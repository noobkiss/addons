...
[11341]="Increases experience, alliance points, and gold by 7%, and increases Weapon Critical and Spell Critical by 1% while in Cyrodiil.",
[11343]="Increases experience, alliance points, and gold by 8%, and increases Weapon Critical and Spell Critical by 2% while in Cyrodiil.",
[11345]="Increases experience, alliance points, and gold by 9%, and increases Weapon Critical and Spell Critical by 3% while in Cyrodiil.",
[11346]="Increases experience, alliance points, and gold by 5% while in Cyrodiil.",
[11347]="Increases experience, alliance points, and gold by 10%, and increases Weapon Critical and Spell Critical by 4% while in Cyrodiil.",
[11348]="Increases experience, alliance points, and gold by 11%, and increases Weapon Critical and Spell Critical by 5% while in Cyrodiil.",
[11350]="Increases experience, alliance points, and gold by 12%, and increases Weapon Critical and Spell Critical by 6% while in Cyrodiil.",
[11352]="Increases experience, alliance points, and gold by 13%, and increases Weapon Critical and Spell Critical by 7% while in Cyrodiil.",
[11353]="Increases experience, alliance points, and gold by 14%, and increases Weapon Critical and Spell Critical by 8% while in Cyrodiil.",
[11356]="Increases experience, alliance points, and gold by 15%, and increases Weapon Critical and Spell Critical by 9% while in Cyrodiil.",
...
[15058]="Increases Weapon and Spell Damage by <<1>> while in Cyrodiil.",
[15060]="Increases Physical and Spell Resistance by <<1>> while in Cyrodiil.",
...
[15530]="· <<1>> to enemy\n· Chain attack to <<2>>",
[15531]="· <<1>> to enemy",
[15540]="Charge with your divine lance to impale an enemy, dealing <<1>> while taunting them to attack you for <<2>>. The enemy hit is stunned for <<3>>, set Off Balance, and if they were casting, they are interrupted.\n\nYou also gain <<4>> for <<5>>, reducing your damage taken by <<6>>.",
...
[15957]="Ignite the molten lava in your veins, limiting incoming damage to <<1>>% of your Max Health for <<2>>.\n\nWhile active, you cannot generate Ultimate.",
...
[16277]="· Deals <<1>>",
[16348]="Increases Weapon and Spell Damage by <<1>> while in Cyrodiil.",
[16350]="Increases Physical and Spell Resistance by <<1>> while in Cyrodiil.",
...
[17874]="Ignite the molten lava in your veins, limiting incoming damage to <<1>>% of your Max Health for <<2>>.\n\nWhen activated, nearby allies gain a damage shield for <<3>>% of their Max Health for <<4>>.\n\nWhile active, you cannot generate Ultimate.",
[17878]="Ignite the molten lava in your veins, limiting incoming damage to <<1>>% of your Max Health and dealing <<2>> to nearby enemies each second for <<3>>. \n\nWhile active your direct damage attacks ignore enemy Physical and Spell Resistance but you cannot generate Ultimate.",
[17895]="Deals <<1>>.",
[17897]="Deals <<1>>.",
[17899]="Deals <<1>>.",
...
[18866]="Casting a Shadow ability grants you Major Resolve for <<1>>, increasing your Physical and Spell Resistance by <<2>>. This duration is increased by <<3>> for each piece of Heavy Armor equipped.\n\nCurrent duration: <<4>>.",
...
[20251]="Call forth talons from the ground, dealing <<1>> to enemies near you and immobilizing them for <<2>>. \n\nEnemies hit are afflicted with <<3>>, reducing damage done by <<4>> for <<5>>. \n\nAn ally near the talons can activate the <<6>> synergy, dealing <<7>> to all enemies held within them.",
...
[20299]="Crouch into the shadows, becoming hidden over <<1>>. Attacking from stealth grants you |cffffff100|r% Critical Strike Chance, a <<2>> Melee Critical Damage bonus, <<3>> Ranged Critical Damage bonus, and stuns the target for <<4>>. \n\nWhile hidden and moving, costs <<5>> Stamina every <<6>> and Stamina Recovery is disabled.",
[20319]="Envelop your body in molten spikes to increase your damage done by <<1>> and gain <<2>>, increasing Physical and Spell Resistance by <<3>> for <<4>>.",
[20323]="Envelop your body in molten spikes to increase your damage done by <<1>> and gain <<2>>, increasing Physical and Spell Resistance by <<3>> for <<4>>.\n\nAs the armor forms you blast foes around you with shattered obsidian, causing them to take <<5>> over <<6>>. When this effect deals damage you gain a stack of <<7>>, up to once every <<8>>.",
[20328]="Envelop your body in molten spikes to increase your damage done by <<1>> and gain <<2>>, increasing Physical and Spell Resistance by <<3>> for <<4>>.\n\nPower drawn from the heart of a volcano forms a damage shield around you that absorbs up to <<5>> damage for <<6>>, scaling off your Max Health.",
[20492]="Lash out with a flaming chain, pulling an enemy to you. The searing metal deals <<1>>, applies the <<2>> status effect, and taunts them for <<3>> if they are not already taunted.\n\nThis attack cannot be dodged or reflected.\n\nAlso inflicts <<4>> on the enemy, reducing Weapon and Spell Damage by <<5>> for <<6>>.",
[20496]="Lash out with a chain bound in Draconic runes, pulling an enemy to you. The enchanted metal deals <<1>>, applies the <<2>> status effect, and taunts them for <<3>> if they are not already taunted. If the target cannot be pulled, you restore the ability's Magicka cost.\n\nThis attack cannot be dodged or reflected.\n\nAlso inflicts <<4>> on the enemy, reducing Weapon and Spell Damage by <<5>> for <<6>>.",
[20499]="Lash out with a chain bound in jagged links, pulling yourself to an enemy. The searing metal deals <<1>> and applies the <<2>> status effect.\n\nThis attack cannot be dodged or reflected.\n\nHitting the target grants you <<3>> for <<4>> and <<5>> for <<6>>, increasing damage done by <<7>> reducing damage taken from area attacks by <<8>>.",
...
[20657]="Slash your foe with a fiery claw, dealing <<1>> and an additional <<2>> over <<3>>.\n\nThe initial hit always applies the <<4>> status effect.",
[20660]="Slash your foe with a fiery claw, dealing <<1>> and an additional <<2>> over <<3>>.\n\nYou heal for <<4>> Health from the initial hit and <<5>> Health each subsequent tick, scaling off your Max Health.\n\nThe initial hit always applies the <<6>> status effect.",
[20668]="Slash your foe with a fiery claw, dealing <<1>> and an additional <<2>> over <<3>>.\n\nThe flame sears into the target, dealing <<4>> more damage every <<5>>.\n\nThe initial hit always applies the <<6>> status effect.",
...
[20697]="For <<1>>:\n· Deals <<2>> every <<3>>\n· Snare <<4>>",
[20779]="Throw out a purifying flame, filling a large area with warmth for <<1>>. This fire heals you and your allies at the target location for <<2>> Health every <<3>>. This healing increases by |cffffff50|r% if you are in the area.\n\nHealed targets gain <<4>> and <<5>> for <<6>>, increasing Health Recovery by <<7>> and generating <<8>> Ultimate every |cffffff1.5|r seconds.",
[20783]="For <<1>>:\n· Deals <<2>>\n· Snare <<3>>",
[20786]="For <<1>>:\n· Deals <<2>>\n· Snare <<3>>",
[20805]="Lash an enemy with flame, dealing <<1>>.\n\nActivating a different Dragonknight ability while in combat grants a stack of <<2>> up to 3 times, increasing the damage of your next <<3>> by <<4>> within <<5>>.",
[20816]="Lash an enemy with flame, dealing <<1>> and healing for <<2>> Health.\n\nHitting an Off Balance enemy grants <<3>> stacks of <<4>> for <<5>>, up to once every <<6>>.\n\nActivating again consumes a stack to deal <<7>> to your target and all nearby enemies and heals for <<8>> Health.",
[20824]="Slam your whip down with tremendous force at an enemy, dealing <<1>> to them and all nearby enemies and healing you for <<2>> Health.",
[20917]="Exhale a blast of draconic fire in front of you, dealing <<1>> and an additional <<2>> over <<3>> to enemies in your path.",
...
[20930]="Breathe forth an unending torrent of draconic fire, dealing <<1>> every <<2>> in a channeled attack over <<3>>.\n\nEach tick increases the damage dealt by <<4>>, up to a maximum of |cffffff50|r%. While <<5>> is active you always deal maximum damage.\n\nThis ability is considered direct damage but can trigger <<6>> once every <<7>>.",
[20944]="Exhale a blast of draconic fire in front of you, dealing <<1>>, applying the <<2>> status effect, and an additional <<3>> over <<4>> to enemies in your path.\n\nThe initial hit liquifies the armor of your enemies, applying <<5>> to enemies for the duration, reducing Physical and Spell Resistance by <<6>>.",
...
[21007]="Unfurl draconic wings to knock back enemies around you <<1>> and stun them for <<2>>.\n\nThe winds from your buffet swirl around you, reducing your damage taken from projectiles by <<3>> for <<4>>, while granting you <<5>> for <<6>>, increasing Movement Speed by <<7>>.",
[21014]="Unfurl draconic wings to knock back enemies around you <<1>> and stun them for <<2>>. \n\nThe enchanted winds summoned by your wings coalesce around you, reducing your damage taken from projectiles by <<3>> for <<4>>, while granting you immunity to snares and immobilizations and <<5>> for <<6>>, increasing Movement Speed by <<7>>.",
[21017]="Unfurl draconic wings to safeguard you and nearby group members for <<1>>, reducing damage taken from projectiles by <<2>> for you and <<3>> for group members.\n\nYou and your brood gain <<4>> for <<5>>, reducing damage taken by <<6>>. You gain <<7>> for <<8>>, increasing Movement Speed by <<9>>.",
...
[21114]="Gives you an <<1>> damage bonus when attacking stunned, immobilized, or silenced enemies.",
...
[21763]="Summon an expanding beam of pure sunlight to doom an enemy, dealing <<1>> immediately and marking them for <<2>>.\n\nAfter the duration ends, the sunlight bursts, dealing <<3>> to the enemy, which increases based on the amount of damage you dealt to them over the duration, up to <<4>>.\n\nYou can have only one <<5>> active at a time, and each hit of the ability applies the <<6>> status effect.",
...
[21925]="Applies Minor Defile which reduces healing received and damage shield strength by <<1>> on the enemy.",
...
[22149]="Charge with your divine lance to impale an enemy, dealing <<1>> while taunting them to attack you for <<2>>. If the enemy hit was casting, they are interrupted, set Off Balance, and stunned for <<3>>.\n\nYou also gain <<4>> for <<5>>, reducing your damage taken by <<6>>.",
[22161]="Charge with your divine lance to impale all enemies in the area, dealing <<1>> while taunting the first enemy hit to attack you for <<2>>. Any enemy hit that was casting is interrupted, set Off Balance, and stunned for <<3>>.\n\n You also gain <<4>> for <<5>>, reducing your damage taken by <<6>>.",
[22170]="· Deal <<1>>\n· Heal self for <<2>> over <<3>>",
[22172]="· Deal <<1>>\n· Heal nearby allies for <<2>>",
[22174]="· Deal <<1>>\n· Heal self for <<2>> over <<3>>\n· For <<4>>, allies attacking target recover <<5>>% stamina",
[22178]="Surround yourself with solar rays, dealing <<1>> to nearby enemies and applying <<2>> to them for <<3>>, reducing their damage done by <<4>>.\n\nThe rays then protect you, granting a damage shield that absorbs up to <<5>> damage for <<6>>, increasing by <<7>>% for each enemy hit, up to |cffffff60|r%. This portion of the ability scales off your Max Health.",
[22180]="Surround yourself with solar rays, applying <<1>> to nearby enemies for <<2>>, reducing their damage done by <<3>>.\n\nYou gain a damage shield that absorbs up to <<4>> damage for <<5>>, increasing by <<6>> for each enemy hit, up to |cffffff60|r%. This ability scales off your Max Health.\n\nWhen the shield expires it explodes, dealing <<7>>% of damage absorbed as Magic Damage to nearby enemies.",
[22182]="Surround yourself with solar rays, dealing <<1>> to nearby enemies and applying <<2>> to them for <<3>>, reducing their damage done by <<4>>.\n\nThe rays then protect you, granting a damage shield that absorbs up to <<5>> damage for <<6>>, increasing by <<7>>% for each enemy hit, up to |cffffff120|r%. This portion of the ability scales off your Max Health.",
...
[23277]="Transform yourself into pure energy and flash forward. After reaching your location, you become immune to snare and immobilize effects for <<1>>. A ball of lightning is summoned at your end point, which intercepts up to |cffffff1|r projectile attack made against you every |cffffff1|r second for <<2>>.\n\nCasting again within <<3>> costs <<4>> more Magicka.",
...
[23806]="Lash an enemy with flame, dealing <<1>>.\n\nHitting an Off Balance enemy grants <<2>> stacks of <<3>> for <<4>>, up to once every <<5>>.\n\n<<3>> replaces this ability and consumes a stack to instead deal <<6>> to your target and all nearby enemies.",
[24158]="Protect yourself with the power of Oblivion, creating a suit of Daedric mail that increases your block mitigation by <<1>> for <<2>>. The duration is based on your combined Physical and Spell Resistance.\n\nWhile slotted on either ability bar, you gain <<3>>, reducing your damage taken by <<4>>.",
[24163]="Protect yourself with the power of Oblivion, creating a suit of Daedric mail that increases your block mitigation by <<1>> for <<2>>. The duration is based on your combined Physical and Spell Resistance.\n\nWhen slotted on either bar, you gain <<3>> and <<4>>, reducing your damage taken by <<5>> and increasing your Armor by <<6>>.",
[24165]="When slotted on either bar, you gain <<1>> and <<2>>, increasing your Critical Rating by <<3>>.\n\nYour Light and Heavy Attacks now generate a stack of <<4>> for <<5>>, up to <<6>> times. Fully-charged Heavy Attacks grant two stacks.\n\nWhen at one or more stacks, you can arm up to <<7>> of them to strike your target for <<8>> every <<9>> for each stack of <<4>> consumed.",
[24326]="Curse an enemy with a destructive rune, dealing <<1>> to the target and all other nearby enemies after <<2>>.\n\nYou can have only one <<3>> active at a time.",
[24328]="Curse an enemy with a destructive rune, dealing <<1>> to the target and all other nearby enemies after <<2>>.\n\nWhile the curse is active, your Daedric Summoning pets prioritize the target and deal an additional <<3>> damage to them.\n\nYou can have only one <<4>> active at a time.",
[24330]="Curse an enemy with a destructive rune, dealing <<1>> to the target and all other nearby enemies after <<2>>.\n\nThe curse will continue to haunt the enemy and explode a second time, dealing <<1>> to the target and all other nearby enemies after an additional <<3>>.\n\nYou can have only one <<4>> active at a time.",
...
[24834]="Carefully form |cffffff5|r protective Daedric wards around you, which take |cffffff3|r seconds to arm and last for <<1>>.\n\nWhen a Daedric ward is triggered it grants you or the ally a damage shield that absorbs <<2>> damage for <<3>>. Targets can only be shielded by Daedric Refuge once every <<4>> and the shield is capped at |cffffff43|r% of the target's Max Health.",
...
[25267]="Slash an enemy, dealing <<1>>. \n\nIf you strike an enemy from their flank you set them Off Balance.\n\nWhen you leave Sneak or invisibility while in combat, increase your damage done with this ability by <<2>> for <<3>>.\n\nWhile slotted on either bar, you gain <<4>>, increasing your Movement Speed  by <<5>>.",
...
[25375]="Cloak yourself in shadow to become invisible. When moving your Magicka Recovery is disabled and when not moving <<1>> is half cost.\n\nWhen <<1>> begins or ends, you gain <<2>> for <<3>>, increasing your damage done to monsters by <<4>>.\n\nWhile slotted on either bar, you gain <<5>>, reducing your damage taken by <<6>>.",
[25376]="Cloak yourself in shadow to become invisible for <<1>>.\n\nWhile slotted on either bar, you gain Major Prophecy and Savagery, increasing your Spell and Weapon Critical rating by <<2>>.",
[25377]="Shroud yourself in protective shadow to heal for <<1>> Health every <<2>>, over <<3>>, increasing by an additional <<4>> while Bracing. This portion of the ability scales off your Max Health.\n\nWhile slotted on either bar, you gain <<5>>, reducing your damage taken by <<6>>.",
[25380]="Cloak yourself in shadow to become invisible. When moving your Magicka Recovery is disabled and when not moving <<1>> is half cost. Your next direct damage attack will Critically Strike.\n\nWhen <<1>> begins or ends, you gain <<2>> for <<3>>, increasing your damage done to monsters by <<4>>.\n\nWhile slotted on either bar, you gain <<5>>, reducing your damage taken by <<6>>.",
...
[25493]="Flash through the shadows and ambush an enemy while unleashing a fan of knives, dealing <<1>> to them and enemies around you.\n\nAll enemies hit take an additional <<2>> over <<3>> and are afflicted with <<4>> for <<5>>, increasing their damage taken by <<6>>.",
...
[26114]="Launch a relentless assault, striking up to 6 enemies in front of you three times with your Aedric spear. The spear deals <<1>> per strike and reduces enemy Movement Speed by <<2>> for <<3>>.",
...
[26750]="Reduce Magicka cost of spells by <<1>>. This effect does not work with abilities that drain their cost multiple times over their activation.",
[26768]="Lay claim to an enemy's soul, dealing <<1>> over <<2>>.\n\nFills an empty Soul Gem if an affected enemy dies.",
[26792]="Launch a relentless assault, striking up to 6 enemies in front of you three times with your Aedric spear. The spear deals <<1>> per strike and reduces enemy Movement Speed by <<2>> for <<3>>. Each strike has a 10% chance of applying the <<4>> status effect.\n\nActivating this ability grants you <<5>> and <<6>>, increasing your Weapon and Spell Damage by <<7>> for <<8>>.",
[26797]="Launch a relentless assault, striking up to 6 enemies in front of you three times with your Aedric spear. The spear deals <<1>> per strike and reduces enemy Movement Speed by <<2>> for <<3>>.\n\nYou heal for <<4>> of the damage done with this ability.",
...
[26858]="Send your spear into the heavens to bring down a shower of divine wrath, dealing  <<1>> to enemies in the area and an additional <<2>> every <<3>> for <<4>>.\n\nYou or an ally near the spear can activate the <<5>> synergy, which restores <<6>> Magicka and Stamina.",
[26869]="Send your spear into the heavens to bring down a shower of divine wrath, dealing <<1>> to enemies in the area and an additional <<2>> every <<3>> for <<4>>. Enemies hit by the initial hit are immobilized for <<5>>.\n\nAn ally near the spear can activate the <<6>> synergy, restoring <<7>> Magicka or Stamina, whichever maximum is higher.",
...
[28297]="Focus your strength and resolve to gain <<1>> and Sorcery, increasing your Weapon and Spell Damage by <<2>>, as well as gaining <<3>>, increasing your Stamina Recovery by <<4>> for <<5>>.",
[28301]="Immunity to enemy control abilities.",
[28302]="Shift your grip and strike an enemy down, dealing <<1>>. Deals up to <<2>>% more damage to enemies with less than <<3>>% Health.",
...
[28308]="Call forth Daedric shards from the earth to encase and immobilize all enemies in front of you for <<1>>. After the effect ends the shards shatter, dealing <<2>> to any enemy that was encased.\n\nEnemies hit are afflicted with <<3>>, reducing their damage done by <<4>> for <<5>>.",
[28311]="Call forth a Daedric shroud from the Colored Rooms to heal you and your allies and enfeeble foes in front of you. \n\nYou and allies in the area are healed for <<1>> Health and receive <<2>>, increasing your healing received and damage shield strength by <<3>> for <<4>>.\n\nEnemies are afflicted with <<5>>, reducing their damage done by <<6>> for <<4>>.",
...
[28418]="Conjure globes of Daedric energy for protection, granting a damage shield for you and your pets that absorbs <<1>> damage for <<2>>.\n\nThis ability scales off the higher of your Max Health or Magicka and the shield is capped at |cffffff55|r% of your Max Health.",
...
[28591]="Launch yourself into a lethal spin, dealing <<1>> to nearby enemies. Deals up to <<2>>% more damage to enemies with less than <<3>>% Health.",
...
[28967]="Activate an aura of flames which launches a wave of flame around you every <<1>>, dealing <<2>> to enemies inside.\n\nWhile slotted on either bar, you gain Major Prophecy and Savagery, increasing your Spell and Weapon Critical rating by <<3>>.",
[28988]="Call down a battle standard for <<1>>, rallying you and group members inside the area, increasing Weapon and Spell Damage by <<2>> and reducing damage taken by <<3>>.\n\nAn ally near the standard can activate the <<4>> synergy, dealing <<5>> to enemies in the area and immobilizing them for <<6>>.",
[29004]="Draw on your draconic blood to heal for <<1>> Health, increasing by up to <<2>>% additional healing based on your missing Health. This ability scales off your Max Health.\n\nYou also gain <<3>>, increasing your Health Recovery by <<4>> for <<5>>.",
[29011]="· Heal for <<1>>% of missing health\n· Increase health regeneration by <<2>> for <<3>>",
[29012]="Launch yourself at an enemy, dealing <<1>> to all enemies in the area, knocking players back <<2>> and stunning them for <<3>>. If the target is a monster they are instead knocked into the air and stunned for <<4>>.",
[29032]="Roil the air around you or an ally, granting a damage shield that absorbs up to <<1>> for <<2>>.\n\nThis ability scales off the higher of your Max Magicka or Stamina and is capped at <<3>> of the target's Max Health.",
[29037]="Encase an enemy in molten rock, reducing their movement speed by <<1>> for <<2>>. Upon completion, the target is stunned for <<3>>, or <<4>> against monsters.\n\nThis stun cannot be blocked.\n\nThe molten rock melts through the enemy's armor and applies <<5>> for <<6>>, reducing Armor by <<7>>.",
[29043]="Charge you and your grouped allies' weapons with volcanic power to gain <<1>> and Sorcery, increasing your Weapon and Spell Damage by <<2>> for <<3>>.\n\nWhile active, dealing damage with Light and Heavy Attacks causes an additional <<4>>, up to once every <<5>>.",
[29059]="Throw out a kindled flame, filling a large area with warmth for <<1>>. This fire heals you and your allies at the target location for <<2>> Health every <<3>>.\n\nHealed targets gain <<4>> and <<5>> while inside, increasing Health Recovery by <<6>> and generating <<7>> Ultimate every |cffffff1.5|r seconds.",
...
[29102]="When you cast a Magicka ability, you have a |cffffff15|r% chance to negate that ability's cost.",
...
[29424]="To you, flame is fuel. \n\nWhen you apply Burning, you restore <<1>> Magicka and Stamina. This effect can occur once every <<2>>.",
[29430]="Fire cares not for love, or coin, or creed. It consumes.\n\nDealing direct damage with an Ardent Flame ability causes the target to take <<1>> increased Flame Damage and reduces their Movement Speed by <<2>> for <<3>>.",
[29439]="Tend to your garden of flame, that it may flourish.\n\nIncreases your chances of applying the <<1>> status effect by <<2>> and its damage done by <<3>>. These values are influenced by the number of Dragonknight abilities slotted.",
[29451]="The will to survive burns bright in your chest.\n\nIncreases your Healing Taken by <<1>>.",
[29455]="A Dragon's scales will turn aside arrow, fire, and blade.\n\nIncreases the amount of damage you block by <<1>>.",
[29457]="Dragons leave naught but ash and ruin in their wake.\n\nIncreases your damage done with area and over time attacks by <<1>>.",
[29460]="The eldest Dragons are forces of nature. As are you.\n\nActivating a Draconic Power ability grants you and group members <<1>> for <<2>>, increasing Weapon Damage by <<3>>.\n\nIncreases your Health Recovery by up to <<4>>, based on your missing Health.\nCurrent amount: <<5>>",
[29462]="The syllables of that ancient tongue live in the mouth of every Dragonknight.\n\nWhen you cast an Ultimate ability, you restore <<1>> Health, <<2>> Magicka, and <<2>> Stamina for every Ultimate spent. Each Dragonknight ability slotted increases this value by |cffffff3|r.\n\nCurrent amount:\n<<3>> Health\n<<4>> Magicka\n<<5>> Stamina",
[29463]="Given time, the smallest rock on the mountain can cascade into pure devastation.\n\nWhenever you deal damage you gain a stack of <<1>> which increases your damage done by <<2>> per stack, up to |cffffff10|r times. This effect can occur once every <<3>>.\n\nEvery <<4>> you do not deal damage, you lose a stack.",
[29468]="Rock and stone shield your heart, turning aside sharp blades and barbed words.\n\nIncreases your Armor by <<1>>.",
[29473]="Where earth meets sky is a wellspring of power you can tap at will.\n\nWhen you cast or deal damage with an Earthen Heart ability in combat you generate <<1>> Ultimate. This effect can occur once every <<2>>.\n\nIncreases your Critical Damage by <<3>>.",
[29475]="The strength of mountains fuels your mightiest blows.\n\nDealing damage with a fully-charged Heavy Attack also applies Off Balance to the target.",
[29482]="Conjure globes of Daedric energy for protection, granting a damage shield for you and your pets that absorbs <<1>> damage for <<2>>, heals you for <<3>> Health, and grants <<4>> and <<5>> to you and nearby allies for <<6>>.\n\nThis ability scales off the higher of your Max Health or Magicka and the shield is capped at |cffffff55|r% of your Max Health.",
[29483]="· Create a <<1>> point damage ward for <<2>>",
[29484]="· Create a <<1>> point damage ward for <<2>>",
[29489]="Conjure globes of Daedric energy for protection, granting a damage shield for you and your pets that absorbs <<1>> damage for <<2>>.\n\nThis ability scales off the higher of your Max Health or Magicka and the shield is capped at |cffffff72|r% of your Max Health.",
...
[29556]="Shroud yourself in mist to gain <<1>>, reducing damage taken from area attacks by <<2>> for <<3>>.",
...
[31383]="When you cast a Dark Magic ability with a cost, you heal for <<1>> Health if you are not at full Health. This portion of the ability scales off your Max Health.\n\nIf your Health is full, the higher of your Max Magicka or Stamina is increased by <<2>> for <<3>>.",
...
[31412]="Increases your Magicka and Stamina by <<1>>.\n\nIncreases your Max Health <<1>> if you have a permanent pet active.",
[31417]="Reduce your damage taken by <<1>> while you have a Daedric Summoning ability active.",
[31419]="Increases your Health, Magicka, and Stamina Recovery by <<1>>.",
...
[31565]="Increases your Weapon Damage, Spell Damage, and Armor by <<1>>.",
...
[31698]="Increases your Critical Damage by <<1>>.\n\nIncreases your damage done to blocking players by <<2>>.",
[31700]="· Increase critical strike rating by <<1>> with spear abilities",
[31708]="Gain <<1>> and <<2>> for <<3>>, increasing damage done and reducing damage taken by <<4>>.",
[31718]="When you deal damage you generate a stack of <<1>> for <<2>>. After reaching |cffffff4|r stacks, you deal <<3>> to your target. This effect can stack once every half second and scales off the higher of your Weapon or Spell Damage.",
...
[31751]="Increases your healing done by up to <<1>>, in proportion to the severity of the target's wounds.",
...
[31760]="When you heal an ally under |cffffff50|r% Health with a Restoring Light ability, you grant them |cffffff1|r Ultimate.\n\nActivating an ability with a cast or channel time while in combat causes you to automatically block all attacks at no cost for <<1>>, up to once every <<2>>.",
[31816]="Draw forth magma from below to hurl at an enemy, dealing <<1>> while applying a stack of <<2>>, which increases the enemy's damage taken by <<3>> for <<4>> per stack, up to |cffffff3|r times.\n\nHitting an enemy at max stacks of Heat Shock with this ability increases the damage done of the next cast of this ability within <<5>> by <<6>>, up to once every <<7>>.",
[31820]="Roil the air around you or an ally, granting a damage shield that absorbs up to <<1>> for <<2>> and reducing the next instance of damage taken by <<3>>. When the shield ends the latent heat warms the target, healing them for <<4>> Health.\n\nThis ability scales off the higher of your Max Magicka or Stamina and the shield is capped at <<5>> of the target's Max Health.",
[31837]="Let the fire within draw heat to your core, restoring <<1>> of your missing Magicka and Stamina every <<2>> over <<3>>.\n\nWhen this ability completes, you release this heat as a blast of fire that deals <<4>> to nearby enemies.",
[31874]="Charge you and your grouped allies' weapons with volcanic power to gain <<1>> and Sorcery, increasing your Weapon and Spell Damage by <<2>> for <<3>>.\n\nWhile active, dealing damage with Light and Heavy Attacks causes an additional <<4>>, up to once every <<5>>.",
[31888]="Charge you and your grouped allies' weapons with volcanic power to gain <<1>> and Sorcery, increasing your Weapon and Spell Damage by <<2>> for <<3>>.\n\nWhile active, dealing damage with Light and Heavy Attacks causes an additional <<4>>, up to once every <<5>>.\n\nYou also gain <<6>> for the duration, increasing the damage of your Heavy Attacks against monsters by <<7>>.",
...
[32455]="Transform into a beast, fearing nearby enemies for <<1>>.\n\nWhile transformed and in combat, abilities generate <<2>> Fury. When you have <<3>>, this ability becomes <<4>>, which increases your damage done by <<5>>, Movement Speed by <<6>>, and removes the cost of all Werewolf abilities for <<7>>. \n\nWhile slotted, your Stamina Recovery is increased by <<8>>.",
[32464]="· Deals <<1>>",
...
[32632]="Pounce on an enemy with primal fury, dealing <<1>> and applying the <<2>> status effect.\n\nWhen you are <<3>> meters or closer this ability becomes <<4>>, which causes you to rip into an enemy and deal <<5>> over <<6>>, dealing up to <<7>>% more damage to enemies under <<8>>% Health.",
[32633]="Roar with bloodlust to fear nearby enemies for <<1>> and setting them Off Balance for <<2>>. Grants you a stack of <<3>>, which empowers Gnash and Claw Fury.\n\nUp to 12 nearby allies can activate the <<4>> synergy, which grants <<5>> damage done and <<6>> for <<7>>, increasing Critical Damage by <<8>>%.\n\nWhile slotted you gain <<9>> and Savagery.",
[32634]="Hunger gnaws at you. Like Storihbeg, shape it into a brutal weapon.\n\nGain the ability to devour corpses, for up to <<1>> per corpse. Each second devouring you heal for <<2>> Health, based off your Max Health, and restore <<3>> Ultimate.\n\nIf you are a <<4>>, each tick activates Fury generation.",
[32636]="Give chase, hunter. Become pursuit unrelenting.\n\nIncreases your Movement Speed by <<1>>.",
[32637]="Honor your pact and let loose your rage.\n\nIncreases the amount of Fury you generate by <<1>>.\nCurrent Bonus: <<2>>\n\nFury is generated by using Werewolf abilities while in combat. Once you have <<3>>, you gain access to the <<4>> Ultimate, which increases your damage done by <<5>>, Movement Speed by <<6>>, and removes the cost of all Werewolf abilities for <<7>>.",
[32638]="Lorkh teaches through suffering. So too will your claws.\n\nIncreases your Weapon and Spell Damage by <<1>>, reducing to <<2>> against targets with Battle Spirit.\n\nGrants you <<3>>, increasing your Physical and Spell Resistance by <<4>>.",
[32639]="The Great Hunt demands more participants. Become a shepard to the lamb who wishes to fight back.\n\nAllows you to infect another player with Lycanthropy once every |cffffffweek|r by returning to the Werewolf ritual site. \n\nPlayers already infected with Noxiphilic Sanguivoria cannot be infected with Lycanthropy.",
[32641]="No beast can resist their master's call. Hunt as one and none shall escape.\n\nReduces the cost of remaining in your Werewolf Transformation by <<1>>, plus <<1>> for each transformed werewolf or direwolf in your group, including yourself, up to a maximum of <<2>>.",
[32673]="Call the earth to your defense, creating a damage shield for you and nearby allies that absorbs <<1>> damage. This portion of the ability scales off the higher of your Max Magicka or Stamina and is capped at |cffffff31|r% of the target's Max Health.\n\nYou also gain Major Mending, increasing your healing done by <<2>> for <<3>>.",
[32678]="Encase an enemy in molten rock, reducing their movement speed by <<1>> for <<2>>. Upon completion, the target is stunned for <<3>>, or <<4>> against monsters. After the stun ends, the target takes <<5>> and you heal for <<6>> Health.\n\nThis stun cannot be blocked.\n\nThe molten rock melts through the enemy's armor and applies <<7>> for <<8>>, reducing Armor by <<9>>.",
[32685]="Encase an enemy in molten rock, reducing their movement speed by <<1>> for <<2>>. Upon completion, the target is stunned for <<3>>, or <<4>> against monsters. Immobilizes the target for <<5>> after the stun ends.\n\nThis stun cannot be blocked.\n\nThe molten rock melts through the enemy's armor and applies <<6>> and <<7>> for <<8>>, reducing Armor by <<9>> and increasing damage taken by <<10>>.",
[32710]="Throw out a protective flame for <<1>>, healing you and allies inside for <<2>> Health every <<3>>, scaling off your Max Health.\n\nHealed targets gain <<4>> and <<5>> while inside, increasing Health Recovery by <<6>> and generating <<7>> Ultimate every |cffffff1.5|r seconds. You gain <<8>> while inside, reducing damage taken by <<9>>.\n\nEnemies inside have their Movement Speed reduced by <<10>>.",
[32715]="Launch yourself at an enemy, dealing <<1>> to all enemies in the area, knocking players back <<2>> and stunning them for <<3>>. If the target is a monster they are instead knocked into the air and stunned for <<4>>.\n\nUpon activation you gain a damage shield that absorbs <<5>> damage for <<6>>. This portion of the ability scales with your Max Health.",
[32719]="Launch yourself at an enemy, dealing <<1>> to all enemies in the area, knocking them back <<2>>, and stunning them for <<3>>. If the target is a monster they are instead knocked into the air and stunned for <<4>>.\n\nUpon activation you are filled with draconic fury for <<5>>, increasing your damage done by <<6>>. This effect's potency doubles against monsters.",
[32722]="Draw on your draconic blood to heal yourself for <<1>> and nearby allies for <<2>> Health, increasing by up to <<3>>% additional healing based on missing Health. \n\nHealed targets gain <<4>> and <<5>>, increasing Health Recovery by <<6>> and Weapon and Spell Damage by <<7>> for <<8>>.",
...
[32729]="When you take damage, you generate <<1>> Ultimate. This effect can occur once every <<2>> and the Ultimate triples while in Werewolf Transformation.",
...
[32744]="Draw on your draconic blood to heal for <<1>> Health, increasing by up to <<2>>% additional healing based on your missing Health. Heals for an additional <<3>> Health over <<4>>. This ability scales off your Max Health.\n\nYou also gain <<5>> and Fortitude and <<6>>, increasing Health and Stamina Recovery by <<7>> and increasing healing received and damage shield strength by <<8>> for <<9>>.",
...
[32752]="When you cast an ability that grants Major or Minor Resolve while in combat, you gain <<1>> Weapon and Spell Damage and <<2>> Health Recovery for <<3>>. This effect can occur every <<4>>.",
[32754]="When you take damage, you apply Major Defile to the enemy for <<1>>, reducing their healing received and damage shield strength by <<2>>. This effect can occur once every <<3>> per enemy.",
...
[32785]="Let the fire within draw heat to your heart, restoring <<1>> of your missing Magicka and Stamina and healing <<2>> Health every <<3>> over <<4>>.\n\nWhen this ability completes, you release this heat as a blast of fire that deals <<5>> to nearby enemies.",
[32792]="Let the fire within draw heat to your soul, restoring <<1>> of your missing Magicka and Stamina every <<2>> over <<3>>.\n\nMuch of this heat is drawn from enemies around you. Those that are casting are interrupted, set Off Balance, and stunned for <<4>>.\n\nWhen this ability completes, you release this heat as a blast of fire that deals <<5>> to nearby enemies.",
...
[32824]="When you deal damage, you deal <<1>> to the target. The enemy is then afflicted with the Diseased status effect, applying Minor Defile to the target, reducing their Healing Received and damage shield strength by <<2>> for <<3>>.  This effect can occur once every <<4>> and scales off the higher of your Weapon or Spell Damage.",
...
[32833]="While you are casting or channeling an ability, your damage taken is reduced by <<1>>%. \n\nWhen you are interrupted, your next Health, Magicka, or Stamina ability cast within <<2>> will cost no resources.",
...
[32837]="When you deal Martial melee damage, you apply Major Defile to the enemy for <<1>>, reducing their healing received and damage shield strength by <<2>>. This effect can occur once every <<3>>.",
[32838]="Activating an ability with a cast or channel time grants you <<1>> Weapon and Spell Damage for <<2>>.",
[32853]="Activate an aura of flames which launches a wave of flames every <<1>>, dealing <<2>> to enemies inside.\n\nEach hit has a |cffffff15|r% chance of applying <<3>>.\n\nWhile slotted on either bar, you gain Major Prophecy and Savagery, increasing your Spell and Weapon Critical rating by <<4>>.",
[32881]="Activate an aura of embers which cauterizes the wounds of you or up to |cffffff6|r nearby allies every <<1>>, healing for <<2>> Health.\n\nWhile slotted on either bar, you gain Major Prophecy and Savagery, increasing your Spell and Weapon Critical rating by <<3>>.",
[32893]="Rend an enemy, dealing <<1>> and applying the <<2>> status effect.\n\nDeals up to <<3>>% more damage based on your missing Health.",
[32947]="Call down a battle standard for <<1>>, rallying you and group members inside the area, increasing Weapon and Spell Damage by <<2>> and reducing damage taken by <<3>>. You gain an additional <<4>> damage done, <<4>> reduced damage taken, and <<2>> Weapon and Spell Damage.\n\nAn ally near the standard can activate the <<5>> synergy, dealing <<6>> to enemies in the area and immobilizing them for <<7>>.",
[32958]="Call down a battle standard, dealing <<1>> every <<2>> for <<3>> to enemies and applying Major Defile to them, reducing their healing received and damage shield strength by <<4>>. \n\nActivating this ability again allows you to move the standard to your location.\n\nAn ally near the standard can activate the <<5>> synergy, dealing <<6>> to enemies in the area and immobilizing them for <<7>>.",
...
[33319]="Channel a portion of your soul to convert Health to <<1>> Magicka and Stamina.\n\nWhile slotted on either bar, your soul yearns for the warmth of life. All damage you deal heals you for <<2>> Health, up to once every <<3>>.",
...
[33357]="Expose an enemy's weaknesses by applying <<1>> to them, reducing Physical Resistance and Spell Resistance by <<2>> for <<3>>.\n\nWhen a marked enemy dies, you heal to full Health.\n\nYou can only have one <<4>> active at a time.",
...
[34838]="Steal an enemy's life force, dealing <<1>> and healing you or |cffffff3|r other nearby allies for <<2>>% of the damage inflicted every <<3>> for <<4>>.",
...
[35434]="Summon a shade version of yourself to attack an enemy and fight at your side for <<1>>. \n\nThe shade attacks nearby enemies within |cffffff9|r meters of it, dealing <<2>> once every <<3>> and afflicting them with <<4>> for <<5>>, reducing their damage done by <<6>>.",
...
[36508]="Ravage an enemy with a swift strike, dealing <<1>> and causing them to take <<2>> more damage from your attacks for <<3>>.\n\nIf cast with <<4>> or more Ultimate, you instead deal <<5>>, stun the enemy for <<6>>, and increase the duration of the damage taken effect to <<7>>.",
[36514]="Ravage an enemy with a spinning attack, dealing <<1>> and increasing your damage against them by <<2>> for <<3>>.\n\nAlso afflicts the enemy with Major Defile, reducing their healing received and damage shield strength by <<4>>.\n\nWhile slotted on either bar, any time you kill an enemy you gain <<5>> Ultimate.",
...
[36552]="Increases the duration of your Shadow abilities by <<1>>.\n\nDoes not apply to Shadow Cloak or its morphs.",
...
[36595]="Increases your Max Magicka and Stamina by <<1>>.",
...
[36616]="Increases your Critical Chance rating against enemies you are flanking by <<1>>, increasing your chance to critically strike by |cffffff|3.3|r%.",
...
[36636]="Increases your Critical Chance rating by <<1>> for each Nightblade ability slotted, increasing your chance to critically strike by <<2>> per ability.\n\nCurrent bonus: <<3>>.",
[36641]="Increases your Critical Damage by <<1>>. \n\nCritically striking in any form grants you and your group Minor Savagery, increasing your Weapon Critical rating by <<2>> for <<3>>.",
...
[36908]="Channel a portion of your soul to convert Health to <<1>> Magicka and Stamina.\n\nWhile slotted on either bar, your soul yearns for the warmth of life. All damage you deal heals you for <<2>> Health and reduces the cost of your next <<3>> by <<4>>, stacking up to <<5>> times. This effect can occur once every <<6>>.",
[36935]="Channel a portion of your soul to convert Health to <<1>> Magicka and Stamina.\n\nWhile slotted on either bar, your soul yearns for the warmth of life. All damage you deal heals you for <<2>> Health and restores <<3>> Magicka and Stamina, up to once every <<4>>.",
...
[36967]="Expose an enemy's weaknesses by applying <<1>> to them, reducing Physical Resistance and Spell Resistance by <<2>> for <<3>>.\n\nWhen a marked enemy dies, you heal to full Health and gain Major Berserk, increasing your damage done by <<4>> for <<5>>.\n\nYou can only have one <<6>> active at a time.",
[36968]="Expose an enemy's weaknesses by applying <<1>> to them, reducing Physical Resistance and Spell Resistance by <<2>> for <<3>>.\n\nYou can detect marked enemies even if they use stealth or invisibility for <<4>>. When a marked enemy dies, you heal to full Health.\n\nYou can only have one <<5>> active at a time.",
...
[37232]="Call on your staff's strength to protect you or the lowest health ally around you with a damage shield that absorbs <<1>> damage for <<2>>.\n\nThe shield's strength is increased by up to <<3>>%, depending on the severity of the target's wounds.",
...
[38685]="Plant a masterfully aimed arrow in an enemy's vital spot, dealing <<1>> and applying the Poisoned status effect.\n\nAlso afflicts enemy with <<2>>, which reduces their healing received and damage shield strength by <<3>> for <<4>>.",
[38687]="Plant a masterfully aimed arrow in an enemy's vital spot, dealing <<1>> and applying the <<2>> status effect.",
...
[38745]="Focus your strength into a mighty swing, dealing <<1>> to enemies in front of you, and causing them to bleed for an additional <<2>> over <<3>>.\n\nHitting a target that is already affected from this ability extends the duration by <<4>> seconds, up to a maximum of <<5>>.\n\nYou also gain a damage shield that absorbs <<6>> damage for <<7>>.",
...
[38778]="Launch across the earth and smash an enemy, dealing <<1>>. Deals up to <<2>> more damage based on the distance traveled.\n\nThis attack is always a Critical Strike.",
...
[38794]="Focus your strength and resolve to gain <<1>> and Sorcery, increasing your Weapon and Spell Damage by <<2>>, as well as gaining <<3>>, increasing your Stamina Recovery by <<4>> for <<5>>.\n\nActivating this ability removes all snares and immobilizations from you and grants immunity to them for <<6>>.",
[38802]="Focus your strength and resolve to gain <<1>> and Sorcery, increasing your Weapon and Spell Damage by <<2>>, as well as gaining <<3>>, increasing your Stamina Recovery by <<4>> for <<5>>.\n\nYou heal for <<6>> Health when Rally ends. The final heal is increased by <<7>> every <<8>>, up to a maximum of |cffffff200|r%.",
[38807]="Slam an enemy with an upward swing, dealing <<1>>.\n\nGrants you <<2>> and <<3>> for <<4>>, increasing damage done by <<5>> and increasing damage done with Heavy Attacks against monsters by <<6>>.",
...
[38819]="Shift your grip and cut deep, dealing <<1>> to your foe. Deals up to <<2>>% more damage to enemies with less than <<3>>% Health.",
[38823]="Shift your grip and unleash a devastating slice, dealing <<1>> to your foe and all nearby enemies. Deals up to <<2>>% more damage to enemies with less than <<3>>% Health.",
...
[38861]="Launch yourself into a lethal spin, releasing a flurry of blades around you that deals <<1>> to nearby enemies. Deals up to <<2>>% more damage to enemies with less than <<3>>% Health.",
...
[38949]="Rend an enemy, dealing <<1>> and applying the <<2>> status effect.\n\nDeals up to <<3>>% more damage based on your missing Health.\n\nAfter you cast this ability, you cannot be healed by allies for <<4>>.",
[38956]="Rend an enemy, dealing <<1>> and applying the <<2>> status effect.\n\nDeals up to <<3>>% more damage based on your missing Health.\n\nIf you use this ability while you are under |cffffff50|r% Health, it will always be a Critical Strike.",
...
[39075]="Transform into an imposing beast, fearing nearby enemies for <<1>>. \n\nYou also gain <<2>>, <<3>> increased Block Mitigation, and you and group members gain <<4>>.\n\nYou summon two direwolves that deal <<5>> twice or <<6>> once every <<7>>.\n\nWhile transformed in combat, abilities generate Fury. When you have <<8>>, this ability becomes Enduring Rampage, which gains <<9>> Health Recovery in addition to its base effects.\n\nWhile slotted, your Stamina Recovery is increased by <<10>>.",
[39076]="Transform into a berserk beast, fearing nearby enemies for <<1>>.\n\nWhile transformed, you gain <<2>> and your Light Attacks and Heavy Attacks apply a bleed for <<3>> over <<4>>, or <<5>> after <<6>> against players.\n\nWhile transformed and in combat, abilities generate Fury. When you have <<7>>, this ability becomes <<8>>, which increases your damage done, Movement Speed, and removes the cost of Werewolf abilities for <<9>>.\n\nWhile slotted, your Stamina Recovery is increased by <<10>>.",
...
[39104]="Pounce on an enemy with primal fury, dealing <<1>> and applying the <<2>> status effect.\n\nWhen you are <<3>> meters or closer this ability becomes <<4>>, which causes you to rip into an enemy and deal <<5>> over <<6>>, dealing up to <<7>>% more damage to enemies under <<8>>% Health.\n\nDealing damage with either ability restores <<9>> Stamina and triggers Fury generation.",
[39105]="Pounce on an enemy with primal fury, dealing <<1>> and applying the <<2>> status effect to all nearby enemies.\n\nWhen you are <<3>> meters or closer this ability becomes <<4>>, which causes you to rip into all enemies in front of you to deal <<5>> over <<6>>, dealing up to <<7>>% more damage to enemies under <<8>>% Health. The duration increases by <<9>> seconds if cast on the same enemy multiple times.",
[39113]="Roar with bloodlust to fear nearby enemies for <<1>> and setting them Off Balance for <<2>>. Grants two stacks of <<3>>, which empowers Gnash and Claw Fury.\n\nYou and up to 11 nearby allies gain <<4>> for <<5>> and can activate the <<6>> synergy, which grants <<7>> damage done and <<8>> for <<9>>.\n\nWhile slotted you gain <<10>> and Savagery.",
[39114]="Roar with bloodlust to fear nearby enemies for <<1>>, setting them Off Balance for <<2>>, and applying Major Cowardice and Maim for <<3>>. Grants you a stack of <<4>>.\n\nUp to 12 nearby allies can activate the <<5>> synergy, which grants <<6>> damage done and <<7>> for <<8>>.\n\nWhile slotted you gain <<9>> and <<10>>. Selecting this morph causes your Gnash to taunt enemies if cast while Bracing.",
...
[39248]="Increases your Weapon and Spell Damage by <<1>> and Health, Magicka, and Stamina Recovery by <<2>> for <<3>> after you capture a Lumber Mill, Farm, Mine, or Keep.\n\nGain <<4>> at all times, increasing your Mount Speed by <<5>>.",
...
[39458]="While toggled:\n· Light and heavy attacks are replaced with empowered versions that cost ultimate",
[39475]="Ignite the fires of hate in an enemy's heart, dealing <<1>> and taunting them to attack you for <<2>>.\n\nAn ally targeting the taunted enemy can activate the <<3>> synergy, dealing <<4>> to them over <<5>> then an additional <<6>> to them and other nearby enemies.",
...
[40437]="Increases the duration of your Mages Guild abilities by |cffffff1|r second.",
...
[42056]="Ignite the fires of hate in an enemy's heart, dealing <<1>> and taunting them to attack you for <<2>>.\n\nUp to 3 allies targeting the taunted enemy can activate the <<3>> synergy, dealing <<4>> to them over <<5>> then an additional <<6>> to them and other nearby enemies.",
[42060]="Ignite the fires of hate in an enemy's heart, dealing <<1>>, taunting them to attack you, and applying <<2>> and <<3>> for <<4>>, reducing their damage done and increasing their damage taken by <<5>>.\n\nAn ally targeting the enemy can activate the <<6>> synergy, dealing <<7>> to them over <<8>> then an additional <<9>> to them and other nearby enemies.",
...
[42176]="Surround yourself with a whirlwind of bones, gaining a damage shield that absorbs up to <<1>> damage for <<2>>. This ability scales off your Max Health.\n\nAn ally near you can activate the <<3>> synergy, granting up to |cffffff6|r allies a damage shield that absorbs up to <<4>> of their Max Health for <<5>> and <<6>>, increasing their healing received and damage shield strength by <<7>>.",
...
[44721]="Gain <<1>> and <<2>> for <<3>>, increasing damage done and reducing damage taken by <<4>>.",
[44730]="When you deal damage you generate a stack of <<1>> for <<2>>. After reaching |cffffff4|r stacks, you deal <<3>> to your target. This effect can stack once every half second and scales off the higher of your Weapon or Spell Damage.",
[44732]="Increases your Weapon Damage, Spell Damage, and Armor by <<1>>.",
[44922]="A Dragon's scales will turn aside arrow, fire, and blade.\n\nIncreases the amount of damage you block by <<1>>.",
[44933]="Dragons leave naught but ash and ruin in their wake.\n\nIncreases your damage done with area and over time attacks by <<1>>.",
[44951]="The eldest Dragons are forces of nature. As are you.\n\nActivating a Draconic Power ability grants you and group members <<1>> for <<2>>, increasing Weapon Damage by <<3>>.\n\nIncreases your Health Recovery by up to <<4>>, based on your missing Health.\nCurrent amount: <<5>>",
[44953]="The syllables of that ancient tongue live in the mouth of every Dragonknight.\n\nWhen you cast an Ultimate ability, you restore <<1>> Health, <<2>> Magicka, and <<2>> Stamina for every Ultimate spent. Each Dragonknight ability slotted increases this value by |cffffff6|r.\n\nCurrent amount:\n<<3>> Health\n<<4>> Magicka\n<<5>> Stamina",
[44984]="Given time, the smallest rock on the mountain can cascade into pure devastation.\n\nWhenever you deal damage you gain a stack of <<1>> which increases your damage done by <<2>> per stack, up to |cffffff10|r times. This effect can occur once every <<3>>.\n\nEvery <<4>> you do not deal damage, you lose a stack.",
[44996]="Rock and stone shield your heart, turning aside sharp blades and barbed words.\n\nIncreases your Armor by <<1>>.",
[45001]="Where earth meets sky is a wellspring of power you can tap at will.\n\nWhen you cast or deal damage with an Earthen Heart ability in combat you generate <<1>> Ultimate. This effect can occur once every <<2>>.\n\nIncreases your Critical Damage by <<3>>.",
[45009]="The strength of mountains fuels your mightiest blows.\n\nDealing damage with a fully-charged Heavy Attack also applies Off Balance to the target and restores <<1>> Stamina. The Stamina restore can occur once every <<2>>.",
[45011]="To you, flame is fuel. \n\nWhen you apply Burning to an enemy, you restore <<1>> Magicka and Stamina. This effect can occur once every <<2>>.",
[45012]="Fire cares not for love, or coin, or creed. It consumes.\n\nDealing direct damage with an Ardent Flame ability causes the target to take <<1>> increased Flame Damage and reduces their Movement Speed by <<2>> for <<3>>.",
[45023]="Tend to your garden of flame, that it may flourish.\n\nIncreases your chances of applying the <<1>> status effect by <<2>> and its damage done by <<3>>. These values are influenced by the number of Dragonknight abilities slotted.",
[45029]="The will to survive burns bright in your chest.\n\nIncreases your Healing Taken by <<1>>.",
[45038]="Increases your Critical Chance rating against enemies you are flanking by <<1>>, increasing your chance to critically strike by |cffffff|6.6|r%.",
[45048]="When an enemy dies within |cffffff2|r seconds of being damaged by you, you restore <<1>> Magicka and Stamina.",
[45053]="Increases your Critical Chance rating by <<1>> for each Nightblade ability slotted, increasing your chance to critically strike by <<2>> per ability.\n\nCurrent bonus: <<3>>.",
[45060]="Increases your Critical Damage by <<1>>. \n\nCritically striking in any form grants you and your group Minor Savagery, increasing your Weapon Critical rating by <<2>> for <<3>>.",
[45071]="Casting a Shadow ability grants you Major Resolve for <<1>>, increasing your Physical and Spell Resistance by <<2>>. This duration is increased by <<3>> for each piece of Heavy Armor equipped.\n\nCurrent duration: <<4>>",
...
[45115]="Increases the duration of your Shadow abilities by <<1>>.\n\nDoes not apply to Shadow Cloak or its morphs.",
...
[45150]="Increases your Max Magicka and Stamina by <<1>>.",
...
[45172]="When you cast a Dark Magic ability with a cost, you heal for <<1>> Health if you are not at full Health. This portion of the ability scales off your Max Health.\n\nIf your Health is full, the higher of your Max Magicka or Stamina is increased by <<2>> for <<3>>.",
...
[45188]="Increases your Health, Magicka, and Stamina Recovery by <<1>>.",
...
[45199]="Increases your Magicka and Stamina by <<1>>.\n\nIncreases your Max Health by <<1>> if you have a permanent pet active.",
[45200]="Reduce your damage taken by <<1>> while you have a Daedric Summoning ability active.",
...
[45206]="Increases your healing done by up to <<1>>, in proportion to the severity of the target's wounds.",
...
[45481]="Gives you an <<1>> damage bonus when attacking stunned, immobilized, or silenced enemies.",
...
[45602]="Increases the duration of your Mages Guild abilities by |cffffff2|r seconds.",
...
[45614]="Increases your Weapon and Spell Damage by <<1>> and Health, Magicka, and Stamina Recovery by <<2>> for <<3>> after you capture a Lumber Mill, Farm, Mine, or Keep.\n\nGain <<4>> at all times, increasing your Mount Speed by <<5>>.",
...
[46135]="Honor your pact and let loose your rage.\n\nIncreases the amount of Fury you generate by <<1>>.\nCurrent Bonus: <<2>>\n\nFury is generated by using Werewolf abilities while in combat. Once you have <<3>>, you gain access to the <<4>> Ultimate, which increases your damage done by <<5>>, Movement Speed by <<6>>, and removes the cost of all Werewolf abilities for <<7>>.",
[46137]="No beast can resist their master's call. Hunt as one and none shall escape.\n\nReduces the cost of remaining in your Werewolf Transformation by <<1>>, plus <<1>> for each transformed werewolf or direwolf in your group, including yourself, up to a maximum of <<2>>.",
[46139]="Lorkh teaches through suffering. So too will your claws.\n\nIncreases your Weapon and Spell Damage by <<1>>, reducing to <<2>> against targets with Battle Spirit.\n\nGrants you <<3>>, increasing your Physical and Spell Resistance by <<4>>.",
[46142]="Give chase, hunter. Become pursuit unrelenting.\n\nIncreases your Movement Speed by <<1>>.\n\nIncreases the Stamina your Heavy Attacks restore by <<2>>.",
...
[46324]="Conjure dark crystals to bombard an enemy, dealing <<1>>. Your next non-Ultimate ability cast within <<2>> costs <<3>> less.\n\nWhile slotted on either bar, casting a non-Ultimate ability has a |cffffff33|r% chance of causing your next Crystal Fragments to be instant cast at half cost, dealing <<4>>.",
...
[46733]="Reduce Stamina cost of abilities by <<1>>. This effect does not work with abilities that drain their cost multiple times over their activation.",
...
[46741]="Increase the duration of beneficial potion effects by <<1>>.",
...
[47362]="Increases Max Health by <<1>> for you and up to |cffffff11|r other group members within |cffffff28|r meters of you. This bonus persists through death.",
...
[50971]="When you deal Martial melee damage, your Critical Chance is increased by <<1>> for <<2>>, stacking up to 5 times. This effect can occur once every half second.",
...
[50990]="When you Block, you deal <<1>> to all enemies within |cffffff10|r meters of you and heal for <<2>> of the damage done. This effect can occur once every <<3>> and scales off your Max Health.",
...
[51132]="When you deal damage with a Light or Heavy Attack against an enemy who has a Poison Damage ability on them, you deal an additional <<1>> and apply the <<2>> status effect to the enemy. This effect can occur once every <<3>> and scales off the higher of your Weapon or Spell Damage.",
...
[51170]="When you deal damage, your Offensive Penetration is increased by <<1>> for <<2>>, stacking up to 5 times. This effect can occur once every half second.",
...
[51314]="When you deal damage with a fully-charged Heavy Attack, you mark the enemy with unstable energies for <<1>>. If your mark was already active before applying, it instead detonates, dealing <<2>> all enemies within |cffffff8|r meters. This effect can occur once every <<3>> and scales off the higher of your Weapon or Spell Damage.",
...
[52710]="When you deal damage with a Light or Heavy Attack, you deal an additional <<1>>. This effect can occur once every <<2>> and scales off the higher of your Weapon or Spell Damage.",
...
[58310]="Invoke the Huntsman's blessing, healing you for <<1>> Health, scaling off your Max Health. You also restore <<2>> Stamina, increasing by up to <<3>> based on how high your current Health is. \nCurrent Restore: <<4>>\n\nWhile slotted you gain <<5>> and Sorcery, increasing your Weapon and Spell Damage by <<6>>.",
[58317]="Invoke the Huntsman's blessing, healing you for <<1>> Health, granting double Fury, and increasing your damage done and taken by up to <<2>> for <<3>>, based on how high your current Health is. \nCurrent Bonus: <<4>>\n\nYou also restore <<5>> Stamina, increasing by up to <<6>>, based on how high your current Health is. \nCurrent Restore: <<7>>\n\nWhile slotted you gain <<8>> and Sorcery and <<9>>.",
[58325]="Invoke the Huntsman's blessing, healing you for <<1>> Health, scaling off your Max Health. You also restore <<2>> Stamina, increasing by up to <<3>> based on how high your current Health is. \nCurrent Restore: <<4>>\n\nWhile slotted you gain <<5>>, Sorcery, and Vitality increasing Weapon and Spell Damage by <<6>> and healing received and damage shield strength by <<7>>.",
[58344]="· Deals <<1>> \n· 20% off balance chance, occurs more frequently vs enemies under 30% health",
[58348]="· Deals <<1>> \n· 20% off balance chance, occurs more frequently vs enemies under 30% health",
[58405]="Bare your fangs and gnash your teeth into an enemy while ripping back, dealing <<1>> on the initial lunge and <<2>> while ripping out. \n\nConsumes a stack of <<3>> to increase the initial damage done by <<4>>. \n\nThe second hit deals up to <<5>>% more damage to enemies with less than <<6>>% Health.",
...
[58742]="Rip and tear into an enemy with your fangs, dealing <<1>> while applying Major Breach for <<2>> and the <<3>> status effect on the initial rip and <<4>> while tearing out, when it is done. \n\nThe second hit deals up to <<5>>% more damage to enemies with less than <<6>>% Health and heals you for <<7>>, based off your Max Health.\n\nConsumes a stack of <<8>> to increase the initial damage and healing done by <<9>>.",
[58781]="Increase Spell Resistance by <<1>>",
[58782]="Reduces research times by 25%, limits research time to 10 days, and allows the research of three items at once.",
[58783]="Reduces research times by 25%, limits research time to 10 days, and allows the research of three items at once.",
[58784]="Reduces research times by 25%, limits research time to 10 days, and allows the research of three items at once.",
[58798]="Bare your fangs and gnash your teeth into an enemy while ripping back, dealing <<1>> on the initial lunge and <<2>> while ripping out. \n\nConsumes a stack of <<3>> to increase the initial damage done by <<4>>. There is a <<5>> chance to retain <<3>> each cast.\n\nThe second hit deals up to <<6>>% more damage to enemies with less than <<7>>% Health and applies the <<8>> status effect.",
[58855]="Shred up to <<1>> enemies in front of you with wild abandon, dealing <<2>> and an additional <<3>> over <<4>>. Reduced to <<5>> over <<6>> against players.\n\nThe initial hit has a <<7>> chance of applying <<8>>, while the damage over time has a <<9>> chance of applying <<10>>.",
[58864]="Shred up to <<1>> enemies in front of you with furious intent, dealing <<2>> in a channeled attack over <<3>>. \n\nDealing damage with this ability generates <<4>> Fury and a stack of <<5>>, up to once per second. \n\nThis ability deals <<6>> more damage per stack of <<5>>, consumes all stacks when the ability ends, and is considered direct damage.",
[58879]="Shred up to <<1>> enemies in front of you with blood soaked claws, dealing <<2>> and an additional <<3>> over <<4>>. Reduced to <<5>> over <<6>> against players.\n\nYou heal for <<7>> of the initial hit's damage, while you heal for <<8>> Health with the damage over time, based off your Max Health.\n\nThe initial hit grants a stack of Blood Hunger per enemy hit and has a <<9>> chance of applying Sundered, while the damage over time has a <<10>> chance of applying Hemorrhaging.",
...
[59521]="When you use an ability that costs resources, you have a |cffffff25|r%  chance to summon a Dwemer automaton to restore <<1>> Stamina or Magicka or <<2>> Health to you every <<3>> for |cffffff6|r seconds. This effect can occur once every <<4>>.",
...
[59595]="When you deal damage with a damage over time effect, you have an |cffffff8|r% chance to summon a meteor that deals <<1>> to the target and <<2>> to all other enemies within |cffffff5|r meters. This effect can occur once every <<3>> and scales off the higher of your Weapon or Spell Damage.",
...
[61902]="When slotted on either bar, you gain <<1>> and <<2>>, increasing your Spell and Weapon Critical rating by <<3>>.\n\nYour Light and Heavy Attacks now generate a stack of <<4>>, up to <<5>> times. Fully-charged Heavy Attacks grant two stacks.\n\nWhen at <<6>> or more stacks, you can consume <<6>> to fire a spectral arrow to deal <<7>> and heal for <<8>> of the damage dealt, if you are in melee range.",
[61919]="When slotted on either bar, you gain <<1>> and <<2>>, increasing your Spell and Weapon Critical rating by <<3>>.\n\nYour Light and Heavy Attacks now generate a stack of <<4>>, up to <<5>> times. Fully-charged Heavy Attacks grant two stacks.\n\nWhen at <<6>> or more stacks, you can consume <<6>> to fire a spectral arrow to deal <<7>> and heal for <<8>> of the damage dealt, if you are in melee range.",
[61927]="When slotted on either bar, you gain <<1>> and <<2>>, increasing your Spell and Weapon Critical rating by <<3>>.\n\nYour Light and Heavy Attacks now generate a stack of <<4>>, up to <<5>> times. Fully-charged Heavy Attacks grant two stacks.\n\nWhen at <<6>> or more stacks, you can consume <<6>> to fire a spectral arrow to deal <<7>> and heal for <<8>> of the damage dealt, if you are in melee range.",
...
[63601]="Earn +10% to Experience, Gold, Tome Points (Challenges only), Alliance Points (Currency, PvP Skill Lines, and Alliance rank only), Tel Var Stones (monster kills only), Archival Fortunes, Crafting Inspiration, and Trait Research speed.",
...
[67096]="When your healing critically strikes, you grant your target a damage shield that absorbs <<1>> damage for <<2>>. This effect can occur once every <<3>> per target.",
...
[67202]="When you take damage, you summon a cloud of leeching poison under the assailant. The cloud deals <<1>> every <<2>> for <<3>> and heals you for <<4>> of the damage caused. This effect can occur once every <<5>> and scales off your Max Health.",
...
[67280]="When you deal direct damage with a Blink, Charge, Leap, Teleport, or Pull ability, you gain <<1>> Physical and Spell Resistance, taunt the first enemy hit to attack you for <<2>>, and heal for <<3>> of the damage done.",
...
[71102]="When you deal Critical Damage, you increase your Weapon and Spell Damage by <<1>> for <<2>>. While this effect is active, dealing Critical Damage heals you for <<3>> Health. This effect can occur once every <<4>> and the heal scales off the higher of your Max Magicka or Stamina.",
...
[76946]="While in combat, every <<1>> you apply Minor Defile to enemies within |cffffff5|r meters of you for <<2>>, reducing their healing received and damage shield strength by <<3>>.",
...
[79847]="Grants you <<1>>, increasing your healing received and damage shield strength by <<2>> for <<3>>",
[79848]="Grants you <<1>> which increases your Spell Resistance by <<2>> for <<3>>",
[79849]="Grants you <<1>>, increasing your healing received and damage shield strength by <<2>> for <<3>>",
[79850]="Grants you <<1>> which increases your Spell Resistance by <<2>> for <<3>>",
[79851]="Inflicts <<1>> to your target and grants you <<2>>, reducing their healing received and damage shield strength by <<3>> while increasing your healing received and damage shield strength by <<4>> for <<5>>.",
[79852]="Grants you <<1>> which increases your Spell Resistance by <<2>> for <<3>>",
[79854]="Inflicts <<1>> to your target and grants you <<2>>, reducing their healing received and damage shield strength by <<3>> while increasing your healing received and damage shield strength by <<4>> for <<5>>",
[79855]="Grants you <<1>> which increases your Spell Resistance by <<2>> for <<3>>",
[79856]="Grants you <<1>>, reducing your healing received and damage shield strength by <<2>> for <<3>>",
[79857]="Grants you <<1>> which increases your Spell Resistance by <<2>> for <<3>>",
[79858]="Grants you <<1>>, reducing your healing received and damage shield strength by <<2>> for <<3>>",
[79860]="Grants you <<1>> which increases your Spell Resistance by <<2>> for <<3>>",
[79861]="Inflicts <<1>>, reducing target's healing received and damage shield strength by <<2>> for <<3>>.",
[79862]="Inflicts <<1>>, reducing target's healing received and damage shield strength by <<2>> for <<3>>.",
...
[80501]="When you take damage, you transform into a skeleton and gain <<1>> and <<2>> for <<3>>, reducing your damage taken by <<4>> but reducing your healing received and damage shield strength by <<5>>. This effect can occur once every <<6>>.",
...
[81068]="When you use a heal ability with a cost, you have a |cffffff33|r% chance to summon a strangler sapling that heals you or an ally for <<1>> Health over <<2>>. This effect can occur once every <<3>> and scales off the higher of your Max Magicka or Stamina.",
...
[83229]="Strike at an enemy with a vicious blow, dealing <<1>> to them and all nearby enemies.\n\nThis attack ignores the target's Resistance and grants you Physical and Spell Penetration for direct damage attacks equal to <<2>> of the amount ignored from the initial target and if Battle Spirit is inactive you gain <<3>> Critical Chance for <<4>>.",
...
[85179]="Slash enemies in front of you, causing them to bleed for <<1>> over <<2>> and healing you for <<3>> of the damage done.\n\nEach enemy hit increases your damage done by <<4>>% for <<5>>. This effect can stack up to |cffffff6|r times.\n\nEach tick applies the <<6>> status effect.",
...
[85451]="Create a turret to unleash a barrage of arrows at an enemy, dealing <<1>> over <<2>>.",
...
[85565]="Gain Minor Vitality at all times, increasing your healing received and damage shield strength by <<1>>.",
...
[85878]="When you overheal yourself or an ally with a Green Balance ability, you gain <<1>> Magicka and <<1>> Stamina, up to once every <<2>>.",
[85879]="When you overheal yourself or an ally with a Green Balance ability, you gain <<1>> Magicka and <<2>> Stamina, up to once every <<3>>.",
...
[85882]="When you heal yourself or an ally under |cffffff40|r% Health with a Green Balance ability you gain <<1>>, increasing your healing done by <<2>> for <<3>>.",
[85883]="When you heal yourself or an ally under |cffffff40|r% Health with a Green Balance ability you gain <<1>>, increasing your healing done by <<2>> for <<3>>.",
...
[86062]="Casting an Animal Companions ability while are in combat generates <<1>> Ultimate. This effect can occur once every <<2>>.",
[86063]="Casting an Animal Companions ability while are in combat generates <<1>> Ultimate. This effect can occur once every <<2>>.",
...
[86066]="Increases your Magicka and Stamina recovery by <<1>>.",
[86067]="Increases your Magicka and Stamina recovery by <<1>>.",
...
[86113]="Twist a violent storm around you, dealing <<1>> every <<2>> for <<3>> to enemies around you and reducing their Movement Speed by <<4>>. As the storm holds, your damage done increases by <<5>>, reduced to <<6>> while Battle Spirit is active, every <<2>> for <<7>>, up to <<8>> stacks max.\n\nYou and nearby allies gain Major Protection, reducing your damage taken by <<9>>.",
...
[86152]="Envelop yourself in winter winds, instantly healing for <<1>> Health and healing for an additional <<2>> Health every <<3>> over <<4>>. You also heal a nearby ally for <<5>> Health. This ability scales off your Max Health.",
[86156]="Envelop yourself in winter winds, instantly dealing <<1>> to nearby enemies. If no enemies are hit, you heal for <<2>> Health.\n\nThe winds persist for <<3>> and chill your foes to the bone, dealing <<4>> every <<5>>, after <<5>>. The damage has a higher chance to apply the Chilled status effect.\n\nStuns enemies after the delay for <<6>>.",
...
[86191]="Increases your chance to apply the Chilled status effect by <<1>> and increases its damage done by <<2>>. The damage increasing effect scales off the higher of your Weapon or Spell Damage.",
[86192]="Increases your chance to apply the Chilled status effect by <<1>> and increases its damage by <<2>>. The damage increasing effect scales off the higher of your Weapon or Spell Damage.",
[86193]="When you take direct damage from an enemy in melee range, you apply a stack of <<1>> to them for <<2>>, up to |cffffff5|r stacks max. Attackers at max stacks are afflicted with <<3>> for <<4>>, reducing their damage done by <<5>>.",
[86194]="When you take direct damage from an enemy in melee range, you apply a stack of <<1>> to them for <<2>>, up to |cffffff5|r stacks max. Attackers at max stacks are afflicted with <<3>> for <<4>>, reducing their damage done by <<5>>.",
[86195]="Increases the amount of damage you block by <<1>> and increases your Frost Damage by <<2>>.",
[86196]="Increases the amount of damage you block by <<1>> and increases your Frost Damage  by <<2>>.",
...
[88469]="Applies <<1>> and <<2>>, reducing your victim's damage done by <<3>> and reducing their healing received and damage shield strength by <<4>> for <<5>>.",
...
[89338]="Learn all Furniture Plans from Housing Launch.",
...
[99199]="Adds <<1>> Weapon and Spell Damage to your Class abilities.",
...
[99762]="Twin Slashes deals <<1>> more damage for each hit of the initial attack and bleed. This effect scales off the higher of your Weapon or Spell Damage.",
...
[99787]="Activating Critical Charge stirs up a barbarous lust for battle within you for <<1>>, increasing your damage done with direct damage attacks by <<2>>, up to a maximum of |cffffff12|r%. This effect scales off the higher of your Weapon or Spell Damage.",
...
[99805]="When you deal damage with Flurry, your single target damage over time abilities used within <<1>> gain <<2>> Weapon and Spell Damage.",
...
[100485]="Increase Health Recovery by <<1>> and Stamina Recovery by <<2>> for <<3>>.",
...
[106775]="Gain <<1>> and <<2>> at all times, increasing your Movement Speed by <<3>> and Mounted Speed by <<4>>%.",
...
[107093]="Dealing damage with a Light or Heavy Attack creates a ring of fire beneath you for <<1>>. This effect can occur once every <<2>>. Every second spent standing in the ring increases your Weapon and Spell Damage by <<3>> for <<4>>, stacking up to 10 times.",
...
[107202]="Your Light and Heavy attacks apply a stack of harmful winds to your target for <<1>>, reduced to <<2>> against players. Harmful winds deal <<3>> per stack every <<4>>. This effect can stack once every <<5>>, up to <<6>> times, and scales off the higher of your Weapon or Spell Damage.",
...
[108098]="Reduces research times by 25%, and limits research time to 10 days.",
...
[111213]="Your Light Attacks made within melee range rend flesh, causing your enemy to bleed for <<1>> instantly and additionally every <<2>> for <<3>>. This effect scales off the higher of your Weapon or Spell Damage. If you are in Werewolf Transformation, you also gain <<4>> damage done.",
[111220]="When you lose |cffffff7000|r or more Health from a single attack, you gain Major Vitality for <<1>>, increasing your healing received and damage shield strength by <<2>>.",
...
[113287]="When you apply a damage shield to yourself or an ally, you gain Minor Mending and Minor Vitality for <<1>>, increasing your healing done by <<2>> and healing received and damage shield strength by <<3>>. This effect can occur once every <<4)>>.",
...
[113651]="Steadfast Ward applies Major Vitality to your target for <<1>>, increasing their healing received and damage shield strength by <<2>>.",
...
[114196]="Sacrifice your own power to repair damaged flesh, healing you or an ally in front of you for <<1>> Health but applying Minor Defile to yourself for <<2>>, reducing your healing received and damage shield strength by <<3>>.",
[114317]="Unearth a skeletal mage from the dirt to fight by your side for <<1>>, while granting you <<2>> and Sorcery, increasing your Weapon and Spell Damage by <<3>>. The mage attacks the closest enemy every |cffffff2|r seconds, dealing <<4>>.\n\nCreates a corpse on death if you are in combat.",
...
[114720]="Deploy Volatile Spheres from the front and rear of your skeevaton that roll up to <<1>> and explode on contact, dealing damage to all enemies within <<2>> of the explosion.\n\nEnemies within <<3>> take increased damage. Enemies frozen by <<4>> are obliterated.\n\nThis ability has a cooldown of <<5>>.",
...
[114860]="Summon a skeleton from the ground after <<1>>. The skeleton leaps to you, sacrificing the fallen soul within and enhancing your necromantic energies for <<2>>, increasing your damage done with Necromancer abilities and damage over time effects by <<3>>.\n\nCreates a corpse on death if you are in combat.",
...
[115093]="Summon an effigy of bone at your feet for <<1>> that grants Minor Protection to you and your allies, reducing damage taken by <<2>>. Enemies in the area are afflicted with <<3>>, reducing their Weapon and Spell Damage by <<4>>.\n\nAfter <<5>>, the totem begins fearing nearby enemies every <<5>>, causing them to cower in place for <<6>>.",
...
[115206]="Wrap yourself in hardened bone, granting you Major and Minor Resolve, increasing your Physical Resistance and Spell Resistance by <<1>> and <<2>> for <<3>>.\n\nIf cast during combat, you can cast a corpse consuming ability on yourself. This effect can occur once every <<4>>.",
...
[115252]="Desecrate the ground at the target location, dealing <<1>> over <<2>> to enemies inside and applying <<3>>, increasing their damage taken by <<4>>.\n\nConsumes a corpse on cast to deal <<5>> more damage.\n\nAn ally in the area can activate the <<6>> synergy, dealing <<7>> to nearby enemies and healing for the damage done.",
...
[115924]="Violently drain the last spark of life from a corpse, dealing <<1>> over <<2>> to all enemies around the corpse and between you and the corpse. You also gain <<3>> and Prophecy for <<4>>, increasing your Weapon and Spell Critical rating by <<5>>.\n\nWhile slotted, your damage done is increased by <<6>>.",
...
[116186]="When your <<1>>, <<2>>, or <<3>> dies, the cost of your next <<1>>, <<2>>, or <<3>> is reduced by <<4>>.",
[116188]="When your <<1>>, <<2>>, or <<3>> dies, the cost of your next <<1>>, <<2>>, or <<3>> is reduced by <<4>>.",
...
[116197]="Increases your Critical Strike Chance against enemies under |cffffff33|r% Health by <<1>>.",
[116198]="Increases your Critical Strike Chance against enemies under |cffffff33|r% Health by <<1>>.",
...
[116270]="Increase your Healing Received by |cffffff3|r% for each Bone Tyrant ability slotted.\n\nCurrent bonus: <<1>>.",
[116271]="Increases your Max Health by <<1>>.",
[116272]="Increase your Max Health by <<1>>.",
[116273]="While you have a Living Death ability slotted, your Critical Strike Chance with all healing abilities is increased by up to |cffffff6|r% in proportion to the severity of the target's wounds.",
[116275]="While you have a Living Death ability slotted, your Critical Strike Chance with all healing abilities is increased by up to |cffffff12|r% in proportion to the severity of the target's wounds.",
[116282]="While you have a <<1>>, <<2>>, or <<3>> active, your Health, Magicka, and Stamina Recovery is increased by <<4>>.",
[116283]="While you have a <<1>>, <<2>>, or <<3>> active, your Health, Magicka, and Stamina Recovery is increased by <<4>>.",
[116284]="When you consume a corpse, you generate <<1>> Ultimate. This effect can occur once every <<2>>.",
[116285]="When you consume a corpse, you generate <<1>> Ultimate. This effect can occur once every <<2>>.",
...
[117059]="Summon a blizzard around you while you are Bracing, inflicting <<1>> every <<2>> to enemies within |cffffff6|r meters. This effect scales off your Max Health and has a |cffffff15|r% chance of inflicting the Chilled status effect.",
...
[117330]="You cannot summon another sacrifice while one is already active.",
...
[117690]="Summon a decaying skeleton from the ground after <<1>>. The skeleton runs after the target and explodes when it gets close to them, dealing <<2>> to all enemies nearby and applying the <<3>> status effect and Major Defile to them for <<4>>, reducing their healing received and damage shield strength by <<5>>.\n\nCreates a corpse on death.",
[117693]="You cannot summon another Blastbones while one is already active.",
[117749]="Summon a skeleton from the ground after <<1>>. The skeleton leaps to you, sacrificing the fallen soul within and mastering your necromantic energies for <<2>>, increasing your damage done with Necromancer abilities and damage over time effects by <<3>>. While active, your third cast of <<4>> damages in an |cffffff6|r meter area.\n\nCreates a corpse on death if you are in combat.",
[117752]="Increases your Max Stamina by <<1>>.",
[117753]="Increases your Max Stamina by <<1>>.",
[117754]="Increases your Max Stamina by <<1>>.",
[117773]="You cannot summon another sacrifice while one is already active.",
...
[117805]="Desecrate the ground at the target location, dealing <<1>> over <<2>> to enemies inside and applying <<3>> and <<4>>, reducing Physical and Spell Resistance by <<5>> and increasing damage taken by <<6>> for <<7>> each tick.\n\nConsumes a corpse on cast to deal <<8>> more damage.\n\nAn ally in the area can activate the <<9>> synergy, dealing <<10>> to nearby enemies and healing for the damage done.",
...
[117850]="Desecrate the ground at the target location, dealing <<1>> over <<2>> to enemies inside and applying <<3>>, increasing their damage taken by <<4>>.\n\nConsumes a corpse on cast to deal <<5>> more damage.\n\nYou or an ally in the area can activate the <<6>> synergy, dealing <<7>> to enemies and healing for the damage done.",
...
[117883]="Sacrifice your own power to repair damaged flesh, healing you or an ally in front of you for <<1>> Health but applying Minor Defile to yourself for <<2>>, reducing your healing received and damage shield strength by <<3>>.\n\nYou grant the target Spell and Physical Resistance equal to half the amount healed for <<4>>.",
[117888]="Sacrifice your own power to repair damaged flesh, healing you or an ally in front of you for <<1>> Health but applying Minor Defile to yourself for <<2>>, reducing your healing received and damage shield strength by <<3>>.\n\nConsumes a corpse near you when cast to heal a second target.",
...
[118008]="Violently drain the last spark of life from a corpse, dealing <<1>> over <<2>> to all enemies around the corpse and between you and the corpse. You also gain <<3>> and Prophecy for <<4>>, increasing your Weapon and Spell Critical rating by <<5>>.\n\nWhile siphoning the corpse you gain <<6>> Health, Magicka, and Stamina Recovery.\n\nWhile slotted, your damage done is increased by <<7>>.",
...
[118237]="Wrap yourself in hardened bone, granting you <<1>> and <<2>> for <<3>>, increasing your Physical Resistance and Spell Resistance by <<4>> and <<5>>.\n\nWhile active, ranged attackers will be pulled to you once every <<6>> and become taunted for <<7>> if they are not already taunted.\n\nIf cast during combat, you can cast a corpse consuming ability on yourself. This effect can occur once every <<8>>.",
[118244]="Wrap yourself in hardened bone, granting you <<1>> and <<2>> for <<3>>, increasing your Physical Resistance and Spell Resistance by <<4>> and <<5>>.\n\nWhile active, reduce the cost of Blastbones, Skeletal Mage, and Spirit Mender by <<6>>.\n\nIf cast during combat, you can cast a corpse consuming ability on yourself. This effect can occur once every <<7>>.",
...
[118308]="Summon three patches of skeletal claws from the ground in front of you, each dealing <<1>>.\n\nThe first area applies the Chilled status effect, the second area deals an additional <<2>> over <<3>>, and the final area creates a corpse if at least one enemy was hit.",
...
[118380]="Summon an effigy of bone for <<1>> that grants Minor Protection to you and your allies, reducing damage taken by <<2>>. Enemies in the area are afflicted with <<3>>, reducing their Weapon and Spell Damage by <<4>>.\n\nAfter <<5>>, the totem begins fearing nearby enemies every <<6>>, causing them to cower in place for  <<7>>.",
[118404]="Summon an effigy of bone at your feet for <<1>> that grants <<2>> to you and your allies, reducing damage taken by <<3>>. Enemies in the area are afflicted with <<4>>.\n\nAfter <<5>>, the totem begins fearing nearby enemies every <<5>>, causing them to cower in place for <<6>>.\n\nAllies can activate the <<7>> synergy, dealing <<8>> over <<9>> to enemies.",
...
[118639]="Sap the lingering life from fresh corpses, granting you <<1>> Ultimate and healing <<2>> Health every <<3>> for <<4>> per corpse consumed. This ability scales off your Max Health.\n\nWhile slotted, your damage taken is reduced by <<5>>.",
...
[118680]="Unearth a skeletal archer from the dirt to fight by your side for <<1>>, while granting you <<2>> and Sorcery, increasing your Weapon and Spell Damage by <<3>>. The archer attacks the closest enemy every |cffffff2|r seconds, dealing <<4>>.\n\nEach time the archer deals damage, it deals <<5>> more damage than the previous attack.\n\nCreates a corpse on death if you are in combat.",
[118694]="30% Increase to Movement Speed",
[118726]="Unearth a skeletal mage from the dirt to fight by your side for <<1>>, while granting you <<2>> and Sorcery, increasing your Weapon and Spell Damage by <<3>>. The mage attacks the closest enemy every |cffffff2|r seconds, dealing <<4>> to them and all other enemies nearby.\n\nCreates a corpse on death if you are in combat.",
[118763]="Violently drain the last spark of life from a corpse, dealing <<1>> over <<2>> to all enemies around the corpse and between you and the corpse. You also gain <<3>> and Prophecy for <<4>>, increasing your Weapon and Spell Critical rating by <<5>>.\n\nWhen the siphon ends the corpse explodes, dealing an additional <<6>> to all enemies nearby.\n\nWhile slotted, your damage done is increased by <<7>>.",
...
[118840]="Conjure a ghostly spirit to do your bidding and stay by your side for <<1>>. The spirit heals you or lowest Health ally around you every |cffffff2|r seconds, restoring <<2>> Health to the target and |cffffff2|r allies nearby them.\n\nCreates a corpse on death if you are in combat.",
...
[123685]="Lob an explosive skull at an enemy, dealing <<1>> and creates a corpse near the enemy.",
[123699]="Lob an explosive skull at an enemy, dealing <<1>>.\n\nEvery third cast of this ability deals |cffffff50|r% increased damage.\n\nWhile slotted, casting any Necromancer ability while you are in combat will count towards the third cast.",
[123704]="Lob an explosive skull at an enemy, dealing <<1>> and creates a corpse near the enemy.",
...
[123719]="Lob an explosive skull at an enemy, dealing <<1>> and creates a corpse near the initial enemy.\n\nThe damage bounces up to |cffffff2|r times to other nearby enemies.",
...
[126531]="Whenever you deal direct damage, gain a stack of Resolve for <<1>>. Each stack increases your healing received by <<2>> and your Physical and Spell Resistance by <<3>>.\n\nThis effect can occur once every half second and can stack up to |cffffff9|r times.",
...
[126593]="Your Light Attacks apply the Touch of Z'en on enemies for <<1>>. Enemies with the Touch of Z'en take an additional <<2>> more damage for each damage over time effect you've placed on them, up to <<3>>. Enemies can only be affected by one Touch of Z'en at a time.",
...
[126629]="Dealing damage over time applies a stack of <<1>> to the target for <<2>>. At 20 stacks, <<1>> explodes, dealing <<3>> to the target and nearby enemies, increasing by <<4>> per additional monster hit, up to <<5>>. \n\nThe damage scales off your Weapon or Spell Damage and can occur once every <<6>>. Enemies can only have one <<1>> at a time and require 20 more stacks per group member wearing this set.",
...
[126921]="When your healing critically strikes or when you critically damage a target, spawn a ball of Hemoglobin at their location. After <<1>> the ball explodes, restoring <<2>> Magicka and applying Minor Vitality to you and your group members within |cffffff6|r meters of the ball for <<3>>, increasing their healing received and damage shield strength by <<4>>. This effect can occur once every <<5>>.",
...
[128484]="Healing received is reduced by 50% while near your spawn location in this Battleground",
...
[133290]="When you taunt a nearby enemy, you tether to them for <<1>>, as long as you remain within 8 meters of them. While tethered, you apply Major Maim to your enemy, reducing their damage done by <<2>>, and you gain Major Vitality, increasing your healing received and damage shield strength by <<3>>. This effect can occur once every <<4>>.",
...
[133387]="Increases your damage done by <<1>> but reduces your healing received by <<2>>.",
...
[134583]="Siphon away your enemies' vitality, dealing <<1>> and healing you for <<2>> of your missing Health every <<3>> for <<4>>.\n\nThis ability is considered direct damage.",
...
[134882]="When you have at least 40 Arena Gladiator's Proofs: Use to consume those 40 Proofs, and create a random weapon style page in the Knight of the Circle style.",
...
[135652]="While in combat, casting abilities that leave an effect on the ground will create a circle of healing frost for <<1>>. You and your group members restore <<2>> Health every <<3>> while inside the circle. This effect can occur once every <<4>> and scales off the higher of your Max Magicka or Stamina.",
...
[135876]="Increase your damage done to Bleeding enemies by <<1>>. Dealing non-Bleed damage to Bleeding enemies generates a stack of <<2>> for <<3>>, up to once per half second. After |cffffff10|r stacks you consume <<2>> and heal for <<4>> Health. The heal effect scales off the higher of your Max Magicka or Stamina.",
...
[135944]="Dealing Critical Damage increases your Weapon and Spell Damage by <<1>>, stacking up to 5 times. This effect can occur once every <<2>>.\n\nCompleting a fully-charged Heavy Attack removes all stacks and increases your Weapon and Spell Damage by <<3>> per stack removed.\n\nYou cannot have both effects active at the same time.",
...
[136045]="When you overheal yourself or a group member, you create a pool of Kyne's Blessing under the target for <<1>>. You and group members standing in Kyne's Blessing restore <<2>> Stamina and Magicka every <<3>>. This effect can occur once every <<4>>.",
...
[137156]="Rip into an enemy's flesh with your claws, dealing <<1>> over <<2>>. Deals up to <<3>>% more damage to enemies under <<4>>% Health.",
[137164]="Rip into an enemy's flesh with your claws, dealing <<1>> over <<2>>. Deals up to <<3>>% more damage to enemies under <<4>>% Health.\n\nDealing damage with this ability restores <<5>> Stamina and triggers Fury generation. Fury can only be generated once every <<6>> seconds from this portion of the ability.",
[137184]="Rip into an enemy's flesh with your claws, dealing <<1>> over <<2>> to them and all nearby enemies. Deals up to <<3>>% more damage to enemies under <<4>>% Health.\n\nHitting a target that is already affected from this ability extends the duration by <<5>> seconds, up to a maximum of <<6>>.",
[137259]="Siphon away your enemies' vitality, dealing <<1>>, healing you for <<2>> of your missing Health, and generating <<3>> Ultimate every <<4>> for <<5>>.\n\nThis ability is considered direct damage.",
...
[140300]="Reduce Health, Magicka, and Stamina cost of abilities by <<1>>. This effect does not work with abilities that drain their cost multiple times over their activation.",
...
[141929]="Increases your healing received by |cffffff1|r% per stage.",
...
[147459]="When you attempt to use resources to cast a healing ability while in combat and your dominant resource is under |cffffff50|r%, gain <<1>> for <<2>>, granting you <<3>> Ultimate every |cffffff1.5|r seconds.",
...
[151036]="Increases your damage done with summoned pets by <<1>>.",
[151101]="Adds <<1>> Weapon and Spell Damage to your area of effect abilities.",
[151125]="Bracing while in combat places a damage shield on you and up to 3 group members within 18 meters for <<1>> that absorbs up to <<2>> direct damage. If a damage shield breaks, the wearer of the shield restores <<3>> Magicka and Stamina.\n\nThis effect can occur once every <<4>> if a damage shield broke. This effect can occur once every <<5>> if no damage shields broke.",
...
[153685]="<<1>> calls on their staff's strength to protect themselves or the lowest health ally around them, granting a damage shield that absorbs <<2>> damage over <<3>>.\n\n|c00ccffUsed when <<1>> or an ally is below 25% Health.|r",
...
[153839]="<<1>> launches a fiery chain to grasp and pull an enemy to them, taunting them for <<2>> if they are not already taunted.\n\n|c00ccffUsed when the enemy can be moved and is further than 10 meters away.|r",
...
[154691]="Increases your damage done against monsters by up to <<1>> based on your missing Magicka, reaching the maximum at 50% Magicka.\n\nCurrent value: <<2>>",
...
[157245]="Increases Max Health by <<1>> and increases damage done by <<2>>.",
...
[159270]="Dealing direct damage with a Blink, Charge, Leap, Teleport, or Pull ability creates an area under the enemy that pulls enemies within <<1>> after <<2>>. After <<3>>, deal <<4>> to all enemies within <<5>> of you. This effect can occur once every <<6>> and scales off the higher of your Weapon or Spell Damage.\n\nThe pull will not apply Crowd Control Immunity but works once every <<7>> per target.",
...
[160190]="Reduces your damage taken by |cffffff2|r% per stage while Bracing and under the effects of a Damage Shield.",
...
[163098]="While in combat, applying a Major Buff or Debuff with a duration to a target grants you <<1>> Magicka and Stamina Recovery for <<2>>. \nWhile in combat, applying a Minor Buff or Debuff with a duration to a target grants you <<3>> Magicka and Stamina Recovery for <<4>>.",
...
[163357]="Activating crouch or Prowl activates and deactivates a 12 meter Aura of Pride. Up to 6 group members in the aura gain <<1>> Weapon and Spell Damage. Reduce your Health, Magicka, and Stamina Recovery by <<2>> for every target benefiting from your Aura of Pride.",
...
[166721]="When your healing critically strikes while Battle Spirit is active, you and group members within 12 meters of you gain <<1>> Critical Resistance and <<2>> Weapon and Spell Damage for <<3>>. Each group member affected reduces the Weapon and Spell Damage by <<4>> and Critical Resistance by <<5>>. This effect can occur once every <<6>>.",
...
[167063]="When you use an Ultimate ability, the closest 6 enemies within 12 meters have all Major and Minor debuffs applied to them extended by |cffffff1|r second per |cffffff20|r Ultimate spent. This effect can occur once every <<1>> per target.",
...
[167398]="When you deal direct damage, you have a <<1>> chance to create an area under the target that detonates after <<2>>, applying <<3)>> and <<4>> for <<5)>> to enemies within <<6>> meters. <<3>> lowers the Health Recovery, Magicka Recovery, and Stamina Recovery of enemy players by <<7>> per player hit. This effect can occur once every <<8>>.",
...
[172054]="Casting an Ultimate ability while in combat grants <<1>> of Ultimate spent as Ultimate to up to 11 other group members within 12 meters every <<2>> over <<3>>. Group members can only be affected by this set once every <<4>>.",
...
[172646]="Increases your Weapon and Spell Damage by up to <<1>>, based on your missing Stamina, reaching the maximum at 50% Stamina.\n\nCurrent bonus: <<2>> Weapon and Spell Damage.",
...
[176913]="You deal <<1>> increased damage to Bracing players. When you deal Light Attack damage to an enemy that is immune to crowd control, apply <<2>> for <<3>>, reducing their Magicka Recovery and Stamina Recovery by <<4>>. This effect can occur once every <<5>>.",
...
[182390]="While actively Bracing, you create a 12 meter zone of protection but you can no longer move. Group members within the zone increase the amount of damage they can block by <<1>> and their Health Recovery by <<2>>. The Health Recovery cannot affect yourself.",
...
[183006]="Infuse your arm with abyssal magic to form tentacles that lash out at your foes dealing <<1>> and generating Crux. Enemies are immobilized for <<2>> and marked with Abyssal Ink for <<3>>.\n\nIf an enemy is hit, you for heal for <<4>> Health, once per cast.\n\nYou deal <<5>> increased damage to enemies drenched in Abyssal Ink.",
...
[183122]="Harness pure knowledge into a beam of energy that scars the world in front of you. Channel the beam for up to <<1>>, dealing <<2>> Magic Damage every <<3>> to up to 6 enemies and snares them by <<4>>.\n\nCasting Exhausting Fatecarver consumes all Crux and increases damage done by <<5>>, duration by <<3>>, and snare by <<4>> per Crux spent.\n\nThis ability is considered direct damage.",
...
[183555]="Draw forth your tome and invoke the vigoratum of Hermaeus Mora to conjure a vortex of eldritch power. Entering this vortex grants you and your allies <<1>>, <<2>>, <<3>>, and <<4>>, increasing your Weapon and Spell Damage by <<5>> and your Health, Magicka, and Stamina Recovery by <<6>>.",
...
[184857]="You master the warp and weft of your very soul. \n\nWhen you restore Magicka or Stamina, your Weapon and Spell Damage increase by <<1>> for <<2>>.",
[184858]="You master the warp and weft of your very soul. \n\nWhen you restore Magicka or Stamina, your Weapon and Spell Damage increase by <<1>> for <<2>>.",
...
[185240]="You've stared too long into the abyss. When you generate Crux, you restore <<1>> Magicka and Stamina.",
[185243]="You've stared too long into the abyss. When you generate Crux, you restore <<1>> Magicka and Stamina.",
...
[185805]="Harness pure knowledge into a beam of energy that scars the world in front of you. Channel the beam for up to <<1>>, dealing <<2>> Magic Damage every <<3>> to up to 6 enemies.\n\nCasting Fatecarver consumes all Crux and increases damage done by <<4>> per Crux spent.\n\nThis ability is considered direct damage.",
...
[185839]="Summon a discharging rune under an enemy. After <<1>> the rune pulses, pulling in foes between 2 to 10 meters and etching them with scrawled glyphs that deal <<2>> over <<3>>.\n\nAn ally near the initial target can activate the <<4>> synergy, dealing <<5>> to enemies within 7 meters.",
...
[186229]="Draw forth your tome and invoke the enigmatum of Morian Zenas to conjure a vortex of eldritch power. Entering this vortex grants you and your allies <<1>>, <<2>>, <<3>>, and <<4>>, increasing your Weapon and Spell Damage by <<5>> and your Health, Magicka, and Stamina Recovery by <<6>>.\n\nThese effects cling to you and your allies for up to <<7>> after leaving the vortex.",
[186234]="Draw forth your tome and invoke the leviathanum of the Abyssal Sea to conjure a vortex of eldritch power. Entering this vortex grants you and your allies <<1>>, <<2>>, <<3>>, and <<4>>, increasing your Weapon and Spell Damage by <<5>> and your Health, Magicka, and Stamina Recovery by <<6>>.\n\nThe vortex also heals you and your allies for <<7>> Health over <<8>>.",
[186366]="Channel a beam of energy in front of you for up to <<1>>, dealing <<2>> Magic Damage every <<3>> to up to 6 enemies, and gain a damage shield that absorbs up to <<4>> damage and grants interrupt immunity.\n\nCasting <<5>> consumes all Crux and increases damage done by <<6>>, and decreases cost by <<7>> per Crux spent.\n\nThis ability is considered direct damage.",
...
[186603]="<<1>> conjures ice armor for themselves and nearby grouped allies. <<1>> reduces their Damage Taken by <<2>> for <<3>>. Allies gain Major Resolve, increasing Physical and Spell Resistance by <<4>> for <<5>>.",
...
[188456]="Overhealing yourself or an ally grants them <<1>> Armor for <<2>>. Healing yourself or an ally grants them Minor Vitality for <<3>>, increasing their healing received and damage shield strength by <<4>>.",
[188511]="· <<1>> damage to enemy\n· |cdc2222Chill|r: Slow <<2>> per stack, lasts <<3>>",
[188529]="Applying a Major or Minor Debuff to an enemy applies Star Venom to them for <<1>>. This effect can occur once every <<2>>. Whenever an enemy with Star Venom is healed, they take <<3>> Oblivion Damage, up to once every <<4>>.\n\nAn enemy can only be affected by one instance of Star Venom every <<2>>.",
...
[193130]="<<1>> uses a runic technique to taunt their enemy to attack them for <<2>>, applying Minor Maim to them for <<2>>, reducing their damage done by |cffffff5|r%.\n\n|c00ccffUsed when the enemy is not already taunted.|r",
...
[193331]="Harness pure knowledge into a beam of energy that scars the world in front of you. Channel the beam for up to <<1>>, dealing <<2>> Magic Damage every <<3>> to up to 6 enemies.\n\nCasting Fatecarver consumes all Crux and increases damage done by <<4>> per Crux spent.\n\nThis ability is considered direct damage.",
[193355]="· <<1>> damage to enemy\n· |cdc2222Chill|r: Slow <<2>> per stack, lasts <<3>>",
[193397]="Harness pure knowledge into a beam of energy that scars the world in front of you. Channel the beam for up to <<1>>, dealing <<2>> Magic Damage every <<3>> to up to 6 enemies and snaring them <<4>>.\n\nCasting Exhausting Fatecarver consumes all Crux and increases damage done by <<5>>, duration by <<3>>, and snare by <<4>> per Crux spent.\n\nThis ability is considered direct damage.",
[193398]="Channel a beam of energy in front of you for up to <<1>>, dealing <<2>> Magic Damage every <<3>> to up to 6 enemies. While channeling, you also gain a damage shield that absorbs up to <<4>> damage and grants interrupt immunity.\n\nCasting <<5>> consumes all Crux and increases damage done by <<6>>, and decreases cost by <<7>> per Crux spent.\n\nThis ability is considered direct damage.",
...
[193444]="Reduce your damage taken by <<1>>. \nAdds <<2>> Weapon and Spell Damage.\nAdds <<3>> Magicka and Stamina Recovery.\nDisable all other item set bonuses.",
...
[194346]="Tentacles rip through the air in a 5 meter radius around you dealing <<1>>.",
[194355]="Locate and highlight all Tomeshells within a 50 meter radius. All Seeing lasts for 15 seconds.",
...
[195727]="Move through the air with ease. Wiggling your tentacles causes you to move 50% faster.",
[195735]="Your gaze is so intimidating that it stops your enemies in their tracks! This blast is effective in a 15 meter radius and enemies will be stunned for 10 seconds.",
[195738]="Create an ink cloud that covers a 5 meter radius for 20 seconds and deals <<1>>. Ink spray also snares enemies that enter it by 50%.",
...
[198222]="Spirits of the dead want to extend their gratitude. They have temporarily imbued you with their power and form.",
...
[199287]="Grant yourself a short burst of speed for <<1>>.",
[199288]="Mobilize your forces, granting <<1>> and <<2>> to you and your group, increasing your Movement Speed by <<3>> and Mounted Speed by <<3>>.\n\nAlso grants immunity to snares and immobilizations.\n\nThe effect ends if you cast any spell on an enemy or ally.",
[199290]="Grant yourself a protective shield for <<1>> that prevents stamina decay.",
...
[200314]="· Deals <<1>> to enemy\n· Snare target <<2>> for <<3>>",
[200332]="· Deals <<1>> to enemy\n· Snare target <<2>> for <<3>>",
[200334]="· Deals <<1>> to enemy\n· Snare target <<2>> for <<3>>",
[200335]="· Deals <<1>> to enemy\n· Snare target <<2>> for <<3>>",
[200336]="· Deals <<1>> to enemy\n· Snare target <<2>> for <<3>>",
...
[200750]="Slam your staff down to activate its blessings, healing you and your allies in front of you for <<1>> Health.\n\nAlso grants <<2>>, increasing you and your allies' Physical Resistance and Spell Resistance by <<3>> for <<4>>.",
[200790]="Your single target damage over time effects last longer!\n\nSingle target damage over time effect duration increased by <<1)>> per stack.\n\nCurrent Bonus: <<2>>",
...
[201293]="Summon a discharging rune under an enemy. After <<1>> the rune pulses, pulling in foes between 2 to 10 meters and etching them with scrawled glyphs that deal <<2>> over <<3>>.\n\nAn ally near the initial target can activate the <<4>> synergy, dealing <<5>> to enemies within 7 meters.",
...
[201504]="Your Poisoned weapons are more effective.\n\nPoisoned weapon effectiveness increased by <<1)>> per stack.\n\nCurrent Bonus: <<2>>",
[201549]="Increases Healing Done by <<1>>.\n\nReduces Damage Taken by <<2>>.",
[201550]="Increases Magicka and Stamina Recovery by <<1>>.",
[201551]="Increases Weapon and Spell Damage by <<1>>.",
[201625]="<<1>> brands the earth underneath them with a rune of protection for <<2>>. Standing within the rune reduces the damage they and their allies take by <<3>>. \n\nIf the attacker is an Undead, Daedra, or Werewolf the rune reduces damage taken by an additional <<4>>.",
...
[202091]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
...
[202562]="0",
[202570]="0",
[202585]="Dealing damage applies a stack of Malady to your enemy, reducing healing received by <<1>> for <<2>>, up to 35 stacks. You can apply a stack once every <<3>>.\n\nApplying Malady gives you a stack of Contagion, reducing healing received by <<4>> for <<5>>, up to 15 stacks. You can only gain a stack once every <<6>>.",
...
[202766]="Activate to teleport to Shadow Image",
...
[202931]="Activate to teleport to Shadow Image",
...
[203378]="Create a cataclysmic storm at the target location that builds after |cffffff2|r seconds then lays waste to all enemies in the area, dealing <<1>> every <<2>> for <<3>>.\n\nEnemies hit are immobilized for <<4>>.",
...
[203776]="When backed up against a barrier, you can destroy threats to the barrier and protect the land in front of you from additional attacks for a few seconds.\n\nShares a cooldown with other magical protection charms.",
[203777]="Protect yourself from hazardous waves and watch as they part before you.\n\nShares a cooldown with other magical protection charms.",
[203778]="Force your attackers to the ground with a strong gravitational pull.\n\nShares a cooldown with other magical protection charms.",
...
[204879]="Reduces target's weapon and spell power.",
[204937]="· Deals <<1>> to enemy\n· Snare target <<2>> for <<3>>",
[204942]="Create a cataclysmic storm at the target location that builds after |cffffff2|r seconds then lays waste to all enemies in the area, dealing <<1>> every <<2>> for <<3>>.\n\nEnemies hit are immobilized for <<4>>.",
[205251]="Focus your Magicka into a protective barrier, granting you a damage shield that absorbs up to <<1>> damage for <<2>>.",
[205489]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[205607]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
...
[206729]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[207458]="Grants <<1>> which increases your Spell Damage by <<2>> for <<3>>.\n\nRestore <<4>> Magicka immediately.\nGrants you <<5>> which increases your Magicka Regeneration by <<6>> for <<7>>.",
[208043]="Reduces target's weapon and spell power.",
[208047]="While in combat, strengthens your Siphoning abilities at the cost of Ultimate:\n\nIncreases the damage and healing of Siphoning abilities by <<1>>. Reduces the cost of Siphoning abilities by <<1>>. Casting Siphoning abilities drains you of <<2>> Ultimate and increases your damage done for <<3>> by up to <<4>>, based on how high your current Health is.",
[208166]="Maximum Health increased by <<1>>.\n\nWhen you receive damage, enemies within 5 meters of you are struck by <<2>> for 20% of your Max Health in Physical damage once per <<3>>.\n\nYou also receive a stack of <<4>>, increasing damage done by <<2>> by 10% for <<5>> for each stack of <<4>>.",
[208252]="Restores <<1>> Ultimate to you every <<2>>. \n\nRestores <<3>> Ultimate to other players within 5 meters of you every <<2>>.",
[208256]="Each time you use a Light, Medium, or Heavy attack, damage your target with <<1>> for <<2>> Flame damage.\n\nEnemies struck by this attack receive a stack of <<3>>, increasing damage received from <<1>> by <<4>> for <<5>> for each stack of <<3>> on your target.",
[208329]="Activate to teleport to Shadow Image",
[209299]="Fast Travel to any previously disovered wayshrine.",
...
[209779]="Dealing damage with a <<1>>'s initial hit or every 5th tick creates a <<2>> near the enemy for <<3>>, up to one every <<4>>, up to 3 total. Your <<2>>s within 28 meters of one another link together, dealing <<5>>, <<6>>, every <<7>> to enemies near the links, up to once every <<8>> per enemy.\n\nEach <<2>> active grants you <<9>> Weapon and Spell Damage.",
...
[210811]="Casting a Bone Tyrant ability while in combat grants you <<1>> and <<2>> for <<3>>. <<2>> increases your healing received and reduces damage taken by up to <<4>> based on your missing Health. This can occur once every <<5>>, and is reduced by <<6>> for each slotted Bone Tyrant ability.\n\nCasting a corpse consumer ability consumes <<1>>, treating you as a corpse.",
...
[211546]="When you deal damage with a <<1>> ability, you gain a stack of <<2>> for <<3>>, once per attack and up to <<4>> times. Each stack grants <<5>> Magicka Recovery. When at max stacks, stacks no longer refresh, your Templar skill line abilities deal <<6>> bonus damage but is reduced to <<7>> against players, and a Wrathful Nova is cast on the enemy.\n\nWhen <<2>> expires at max stacks, you lose <<8>> of your current Magicka.",
[211662]="Learn all Furniture Plans from Vvardenfell to Necrom.",
...
[212362]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[212429]="When you have all three collectible fragments for the Mote of Furious Flame: Use to perform the ritual.",
[213157]="<<1>> launches a nightmarish exploding skull at an enemy, dealing <<2>>.",
[213158]="<<1>> sanctifies the ground at the target location, dealing <<2>> every <<3>> over <<4>> and applying Major Breach to enemies within, reducing their Spell and Physical Resistance by <<5>> for <<6>>.",
...
[213160]="<<1>> sacrifices their own power to repair damaged flesh, healing themselves or an ally in front of them for <<2>> Health but applying Minor Defile to themselves for <<3>>, reducing their healing received and damage shield strength by <<4>>.\n\n|c00ccffUsed when <<1>> or an ally is below 75% Health.|r",
...
[213162]="<<1>> absolves the misdeeds of fallen souls at the target location, healing themselves and their allies for <<2>> Health and removing up to |cffffff3|r negative effects.\n\n|c00ccffUsed when <<1>> or an ally is below 75% Health.|r",
...
[213164]="<<1>> summons an implement of moonlight that slashes the enemy's life force, dealing <<2>>.\n\nThey heal for <<3>> Health every <<4>> for <<5>>. The healing of this ability scales off their Max Health.",
[213165]="<<1>> wraps themselves in moon-empowered bone, granting them Major Resolve, increasing their Spell and Physical Resistance by <<2>> for <<3>>.  \n\nWhile active, enemies that strike them with ranged attacks will be pulled toward them once every <<4>> and become taunted for <<5>> if they are not already taunted.\n\nCreates a corpse when effect completes.",
[213166]="<<1>> summons an effigy of bone harboring the souls of fallen Khajiit at the feet of an enemy for <<2>> and applies fear for <<3>>. \n\nAfter <<4>> the totem grants Minor Protection to them and their allies, reducing their damage taken by <<5>> and begins fearing nearby enemies every <<4>>, causing them to cower in place for <<3>>.",
...
[213169]="<<1>> calls upon the power of Azurah, swinging a blade of lunar light in front of them, dealing <<2>>. \n\nEnemies damaged by this ability have <<3>> applied for <<4>>, causing them and their allies to restore <<5>> Magicka to attackers every <<6>> when damaging enemies.",
[213284]="<<1>> desecrates the ground at the target location, dealing <<2>> over <<3>>.",
[213633]="<<1>> seeds a large area of mushrooms in front of you, healing you and your allies for <<2>> Health.\n\nHeals for <<3>> more on allies that are within |cffffff8|r meters of you.\n\n|c00ccffUsed when <<1>> or an ally is below 75% Health.|r",
[213853]="· <<1>> damage to enemy\n· |cdc2222Chill|r: Slow <<2>> per stack, lasts <<3>>",
[213914]="Decreases ability cooldowns by <<1>> and damage taken by <<2>>.",
[214162]="Decreases ability cooldowns by <<1>> and increases Health by <<2>>.",
[214163]="Increases Max Health by <<1>> and damage done by <<2>>.",
[214402]="Gain <<1>> Offensive Penetration against enemies for each Major Buff they have active.\nGain <<2>> Weapon and Spell Damage against enemies for each Minor Buff they have active.",
[214421]="Reduces target's weapon and spell power.",
[214485]="Increase the strength of your Damage Shields by <<1>> to you and targets within 15 meters of you. Increase your Healing Done by <<2>> to targets more than 15 meters away from you.",
[214487]="Reduce the duration of Breakable Crowd Control, Immobilizes, and Snares on you by <<1>>.\n\nReduce the duration of your Breakable Crowd Control, Immobilizes, and Snares by <<2>>.",
[214490]="When you take direct damage, <<1:>> is applied to your enemy for <<2>>, reducing their Critical Damage done by <<3>>. This can occur once every <<4>>.\n\nIncrease your damage done to enemies with <<1>> by <<5>>.",
[214516]="When you deal Critical Damage to an enemy, glass shards burst 8 meters around them after <<1>>, dealing <<2>> to enemies in the burst and applying the Sundered status effect. This effect can occur once every <<3>> and the damage scales off the higher of your Weapon or Spell Damage.",
[214585]="Ignite the molten lava in your veins, limiting incoming damage to <<1>>% of your Max Health and dealing <<2>> to nearby enemies each second for <<3>>.",
[214597]="A powerful current flows through you!\n\nA charge of lightning that gains strength by opening more destructive pathways. The current will arc to nearby targets and attempt to restart its cycle.",
[214609]="Ignite the molten lava in your veins, limiting incoming damage to <<1>>% of your Max Health and dealing <<2>> to nearby enemies each second for <<3>>.",
[214631]="Ignite the molten lava in your veins, limiting incoming damage to <<1>>% of your Max Health and dealing <<2>> to nearby enemies each second for <<3>>.",
[214655]="When you taunt an enemy, gain a stack of <<1>> for <<2>>, up to 5 stacks max. You can only gain one stack every <<3>>. When <<1>> ends, you release the stacks in an 8 meter blast, dealing <<4>> to enemies hit and applying Major Maim to them for <<5>> per stack of <<1>> consumed, reducing their damage done by <<6>>. The damage scales off your Max Health.",
[214685]="Decreases damage taken by <<1>> and increases damage done by <<2>>.",
[214703]="<<1>> charges their and their grouped allies' weapons with volcanic power to gain Major Brutality and Sorcery, increasing Weapon and Spell Damage by <<2>> for <<3>>.",
[214708]="<<1>> summons a scorching cloud of ash at the target location for <<2>>, reducing enemy Movement Speed by <<3>> and healing them and their allies for <<4>> Health every <<5>>.",
[214851]="When your healing critically strikes, your target gains a Hydroglass Damage Shield that absorbs up to <<1>> damage for <<2>>. While the Damage Shield holds and for <<3>> after it ends, the target gains <<4>>, increasing their Critical Damage done by <<5>>. This effect can occur once every <<6>> per target.",
[214865]="<<1>> lays claim to an enemy's soul, dealing <<2>> to their target over <<3>>.",
[214866]="Lay claim to enemy souls, dealing <<1>> to the target and one other nearby enemy over <<2>>.\n\nFills an empty Soul Gem if an affected enemy dies.",
[214867]="On dealing damage, summon a Cindermoth that chases your target without mercy for <<1>>. If your target dies before the moth reaches them, it seeks a new target within 8 meters. The first enemy that nears the Cindermoth causes it to stop and burst after <<2>>, dealing <<3>> and Burning enemies within 8 meters. This can occur once every <<4>> and scales off your Weapon or Spell Damage.",
[214914]="Healing yourself or an ally makes the recipient <<1>> for <<2>>. When you deal direct damage to an enemy, the enemy becomes <<3>> for <<4>>. <<3>> enemies take <<5>> more damage from and deal <<6>> less damage to <<1>> targets.",
[214948]="<<1>>'s  soul explodes outwards, dealing <<2>> around them.\n\nWhen they take damage, deal an additional <<3>> to nearby enemies. This effect can occur once every <<4>> over <<5>>.",
[214960]="Fire a burst at your feet while flipping backwards <<1>>.\n\nCasting again within <<2>> increases the cost by <<3>>.",
[214974]="Fire a burst at your feet while flipping backwards <<1>>.\n\nCasting again within <<2>> increases the cost by <<3>>.",
[214978]="Fire a burst at your feet while flipping backwards <<1>>.\n\nCasting again within <<2>> increases the cost by <<3>>.",
[215000]="After taking direct damage three times within <<1>>, you create a 5 meter area for <<2>> that grants <<3>> to you and group members, reducing the cost of roll dodging by <<4>> and increasing block mitigation by <<5>> for <<6>>. This effect can occur once every <<7>>.",
[215001]="<<1>> burns an enemy from the inside with soulfire, dealing <<2>> over <<3>>. Upon completion, the soulfire overflows and explodes from the enemy, dealing <<4>> to all enemies near them.",
[215025]="Dealing damage with a fully-charged Heavy Attack throws an axe at the enemy, dealing <<1>> and reducing their Armor by <<2>> for <<3>>. This effect can occur once every <<4>> and scales off the higher of your Weapon or Spell Damage.\n\nThe axe drops to the ground after traveling to your target for <<5>>. Touching the axe reduces the cooldown of this set by <<6>>.",
[215042]="<<1>> channels draconic energy to suck in the air around them, dealing <<2>> to nearby enemies and healing themselves for <<3>> Health. Any enemy hit that is casting is interrupted and stunned for <<4>>.\n\nAfter <<5>>, they exhale fire dealing <<6>> to nearby enemies.",
[215048]="<<1>> releases their inner Dragon to gain Major Resolve for themselves and their grouped allies, increasing their Physical and Spell Resistance by <<2>> for <<3>>.\n\nThey gain a damage shield that absorbs up to  <<4>> damage for <<5>>, scaling off their Max Health.",
[215055]="Increases your Max Health by <<1>> while you have a Daedric Summoning ability active on yourself.",
[215056]="Increases your Max Health by <<1>> while you have a Daedric Summoning ability active on yourself.",
[215059]="Increases your Max Health by <<1>> while you have a Daedric Summoning ability active on yourself.",
[215060]="Increases your Max Health by <<1>> while you have a Daedric Summoning ability active on yourself.",
[215086]="Rush an enemy and ram them, dealing <<1>> and stunning them for <<2>>.",
[215089]="Fast Travel to any previously disovered wayshrine.",
[215092]="Fast Travel to any previously disovered wayshrine.",
[215200]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[215215]="<<1>> swipes each hand, sending a massive wave of power to crash into enemies in front of them, dealing  <<2>> followed by a second wave after <<3>> dealing <<4>>. Enemies hit are knocked back and stunned for <<5>>.",
[215381]="<<1>> desecrates the ground at the target location, dealing <<2>> over <<3>>.",
[215482]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[215483]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[215487]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[215491]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[215662]="Create a cataclysmic storm at the target location that builds after |cffffff2|r seconds then lays waste to all enemies in the area, dealing <<1>> every <<2>> for <<3>>.\n\nEnemies hit are immobilized for <<4>>.",
[215663]="Create a cataclysmic storm at the target location that builds after |cffffff2|r seconds then lays waste to all enemies in the area, dealing <<1>> every <<2>> for <<3>>.\n\nEnemies hit are immobilized for <<4>>.",
[215664]="Create a cataclysmic storm at the target location that builds after |cffffff2|r seconds then lays waste to all enemies in the area, dealing <<1>> every <<2>> for <<3>>.\n\nEnemies hit are immobilized for <<4>>.",
...
[215731]="Launch a concentrated blast of soul magic at a target.",
[215748]="When you have at least fifty Siege of Cyrodiil Merits: Use to consume those fifty Merits, and create a Runebound Tome: Unkindness of Ravens.",
[215779]="Applies Minor Defile which reduces healing received and Health Recovery by <<1>> on the enemy.",
[215783]="Applies Minor Defile which reduces healing received and Health Recovery by <<1>> on the enemy.",
[215867]="· Deals <<1>> to enemy\n· Snare target <<2>> for <<3>>",
[216057]="<<1>> dislodges a spirit's ties to a corpse, releasing spiritual energy and dealing <<2>> every <<3>> over <<4>>. Damage is done within 5m to enemies around the corpse, within 5m to enemies around them, and in a line between them and the corpse.\n\nAfter 10 seconds the corpse explodes, dealing an additional <<5>> to all enemies around the corpse.\n\n|c00ccffUsed when a corpse is nearby.|r",
[216445]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[216674]="Fire a burst at your feet while flipping backwards <<1>>.\n\nCasting again within <<2>> increases the cost by <<3>>.",
[216802]="Launch a concentrated blast of soul magic at yourself or an ally.",
[216813]="Launch a concentrated blast of soul magic at yourself or an ally.",
[216973]="Hurl your shield at an enemy, which then returns to you.",
...
[217061]="Hurl your shield at an enemy, which then returns to you.",
[217131]="<<1>> sends out a burst of soothing light, healing themselves or a nearby ally for <<2>> Health, and an additional <<3>> every <<4>> for <<5>> as the light momentarily lingers.\n\n|c00ccffUsed when <<1>> or an ally is below 75% Health.|r",
[217178]="Drag your weapon along the ground to smash a cone in front of you.",
[217179]="Drag your weapon along the ground to smash a cone in front of you.",
[217184]="Drag your weapon along the ground to smash a cone in front of you.",
[217188]="Damage Over Time",
[217190]="Immobilizes nearby enemies for <<1>> and deals <<2>>. An  ally can activate the <<3>> Synergy, damaging enemies held within the talons.",
[217228]="Channel the power in your staff to fling a bolt of volatile magic, causing an elemental explosion at the target location.",
[217257]="Tether yourself to an ally, manifesting a life link between you and them.",
[217340]="Twirl and throw an enchanted dagger at an enemy, which explodes after <<1>> and hits all enemies near the initial target.",
[217459]="Unleash a powerful burst of soul magic around you.",
[217460]="Unleash a powerful burst of soul magic around you.",
[217462]="Unleash a powerful burst of soul magic around you.",
[217465]="Unleash a powerful burst of soul magic around you.",
[217473]="Twirl and throw an enchanted dagger at an enemy, which returns to you after <<1>>  and hits additional enemies in the path.",
[217528]="Imbue yourself with the magical runes of Ulfsild for <<1>>. These runes trigger when you cast an ability with a cost, causing a burst of magic around you.",
...
[217607]="Conjure an imbued torch and sweep the area in front of you three times with its power.",
[217630]="Conjure an imbued torch and sweep the area in front of you three times with its power.",
[217633]="Conjure an imbued torch and sweep the area in front of you three times with its power.",
[217637]="Conjure an imbued torch and sweep the area in front of you three times with its power.",
[217663]="Pierce the air with a shrill whistle, calling your mount forth to trample enemies in a line. This ability cannot be re-activated while your mount is already attacking.",
[217699]="Bring out a banner to inspire yourself and nearby group members.",
[217777]="Fire a burst at your feet while flipping backwards <<1>>.\n\nCasting again within <<2>> increases the cost by <<3>>.",
[217784]="Launch a concentrated blast of soul magic at a target.",
[217794]="<<1>> sends out a burst of soothing light, healing themselves or a nearby ally for <<2>> Health, and an additional <<3>> every <<4>> for <<5>> as the light momentarily lingers.\n\n|c00ccffUsed when <<1>> or an ally is below 75% Health.|r",
[217808]="Hurl your shield at an enemy, which then returns to you.",
[217820]="Drag your weapon along the ground to smash a cone in front of you.",
[217872]="Twirl and throw an enchanted dagger at an enemy, which returns to you after <<1>>  and hits additional enemies in the path.",
[217905]="· <<1>> damage to enemy\n· |cdc2222Chill|r: Slow <<2>> per stack, lasts <<3>>",
[217978]="Unleash a powerful burst of soul magic around you.",
[217979]="Unleash a powerful burst of soul magic around you.",
[218270]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[218296]="When you have all three collectible fragments for the Mote of Furious Flame: Use to perform the ritual.",
[218361]="Convert a portion of your Magicka into a protective ward, gaining a damage shield that absorbs <<1>> damage for <<2>>. Damage shield strength capped at |cffffff50|r% of your Max Health.",
[218492]="The fracturing of the Arcane Knot has left you splintered and vulnerable to its damaging influence.",
[218774]="Slam your staff down to activate its blessings, healing you and your allies in front of you for <<1>> Health.\n\nAlso grants <<2>>, increasing you and your allies' Physical Resistance and Spell Resistance by <<3>> for <<4>>.",
[218871]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[218872]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[218873]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[218930]="Fast Travel to any previously disovered wayshrine.",
[219404]="Adds <<1>>  Status Effect Chance while your Health is above |cffffff50|r%. Adds <<2>> Healing Done while your Health is |cffffff50|r% or less.",
[219572]="When you kill a monster they burst with blood magic, dealing <<1>> of their Max Health to enemies within 6 meters as Bleed Damage, up to |cffffff24096|r Bleed Damage. This damage cannot critically strike. This effect can occur once every <<2>>.",
[219599]="Blocking an attack reduces your damage taken by <<1>> for <<2>>.",
[219638]="Ja'kh uses his keen eyes to point out heavy sacks.",
[219639]="When lockpicking, bestows an increased time to pick a lock, an increased chance to force a lock, and a reduced chance to break a lockpick.",
[219672]="Dealing damage with a fully-charged Heavy Attack grants you Major Berserk for <<1>>, increasing your damage done by <<2>>. This effect can occur once every <<3>>.",
[219679]="While in combat, each second you stand still grants you a stack of <<1>>, increasing your Critical Chance by <<2>> per stack, stacking up to 3 times. Each second you move, one stack is removed. Using charge and teleport abilities does not remove stacks, and exiting combat will remove all stacks of <<1>>.",
[219692]="Your Light and fully-charged Heavy Attacks gain <<1>> Status Effect Chance. The Status Effect is based on the damage type of your weapon.",
[219718]="Increases your healing received by <<1>>.",
[219780]="Launch a concentrated blast of soul magic at a target.",
[219972]="Drag your weapon along the ground to smash a cone in front of you.",
[219994]="· Deals <<1>> to enemy\n· Snare target <<2>> for <<3>>",
[219997]="· Deals <<1>> to enemy\n· Snare target <<2>> for <<3>>",
[219998]="· Deals <<1>> to enemy\n· Snare target <<2>> for <<3>>",
[219999]="· Deals <<1>> to enemy\n· Snare target <<2>> for <<3>>",
[220000]="· Deals <<1>> to enemy\n· Snare target <<2>> for <<3>>",
[220010]="Increases Max Magicka and Max Stamina by <<1>> for you and up to 11 other group members within 28 meters of you. This bonus persists through death.",
[220015]="While you have more than 50% Health, the Critical Damage and Critical Healing of any group members not wearing Lucent Echoes within 28 meters of you increases by <<1>>.\n\nWhile you have 50% or less Health, your damage taken from monsters is reduced by <<2>>.",
[220066]="When you have all three collectible fragments for the Mote of Furious Flame: Use to perform the ritual.",
[220160]="Store Blocked Damage and release it at enemies using Bash!\n\nBlocking damage instantly heals your party for <<1>> of the amount blocked.\n\nBash triggers <<2>> which consumes all stored damage and deals Physical damage in the amount of the stored damage. The damage increases based on your maximum health.\n\nBashing with at least <<3>> damage stored expands <<2>> to hit all enemies within <<4>>.",
[220184]="A powerful Tempest Caller comes to your aid!\n\nSummon the aid of a Tempest Caller who generates an immense storm on your location dealing <<1>> to nearby enemies. In addition, a constant bombardment of lightning strikes target enemies within 25 meters.\n\nThis can be used every <<2>>.",
[220189]="Transform into an avatar of the undead.\n\nSlain enemies empower you, increasing your Damage Done by <<1>>. This effect stacks.\nOnce every <<2>> you may Call the Dead and create a graveyard to call forth the fallen. These minions defend you until their death and cast Fear on nearby enemies.\n\nDamage Taken: |cFFFFFF-|r<<3>>\nDamage Done: |cFFFFFF|r<<4>>\n|cFFFFFF|rImmune to Crowd Control",
[220193]="The dead lend you a helping hand.\n\nEvery <<1>> a skeletal hand will ensnare enemies within |cffffff20|r meters, immobilizing them for <<2>>. Each snared enemy restores <<3>> Magicka and <<4>> Stamina.",
[220194]="Your speed is unmatched!\n\nYour Movement Speed increases by <<1>>. In addition, every <<2>> while you are moving you will leave a temporal echo in your wake which leeches speed from nearby enemies. \n\n|cFFFFFF5|r temporal echoes can be up at a time.",
[220195]="Careful consumption creates countless constricting elixirs!\n\nConsuming a potion creates a shower of elixirs that target nearby enemies and random nearby locations. Enemies affected by an elixir are reduced in size for <<1>>. During this time, their Damage Done is reduced by <<2>>, Damage Taken is increased by <<3>> and their movement speed is increased by <<4>>.",
[220229]="<<1>> summons an effigy of bone at their feet for <<2>> that grants Minor Protection to them and their allies, reducing their damage taken by <<3>>. \n\nAfter <<4>>, the totem begins fearing nearby enemies every <<4>>, causing them to cower in place for <<5>>.",
[220315]="Increase your Critical Chance by <<1>> for every Major Buff active on you, up to 1536 Critical Chance. \n\nIncrease your Critical Damage done by <<2>> for every Minor Buff active on you, up to 12% Critical Damage done.\n\nCurrent Bonus: <<3>> Critical Chance and <<4>> Critical Damage",
[220339]="Guard Captain Paratius saves you from death once every 10 minutes.",
[220427]="Weapon and Spell Damage increased by <<1>>",
[220428]="Magicka and Stamina Recovery is increased by <<1>>",
[220429]="Maximum Health increased by <<1>> and reduces your damage taken by <<2>>",
[220541]="Pierce the air with a shrill whistle, calling your mount forth to trample enemies in a line. This ability cannot be re-activated while your mount is already attacking.",
[220542]="Pierce the air with a shrill whistle, calling your mount forth to trample enemies in a line. This ability cannot be re-activated while your mount is already attacking.",
[220545]="Pierce the air with a shrill whistle, calling your mount forth to trample enemies in a line. This ability cannot be re-activated while your mount is already attacking.",
[220549]="Tether yourself to an ally, manifesting a life link between you and them.",
[220557]="Magic breaks against your defenses!\n\nMagic Damage taken decreased by <<1>>.\n\n|cFFFFFFPART OF THE NECROTIC SET (|r<<2>>|cFFFFFF/3 VISIONS)|r\nWhen you acquire |cFFFFFF3|r unique Necrotic Visions you gain access to the <<3>> Offensive Verse.",
[220563]="The creeping power of undeath is at your disposal!\n\nDamage dealt by Magic attacks increased by <<1>>.\n\n|cFFFFFFPART OF THE NECROTIC SET (|r<<2>>|cFFFFFF/3 VISIONS)|r\nWhen you acquire |cFFFFFF3|r unique Necrotic Visions you gain access to the <<3>> Offensive Verse.",
[220568]="Fallen enemies restore your vigor!\n\nEvery enemy slain during combat restores <<1>> Health, <<2>> Magicka, and <<3>> Stamina.\n\n|cFFFFFFPART OF THE NECROTIC SET (|r<<4>>|cFFFFFF/3 VISIONS)|r\nWhen you acquire |cFFFFFF3|r unique Necrotic Visions you gain access to the <<5>> Offensive Verse.",
[220730]="Request the aid of ghostly defenders!\n\nYou may call a defensive wall of soldiers to blockade your position. Every <<1>> the soldiers will attempt to stagger nearby foes. In addition, while behind the soldiers you gain a Damage Shield every <<2>> equal to <<3>>.\n\nThis can be used once every <<4>>.",
[220747]="Tether yourself to an ally, manifesting a life link between you and them.",
[220765]="Your direct attacks arc bolts of lightning!\n\nYour Shock damage is increased by <<1>> per stack. In addition, any direct attacks against a target cause a bolt of lightning to arc from it to another nearby target dealing <<2>>.\n\nThis can happen once every <<3>>.\n\nCurrent Bonus: <<4>>",
[220770]="Redirect blows back at their attacker!\n\nEnemies within <<1>> that deal direct damage to you are dealt <<2>>. \n\nDamage is increased by <<3>> per stack.\n\nCurrent Bonus: <<4>>",
[220775]="An emissary from Apocrypha comes to your defense!\n\nThis protector aids you during combat and grants you permanent boons from Apocrypha's infinite pages.\n\nEach stack reduces the cost of Bash by <<1>>.\n\n1 Stack: |cffffff<<2>>|r\n2 Stacks: |cffffff<<3>>|r\n3 Stacks: |cffffff<<4>>|r\n\nCurrent Bonus: <<5>>",
[220780]="Your potions are more readily available!\n\nThe cooldown of Potions is reduced by <<1>> per stack.\n\nCurrent Bonus: <<2>>",
[220787]="Dealing Critical Damage gives you a stack of <<1>> for <<2>>, up to once every <<3>>.\n\nUpon gaining your third stack, they merge into a crystal that launches at the last enemy you damaged, dealing <<4>>. This effect scales off the higher of your Weapon or Spell Damage, and you cannot gain <<1>> for <<5>> after the crystal is launched.",
[220801]="Summon restoring spirits with your staff, healing you and your allies in the target area for <<1>> Health over <<2>>.",
[220809]="Immunity to enemy control abilities.",
[220811]="Transform into an Iron Atronach and melt enemies with fiery fury!\n\nDamage Taken: |cFFFFFF-|r<<1>>\nImmune to Crowd Control",
[220953]="While actively Bracing, you gain <<1>> for <<2>>, reducing your damage taken by <<3>>. This effect activates only upon the start of Bracing and can occur once every <<4>>.\n\nBlocking any attack while <<1>> is active reduces its cooldown by <<5>>, up to once per application of the effect.",
[221093]="Fast Travel to any previously disovered wayshrine.",
[221094]="Fast Travel to any previously disovered wayshrine.",
[221105]="Sound a war horn to rally your forces, increasing you and your allies' Max Magicka, Health, and Stamina by <<1>> for <<2>>.",
[221127]="While crouched, you can see Witnesses and Guards through walls.\n\nSuccessfully pickpocketing a Witness or Guard applies <<1>> to them for <<2>>, stunning them and decreasing their Stealth detection radius by 30 meters for the duration.",
[221194]="<<1>>s appear near you!\n\nFire Orbs create a tether between you and the orb, dealing <<2>> to enemies the tether intersects every <<3>>.\n\nA <<1>> is created every <<4>> and they last <<5>>.",
[221203]="Violently drain the last spark of life from a corpse, dealing <<1>> over <<2>> to all enemies around the corpse and between you and the corpse.  \n\nIf the siphon lasts its full duration it causes the corpse to explode, dealing an additional <<3>> to all enemies around the corpse.  This ability scales off your highest offensive stats.\n\nWhile slotted, your damage done is increased by <<4>>.",
[221478]="Learn all Furniture Plans from Necrom onward.",
[221492]="While in combat, you gain one of five random Major buffs which changes every <<1>>. Enemies within 12 meters of you gain one of five random Minor debuffs depending on which buff you have. The available effects are:\n\nMajor Berserk and Minor Maim\nMajor Resolve and Minor Breach\nMajor Force and Minor Brittle\nMajor Evasion and Minor Vulnerability\nMajor Courage and Minor Cowardice",
[221598]="<<1>> violently drains the essence of life from an enemy, dealing <<2>> over <<3>> to all enemies around the target and between them and the enemy.\n\nWhen the siphon ends it causes an explosion, dealing an additional <<4>> to all enemies around the target.",
[221690]="Summon a blizzard around you while blocking, inflicting <<1>> every <<2>> to enemies within your blizzard. Your blizzard has a |cffffff15|r% chance of inflicting Chilled on enemies damaged.",
[221692]="Summon a blizzard around you while blocking, inflicting <<1>> every <<2>> to enemies within |cffffff6|r meters. Your blizzard has a |cffffff15|r% chance of inflicting Chilled on enemies damaged.",
[221930]="Launch a concentrated blast of soul magic at a target.",
[221969]="Launch a fiery chain to grasp and pull an enemy to you, dealing <<1>>.\n\nGrants Major Expedition, increasing your Movement Speed by <<2>> for <<3>>.\n\nThis attack cannot be dodged or reflected.",
[221999]="Hurl your shield at an enemy, which then returns to you.",
[222209]="<<1>> conjures a ghostly spirit of a fallen Khajiit to redeem its soul in service to Azurah for <<2>>. The spirit heals them or the lowest Health ally around them every <<3>> restoring <<4>> Health.\n\n|c00ccffUsed when <<1>> or an ally is below 75% Health.|r",
[222285]="Imbue yourself with the magical runes of Ulfsild for <<1>>. These runes trigger when you cast an ability with a cost, causing a burst of magic around you.",
[222313]="Channel the power in your staff to fling a bolt of volatile magic, causing an elemental explosion at the target location.",
[222405]="Reinforce your defenses when you are more vulnerable!\n\nFor every <<1>> of missing health, you take |cffffff1|r% less damage. This reduction has a limit based on the number of stacks obtained.\n\nEach stack increases the limit by <<2>>.\n\nCurrent Damage Taken Limit: |cffffff-|r<<3>>.",
[222413]="Your strength rises!\n\nFor every <<1>> Ultimate you have, you deal <<2>> increased damage. When you reach |cffffff500|r Ultimate, your damage is increased by another |cffffff5|r%. In addition, Ultimate costs are increased by <<3>> per stack.\n\nCurrent Bonus: <<4>>\nCost Increase: <<5>>",
[222418]="Your resources replenish swiftly!\n\nFor each |cffffff1|r% missing |cffffffMagicka|r, you gain |cffffff1|r% |cffffffMagicka Recovery|r, up to the limit. For each |cffffff1|r% missing |cffffffStamina|r, you gain |cffffff1|r% |cffffffStamina Recovery|r, up to the limit.\n\nThe limit increases based on the number of stacks obtained.\n\nEach stack increases the limit by <<1>>.\n\nCurrent Limit: <<2>>",
[222460]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[222613]="You are vulnerable to Chain Lightning!\n\nXoryns lightning has opened a fracture in your armor that allows Chain Lightning to be more destructive on a second hit.",
[222677]="The fracturing of the Arcane Knot has left you splintered and vulnerable to its damaging influence.",
[222678]="Imbue yourself with the magical runes of Ulfsild for <<1>>. These runes trigger when you cast an ability with a cost, causing a burst of magic around you.",
[222864]="A dark force connects you with your opponent, draining its power and giving it to you.",
[222940]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[222966]="Hurl your shield at an enemy, which then returns to you.",
[223031]="Violently drain the last spark of life from a corpse, dealing <<1>> over <<2>> to all enemies around the corpse and between you and the corpse.  \n\nIf the siphon lasts its full duration it causes the corpse to explode, dealing an additional <<3>> to all enemies around the corpse.  This ability scales off your highest offensive stats.\n\nWhile slotted, your damage done is increased by <<4>>.",
[223292]="Conjure an imbued torch and sweep the area in front of you three times with its power.",
[223477]="Immobilizes nearby enemies for <<1>> and deals <<2>>. An  ally can activate the <<3>> Synergy, damaging enemies held within the talons.",
[223706]="<<1>> summons a scorching cloud of ash at the target location for <<2>>, reducing enemy Movement Speed by <<3>> and healing them and their allies for <<4>> Health every <<5>>.",
[223707]="<<1>> lays claim to an enemy's soul, dealing <<2>> to their target over <<3>>.",
[223708]="<<1>> releases their inner Dragon to gain Major Resolve for themselves and nearby allies, increasing their Physical and Spell Resistance by <<2>> for <<3>>. \n\nThey gain a damage shield that absorbs up to <<4>> damage for <<5>>, scaling off their Max Health.",
[223709]="Lay claim to enemy souls, dealing <<1>> to the target and one other nearby enemy over <<2>>.\n\nFills an empty Soul Gem if an affected enemy dies.",
[223712]="<<1>> desecrates the ground at the target location, dealing <<2>> over <<3>>.",
[223753]="Violently drain the last spark of life from a corpse, dealing <<1>> over <<2>> to all enemies around the corpse and between you and the corpse.  \n\nIf the siphon lasts its full duration it causes the corpse to explode, dealing an additional <<3>> to all enemies around the corpse.  This ability scales off your highest offensive stats.\n\nWhile slotted, your damage done is increased by <<4>>.",
[223919]="<<1>> lobs an explosive skull at an enemy, dealing <<2>>.",
[223920]="<<1>> sacrifices their own power to repair damaged flesh, healing them or an ally in front of them for <<2>> Health but applying Minor Defile to themself for <<3>>, reducing their healing received and damage shield strength by <<4>>.\n\n|c00ccffUsed when <<1>> or an ally is below 75% Health.|r",
[223921]="<<1>> slices into the enemy's life force, dealing <<2>>.\n\nThey heal for <<3>> Health every <<4>> for <<5>>. The healing of this ability scales off your Max Health.",
[224084]="Dealing damage with Burning Light twice within <<1>> creates a 5 meter area for <<2>>. This effect can occur once every <<3>>. \n\nWhile in the area, dealing damage with an Aedric Spear ability launches a spear at your target, dealing <<4>> and applying Sundered and increasing your Weapon and Spell Damage by <<5>> for <<6>>. The damage scales off the higher of your Weapon or Spell Damage.",
[224242]="While you have a permanent pet active, gain <<1>> Health and <<2>> Armor.\n\nWhile you do not have a permanent pet active, increase your Damage Done and Healing Done by <<3>>. This value is reduced to <<4>> while affected by Battle Spirit.",
[224328]="Instant cast. Summon an immobile Gloom Wraith for 60 seconds.  Decreases Max Magicka by 15%. Costs 20 Magicka. Cooldown 5 seconds. \n—Uses Arcane Bolt, a light damage spell on any enemies within 15m.",
[224329]="Instant cast. Summon an immobile Gloom Wraith for 60 seconds.  Decreases Max Magicka by 15%. Costs 20 Magicka. Cooldown 5 seconds. \n—Uses Arcane Bolt, a light damage spell on any enemies within 15m.",
[224330]="Instant cast. Summon an immobile Gloom Wraith for 60 seconds.  Decreases Max Magicka by 15%. Costs 20 Magicka. Cooldown 5 seconds. \n—Uses Arcane Bolt, a light damage spell on any enemies within 15m.",
[224331]="Instant cast. Summon an immobile Gloom Wraith for 60 seconds.  Decreases Max Magicka by 15%. Costs 20 Magicka. Cooldown 5 seconds. \n—Uses Arcane Bolt, a light damage spell on any enemies within 15m.",
[224387]="Reduces target's weapon and spell power.",
[224426]="· <<1>> damage to enemy\n· |cdc2222Chill|r: Slow <<2>> per stack, lasts <<3>>",
[224437]="Instant cast. Summon an immobile Gloom Wraith for 60 seconds.  Decreases Max Magicka by 15%. Costs 20 Magicka. Cooldown 5 seconds. \n—Uses Arcane Bolt, a light damage spell on any enemies within 15m.",
[224438]="Instant cast. Summon an immobile Gloom Wraith for 60 seconds.  Decreases Max Magicka by 15%. Costs 20 Magicka. Cooldown 5 seconds. \n—Uses Arcane Bolt, a light damage spell on any enemies within 15m.",
[224439]="Instant cast. Summon an immobile Gloom Wraith for 60 seconds.  Decreases Max Magicka by 15%. Costs 20 Magicka. Cooldown 5 seconds. \n—Uses Arcane Bolt, a light damage spell on any enemies within 15m.",
[224440]="Instant cast. Summon an immobile Gloom Wraith for 60 seconds.  Decreases Max Magicka by 15%. Costs 20 Magicka. Cooldown 5 seconds. \n—Uses Arcane Bolt, a light damage spell on any enemies within 15m.",
[224612]="Grants one inactive Transformation Verse from Mora's Boons.\n\nThe scroll is only usable in Infinite Archive and is limited to a single use per Archive run.",
...
[224767]="Consume to advance A Signature with Class achievement.",
...
[224836]="· Pull enemy towards you\n· Deals <<1>> flame damage",
[225970]="Violently drain the last spark of life from a corpse, dealing <<1>> over <<2>> to all enemies around the corpse and between you and the corpse.  \n\nIf the siphon lasts its full duration it causes the corpse to explode, dealing an additional <<3>> to all enemies around the corpse.  This ability scales off your highest offensive stats.\n\nWhile slotted, your damage done is increased by <<4>>.",
[226195]="Activate to teleport to Shadow Image",
[226383]="When you cast a Shadow ability, you gain <<1>> for <<2>>, up to once every <<3>>. <<1>> causes you to dodge the next attack made against you and automatically curses the attacking enemy, applying <<4>> for <<5>>, increasing their damage taken by <<6>>.",
[226393]="Your Light Attacks deal <<1>> over <<2>>. This effect can activate <<3>>, up to once every <<4>>.\n\nYour fully-charged Heavy Attacks consume up to <<5>> stacks of your <<3>> to deal <<6>> around the target, dealing up to <<7>>% more damage to enemies below <<8>>% Health.\n\nThe damage scales off the higher of your Weapon or Spell Damage increases by <<9>> per stack of Recursive Flame and Pyrebrand.",
[226484]="Overwhelmed by anger from a missed attack.\n\nFor <<1>> damage done increased by <<2>>.",
[226791]="Your direct attacks arc bolts of lightning!\n\nYour Shock damage is increased by <<1>>. In addition, any direct attacks against a target cause a bolt of lightning to arc from it to another nearby target dealing <<2>>.",
[226885]="<<1>> <<2>> to your target for <<3>>. <<2>> causes an eagle to attack your target every <<4>> after a 3 second delay, dealing <<5>> per attack. \n\nApplying <<2>> grants you <<6>> for <<7>>, increasing your damage done by <<8>> against enemies with <<2>>.\n\nThis effect can occur every <<4>>. You can have one <<2>> active at a time.",
[226966]="Violently drain the last spark of life from a corpse, dealing <<1>> over <<2>> to all enemies around the corpse and between you and the corpse.  \n\nIf the siphon lasts its full duration it causes the corpse to explode, dealing an additional <<3>> to all enemies around the corpse.  This ability scales off your highest offensive stats.\n\nWhile slotted, your damage done is increased by <<4>>.",
[226976]="· <<1>> damage to enemy\n· |cdc2222Chill|r: Slow <<2>> per stack, lasts <<3>>",
[226994]="Instant cast. Summon an immobile Gloom Wraith for 60 seconds.  Decreases Max Magicka by 15%. Costs 20 Magicka. Cooldown 5 seconds. \n—Uses Arcane Bolt, a light damage spell on any enemies within 15m.",
[227068]="Consuming a corpse causes the corpse to explode, dealing <<1>> Disease Damage to enemies within 5 meters and applying the Diseased status effect and <<2>> to them for <<3>>, reducing their Physical and Spell Resistance by <<4>>. This effect can occur once every <<5>>, scales off the higher of your Weapon or Spell Damage, and deals <<6>> more damage for each Grave Lord ability slotted.",
[227170]="Your potions are more readily available!\n\nThe cooldown of Potions is reduced by <<1>>\n\nCurrent Bonus: <<2>>",
[227198]="Increases your healing received by <<1>>.",
[227250]="· Pull enemy towards you\n· Deals <<1>> flame damage",
[227252]="· Pull enemy towards you\n· Deals <<1>> flame damage",
...
[227381]="Dealing damage with an Arcanist ability applies two random status effects to your target and generates a Crux. This effect can occur once every <<1>>. Dealing damage with a Herald of the Tome ability reduces this cooldown by <<2>>, up to once every <<3>>.\n\nIncreases your damage done with status effects by <<4>>.",
[227609]="Focus your attention on a singular enemy and drag your weapon along the ground to smash a cone towards them.",
[227628]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[227631]="Unleash a barrage of arrows at an enemy, dealing <<1>> over <<2>>. \n\nYou can move at full speed and are immune to all disabling effects while channeling this attack.",
[227872]="· Deals <<1>> to enemy\n· Snare target <<2>> for <<3>>",
[227912]="· <<1>> damage to enemy\n· |cdc2222Chill|r: Slow <<2>> per stack, lasts <<3>>",
[227930]="Instant cast. Summon an immobile Gloom Wraith for 60 seconds.  Decreases Max Magicka by 15%. Costs 20 Magicka. Cooldown 5 seconds. \n—Uses Arcane Bolt, a light damage spell on any enemies within 15m.",
[227931]="Instant cast. Summon an immobile Gloom Wraith for 60 seconds.  Decreases Max Magicka by 15%. Costs 20 Magicka. Cooldown 5 seconds. \n—Uses Arcane Bolt, a light damage spell on any enemies within 15m.",
[228085]="· <<1>> damage to enemy\n· |cdc2222Chill|r: Slow <<2>> per stack, lasts <<3>>",
[228138]="Fire Bolt Ammo",
[228190]="When you have at least fifty Arena Gladiator Proofs: Use to consume those fifty Proofs and create a Runebound Tome: Feral Favor Markings.",
[228254]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[228348]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
...
[228676]="Disperse into a dark mist, causing the next |cffffff3|r projectiles to deal no damage to you for <<1>> while you dash forward and reappear at your target location after a short duration.",
[228755]="Weapon and Spell Damage increased by <<1>>",
[229100]="· Deals <<1>> to all enemies in front of you",
[229103]="· Deals <<1>> to all enemies in front of you",
[229208]="When you have all three collectible fragments for the Mote of Furious Flame: Use to perform the ritual.",
[229214]="When you have all three collectible fragments for the Mote of Furious Flame: Use to perform the ritual.",
[229348]="· Deals <<1>> to all enemies in front of you",
[229849]="Fast Travel to any previously disovered wayshrine.",
[229850]="Fast Travel to any previously disovered wayshrine.",
[229857]="Channel the power in your staff to fling a bolt of volatile magic, causing an elemental explosion at the target location.",
[229906]="While under the effect of the Grasping Void, Health Regeneration is reduced to 0.",
...
[230004]="While you have Crowd Control Immunity, you are immune to Snares and Immobilizations.",
[230082]="While you are using a non-Ram Siege Weapon you are immune to knockback and disabling effects, you reduce your damage taken by <<1>>, and you can see enemies through walls.",
[230442]="Rend an enemy, dealing <<1>> and applying the <<2>> status effect.\n\nDeals up to <<3>>% more damage based on your missing Health.",
[230444]="Allow your monstrous appetites to take hold, increasing your Weapon and Spell Damage by <<1>> every <<2>>, up to |cffffff5|r times.\n\nWhile toggled on, the Health cost of this ability increases by <<3>> per stack and you cannot be healed by anyone but yourself, your pets, or your Companions.\n\nWhen toggled off, you heal for <<4>> of the total Health cost you spent while active.",
[230451]="Siphon away your enemies' vitality, dealing <<1>>, healing you for |cffffff25|r% of your missing Health, and generating <<2>> Ultimate every <<3>> for <<4>>.",
[230454]="Subdue enemies around you with your baleful gaze, stunning them for <<1>> if they are facing your direction.\n\nThis stun cannot be blocked.",
[230457]="Launch yourself at an enemy, dealing <<1>> to all enemies in the area, knocking them back <<2>>, and stunning them for <<3>>.",
[230461]="Immunity to enemy control abilities.",
[230464]="Light attack that deals <<1>>.",
[230466]="Hold to charge up a heavy attack, dealing up to <<1>> with each swipe.",
[230473]="Bite the enemy dealing <<1>> and <<2>> over <<3>>.\n\nTaunts the target to attack you for <<4>>.",
[230476]="Charge an enemy dealing <<1>> and hitting all enemies within <<2>>. Weaker enemies are knocked back and stunned by the impact.\n\nGenerates <<3>> Ultimate.\n\nThis ability has a cooldown of <<4>>.",
[230483]="Smash the ground dealing <<1>> to all enemies within <<2>> of yourself. Any enemies hit are interrupted and stunned for <<3>>.\n\nGenerates <<4>> Ultimate.\n\nThis ability has a cooldown of <<5>>.",
[230491]="Stomp the ground sending out multiple tremors that travel <<1>> dealing <<2>> to enemies and knocking them back.\n\nGenerates <<3>> Ultimate.\n\nThis ability has a cooldown of <<4>>.",
[230492]="When your attack is dodged, increase your Weapon and Spell Damage by <<1>> for <<2>>, stacking up to 5 times. This effect can occur once every <<3>>.",
[230506]="Empower yourself for <<1>>, reducing damage taken by |cffffff5|r% any time you deal direct damage, up to |cffffff5|r times and healing <<2>> health every <<3>>.\n\nWhile active any Direct Damage you deal heals you for |cffffff50|r% of the damage inflicted. Dealing direct damage |cffffff5|r times converts this ability into <<4>>.\n\nGenerates <<5>> Ultimate.\n\nThis ability has a cooldown of <<6>>.",
[230515]="Sacrifice your <<1>> active effect to unleash a powerful howl that deals <<2>> every <<3>> over <<4>>, reducing the damage enemies do by <<5>> and slowing their movement by <<6>> for <<7>>.\n\nGenerates <<8>> Ultimate.",
[230523]="Leap and slam down dealing <<1>>, stunning all enemies within <<2>>.\n\nThe impact revives allies and emits an energy ring that grants the <<3>> synergy. <<3>> generates <<4>> Ultimate, resets all cooldowns and grants <<5>> of critical strikes.",
...
[230703]="When an enemy blocks one of your attacks, reduce the amount of damage they can block by <<1>> for <<2>>. This effect can stack up to 5 times and can occur once every <<3>>.",
[230718]="When you deal direct damage with a Blink, Charge, Leap, Teleport, or Pull ability, decrease the Critical Resistance of your enemy by <<1>> and increase your Critical Resistance by an equal amount for <<2>>. This effect can occur once every <<3>>.",
[230732]="<<1>> channels draconic energy to suck in the air around them, dealing <<2>> to nearby enemies and healing themselves for <<3>> Health for each enemy hit.\n\nAny enemy hit that is casting is interrupted and stunned for <<4>>.",
[230917]="Violently drain the last spark of life from a corpse, dealing <<1>> over <<2>> to all enemies around the corpse and between you and the corpse.  \n\nIf the siphon lasts its full duration it causes the corpse to explode, dealing an additional <<3>> to all enemies around the corpse.  This ability scales off your highest offensive stats.\n\nWhile slotted, your damage done is increased by <<4>>.",
[231214]="You have 2 minutes to leave the spawn location before you are moved into the arena.",
[231274]="You have 2 minutes to leave the spawn location before you are moved into the arena.",
[231322]="You have 2 minutes to leave the spawn location before you are moved into the arena.",
[231323]="You have 2 minutes to leave the spawn location before you are moved into the arena.",
[231333]="You have 2 minutes to leave the spawn location before you are moved into the arena.",
[231334]="You have 2 minutes to leave the spawn location before you are moved into the arena.",
[232080]="Fast Travel to any previously disovered wayshrine.",
[232081]="Fast Travel to any previously disovered wayshrine.",
[232112]="Twirl and throw an enchanted dagger at an enemy, which returns to you after <<1>>  and hits additional enemies in the path.",
[232268]="Activate to teleport to Shadow Image",
[232324]="You have 2 minutes to leave the spawn location before you are moved into the arena.",
[232325]="You have 2 minutes to leave the spawn location before you are moved into the arena.",
[232335]="You have 2 minutes to leave the spawn location before you are moved into the arena.",
[232336]="You have 2 minutes to leave the spawn location before you are moved into the arena.",
[232344]="You have 2 minutes to leave the spawn location before you are moved into the arena.",
[232345]="You have 2 minutes to leave the spawn location before you are moved into the arena.",
[232355]="You have 2 minutes to leave the spawn location before you are moved into the arena.",
[232356]="You have 2 minutes to leave the spawn location before you are moved into the arena.",
[232387]="Combine this item with 5 Battlemaster Tokens to create a Runebound Tome: Fanged Worm Styles.",
[232400]="Activate to teleport to Shadow Image",
[232405]="Activate to teleport to Shadow Image",
[232406]="Combine this item with 5 Battlemaster Tokens to create a Runebound Tome: Horned Dragon Styles.",
[232410]="Combine this item with 5 Battlemaster Tokens to create a Runebound Tome: Heavy Storm Lord and Weapon Styles.",
[232414]="Combine this item with 5 Battlemaster Tokens to create a Runebound Tome: Heavy Fire Drake and Weapon Styles.",
[232418]="Combine this item with 5 Battlemaster Tokens to create a Runebound Tome: Heavy Pit Daemon and Weapon Styles.",
[232422]="Combine this item with 5 Battlemaster Tokens to create a Runebound Tome: Battleground Runner Styles.",
[232428]="Combine this item with 10 Battlemaster Tokens to create a Runebound Tome: Medium Fire Drake Outfit Styles.",
[232432]="Combine this item with 10 Battlemaster Tokens to create a Runebound Tome: Light Storm Lord Outfit Styles.",
[232436]="Combine this item with 10 Battlemaster Tokens to create a Runebound Tome: Light Pit Daemon Outfit Styles.",
[232440]="Combine this item with 10 Battlemaster Tokens to create a Runebound Tome: Eld Angavar Weapon Styles.",
[232444]="Combine this item with 20 Battlemaster Tokens to create a Runebound Tome: Mask of Battled Powers Adornment.",
[232461]="When you have at least thirty Battlemaster's Tokens: Use to consume those thirty Tokens and create a Warbear Harness fragment.",
[232468]="When you have at least twenty Siege of Cyrodiil Merits: Use to consume those twenty Merits and create a Warbear Armor fragment.",
[232472]="When you have at least ten Arena Gladiator Proofs: Use to consume those ten Proofs and create a Warbear Saddle fragment.",
[232783]="Violently drain the last spark of life from a corpse, dealing <<1>> over <<2>> to all enemies around the corpse and between you and the corpse.  \n\nIf the siphon lasts its full duration it causes the corpse to explode, dealing an additional <<3>> to all enemies around the corpse.  This ability scales off your highest offensive stats.\n\nWhile slotted, your damage done is increased by <<4>>.",
...
[233040]="Whenever you are dealt damage from a damage over time ability, you deal <<1>> to the attacker. This effect scales off the higher of your Weapon or Spell Damage. Reduce your damage taken from over time abilities by <<2>>.",
[233263]="Spirits of the dead want to extend their gratitude. They have temporarily imbued you with their power and form.",
[233878]="Immunity to enemy control abilities.",
[233918]="Place a rune of teleportation under your feet that lasts as long as you remain within |cffffff40|r meters of it.\n\nIf you move further than |cffffff40|r meters from the rune you are teleported to it.",
[233921]="Activate to teleport to Shadow Image",
[234024]="When you Break Free, gain <<1>> Movement Speed for <<2>>. This effect can occur once every <<3>>.",
[234087]="Gain <<1>> Offensive Penetration. Reduce your damage done by  <<2>>.",
[234294]="When you cleanse a negative effect from yourself or an ally, restore <<1>> Ultimate to the target. This effect can occur once every <<2>> per target.",
[234693]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[234696]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[234815]="Tune into a Voskrona Guardian and pummel enemies into the dirt!\n\nMax Health: |cFFFFFF+|r<<1>>\nWeapon and Spell damage: |cFFFFFF+|r<<2>>\nDamage Taken: |cFFFFFF-|r<<3>>\nHealth Recovery: |cFFFFFF+|r<<4>>\nMovement Speed: |cFFFFFF+|r<<5>>\nImmune to Crowd Control",
[234862]="Immunity to enemy control abilities.",
[234878]="Transform into a Werewolf Behemoth and tear enemies to shreds!\n\nMax Health: |cFFFFFF+|r<<1>>\nWeapon and Spell damage: |cFFFFFF+|r<<2>>\nDamage Taken: |cFFFFFF-|r<<3>>\nHealth Recovery: |cFFFFFF+|r<<4>>\nMovement Speed: |cFFFFFF+|r<<5>>\nImmune to Crowd Control",
[235113]="· Deals <<1>> to enemy\n· Snare target <<2>> for <<3>>",
[235248]="· Deals <<1>> to enemy\n· Snare target <<2>> for <<3>>",
[235358]="When you have all three collectible fragments for the Mote of Furious Flame: Use to perform the ritual.",
[235594]="You are vulnerable to Frenzy!\n\nThe Ruinach's blades have opened a fracture in your armor that allows Frenzy to be more destructive on a second hit.",
[235743]="While in combat, casting an ability that leaves an effect on the ground creates a 6 meter Spike Vortex that deals <<1>> over <<2>> to enemies inside it. After <<2>>, enemies within the Vortex are dealt <<3>> over <<4>>. This effect can occur once every <<5>> and scales off the higher of your Weapon or Spell Damage.",
[235829]="Dealing damage with a fully-charged Heavy Attack places an electric charge on yourself and below your enemy. After <<1>>, both charges explode in a 4 meter blast, each dealing <<2>> to enemies hit. This effect can occur once every <<3>> and scales off the higher of your Weapon or Spell Damage.",
[235871]="Blocking 3 attacks within <<1>> creates an 8 meter Windshield at your feet for <<2>>. Enemies within the area gain <<3:>>, increasing their Critical Damage taken by <<4>>%. While you are within the area, you gain <<5:>>, reducing your damage taken by <<6>>. This effect can occur once every <<7>>. You can only have 1 Windshield active at a time.",
[235887]="· Nearby enemies are knocked back <<1>> and snared <<2>> for <<3>>",
[235922]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[235993]="When you take damage, gain one random effect for <<1>>:\nGain <<2>>, reducing your damage taken by <<3>>.\nGain a damage shield that absorbs up to <<4>> damage.\nHeal for <<5>> Health every <<6>>.\n\nThe Health restore scales off of your Max Health. This effect can occur once every <<7>>.",
[236169]="Fast Travel to any previously disovered wayshrine.",
[236170]="Fast Travel to any previously disovered wayshrine.",
[236319]="<<1>> boost to all experience points.",
[236327]="Surface your will to survive, healing yourself for <<1>> of your missing Health.",
[236351]="While in combat, casting an ability that leaves an effect on the ground creates an 8 meter Gryphon Nest for <<1>>. You and group members inside the Nest gain <<2>> Magicka and Stamina Recovery. The first time you or a group member leaves the Nest, they gain <<3>> for <<4>>, increasing their Weapon and Spell Damage by <<5>>.\n\nThis effect can occur once every <<6>>.",
[236445]="Activating a Synergy gives you and up to 3 group members within 12 meters Major Heroism for <<1>>, granting <<2>> Ultimate every |cffffff1.5|r seconds. This effect can occur once every <<3>>.",
[236644]="While in combat, casting an ability that leaves an effect on the ground summons a tentacle at the target's location. After <<1>>, the tentacle swings wildly in a 5 meter radius, dealing <<2>> and stunning up to 6 enemies for <<3>>. Enemies immune to stun take <<4>> instead. This effect can occur every <<5>> and the damage scales off the higher of your Weapon or Spell Damage.",
[236726]="Dealing damage with a fully-charged Heavy Attack creates a 3 meter poison boulder. After <<1>> the boulder rolls forward until it hits an enemy, dealing <<2>> in a 6 meter area and creating a 6 meter pool of poison for <<3>>, dealing <<4>> and applying the Poisoned status effect each second. This effect can occur once every <<5>> and scales off the higher of your Weapon or Spell Damage.",
...
[237020]="Heal yourself or an ally for <<1>> Health.",
[237022]="Heal yourself or an ally for <<1>> Health over <<2>>.",
[237023]="Remove up to <<1>> negative effects from yourself or an ally.",
[237025]="Attempt to defy death temporarily, limiting all damage you take to <<1>> for <<2>>.",
[237038]="Restore <<1>> Magicka and Stamina.",
[237042]="Knock back an enemy <<1>> and grant yourself <<2>> for <<3>>, increasing your movement speed by <<4>>.",
[237060]="Resurrect an ally.",
[237088]="Removes 1,000,000 |t16:16:EsoUI/Art/currency/currency_gold.dds|t worth of your Bounty on use, and also clears all Heat.",
[237430]="Slash an enemy, dealing <<1>>.",
[237601]="Flash through the shadows and ambush an enemy, dealing <<1>>.",
[237603]="Thrust a magic blade with lethal precision to stab an enemy, dealing <<1>>. Deals <<2>>% more damage to enemies below <<3>>% Health.",
[237604]="Expose an enemy's weaknesses to afflict them with Major Breach, reducing their Physical Resistance and Spell Resistance by <<1>> for <<2>>.",
[237605]="Focus your lethal intent into a spectral bow to fire at an enemy, dealing <<1>>, up to once every <<2>>.",
[237606]="Lash an enemy with flame, dealing <<1>>.",
[237607]="Slash an enemy with flame, dealing <<1>> and an additional <<2>> over <<3>>.",
[237615]="Exhale a flaming blast in front of you, dealing <<1>> to up to 3 enemies and an additional <<2>> over <<3>>.",
[237619]="Ravage an enemy with a swift strike, dealing <<1>>. Deals up to <<2>>% more damage to enemies under <<3>>% Health.",
[237620]="Launch a fiery chain to grasp and pull an enemy to you, dealing <<1>>.\n\nThis attack cannot be dodged or reflected.",
[237624]="Surround yourself in an aura of flames, granting you Major Berserk for <<1>>, increasing your damage done by <<2>>.",
[237627]="Call down a battle standard after <<1>>, dealing <<2>> to up to 3 enemies and applying Major Defile to them for <<3>>, reducing their healing received and damage shield strength by <<4>>.",
[237630]="Release your inner Dragon to gain <<1>>, increasing your Physical and Spell Resistance by <<2>> for <<3>>.",
[237632]="Surround yourself in a phantasmic aura to gain <<1>> and <<2>>, increasing your Physical and Spell Resistance by <<3>> and reducing your damage taken from area attacks by <<4>> for <<5>>.",
[237636]="Call forth talons from the ground, dealing <<1>> to up to 3 enemies near you and immobilizing them for <<2>>.",
[237637]="Immobilizes nearby enemies for <<1>> and deals <<2>>. An  ally can activate the <<3>> Synergy, damaging enemies held within the talons.",
[237638]="Draw on your draconic blood to heal for <<1>> Health, increasing by up to <<2>>% additional healing based on your missing Health. This ability scales off your Max Health.",
[237639]="Flex your scales, reducing your damage taken from projectiles by <<1>> for <<2>>.",
[237640]="Cloak yourself in shadow to become invisible for <<1>> while immediately healing yourself for <<2>> Health.",
[237641]="Channel draconic energy to suck in the air around you, increasing your Health, Magicka, and Stamina Recovery by <<1>> for <<2>>. Afterwards, you exhale fire, dealing <<3>> to up to 3 nearby enemies.",
[237647]="Create a corridor of shadows, granting you and up to 3 group members <<1>> for <<2>>, increasing Movement Speed by <<3>>.",
[237648]="Launch yourself at an enemy, dealing <<1>> to up to 3 enemies in the area.",
[237650]="Immunity to enemy control abilities.",
[237690]="Summon a dark spirit to terrify up to 3 nearby enemies, causing them to cower in fear for <<1>>.",
[237691]="Summon a dark spirit to terrify nearby enemies, causing them to cower in fear for <<1>>.",
[237700]="Infuse your weapon with sinister shadow and stab an enemy, dealing <<1>> and applying <<2>> to them for <<3>>, reducing their damage done by <<4>>.",
[237702]="Conjure concealing shadow around you, granting you and up to 3 nearby allies invisibility for <<1>> and <<2>> for <<3>>, reducing damage taken by <<4>>.",
[237709]="Steal an enemy's life force, dealing <<1>> and healing you or a nearby ally for <<2>> Health.",
[237711]="Pour out your lifesblood and channel the arcane, healing yourself or an ally in front of you for <<1>> Health.",
[237712]="Pour out your lifesblood and channel the arcane, healing yourself or an ally in front of you for <<1>> Health.",
[237713]="Sap an enemy's agility and wrack them with pain, dealing <<1>> over <<2>> and reducing their Movement Speed by <<3>> for <<4>>.",
[237716]="Channel a portion of your soul to convert Health to <<1>> Magicka and Stamina.",
[237719]="Siphon the vigor from your enemies' blood, dealing <<1>> to up to 3 nearby enemies.\n\nAfter activating you gain Minor Force, increasing your Critical Damage done by <<2>>% for <<3>>.",
[237722]="Ravage up to 3 nearby enemies' souls with a night rune, dealing <<1>> and stunning them for <<2>>.",
[237781]="Draw upon magma from under the earth to superheat the air around yourself or an ally, granting a damage shield that absorbs up to <<1>> damage for <<2>>.",
[237782]="Charge your and up to 2 of your grouped allies' weapons with volcanic power to gain Minor Prophecy and Savagery, increasing your Weapon and Spell Critical by <<1>> for <<2>>.",
[237785]="Call the earth to your defense, granting a damage shield to up to 3 of you and your allies that absorbs <<1>> damage.",
[237787]="Encase an enemy in molten rock after <<1>>, stunning them for <<2>>.\n\nThis stun cannot be blocked.",
[237788]="Tend to a warming tinder that heals up to 3 of you and your allies for <<1>> Health.",
[237790]="Ignite the molten lava in your veins, limiting incoming damage to <<1>>% of your Max Health for <<2>>.",
[237792]="Conjure dark crystals to bombard an enemy, dealing <<1>>.",
[237797]="Call forth Daedric shards from the earth to immobilize up to 3 enemies in front of you for <<1>>.",
[237803]="Imprison an enemy in a constricting sphere of dark magic. After a short duration they are stunned for <<1>>.\n\nThis stun cannot be blocked.",
[237808]="Bargain with darkness to restore <<1>> Health and <<2>> Magicka.",
[237811]="Swing your Aedric spear around with holy vengeance, dealing <<1>> to up to 3 nearby enemies.",
[237812]="Surprise your foes by detonating |cffffff3|r volatile Daedric mines around you, dealing <<1>> to up 3 enemies and reducing their movement speed by <<2>> for <<3>>.",
[237856]="Create a globe of magic suppression at your target location that stuns up to 3 enemies in the area for <<1>> and silences them if they are a player for <<2>>.",
[237861]="Launch a relentless assault, striking enemies in front of you three times with your Aedric spear, dealing <<1>> to the closest 3 enemies.",
[237863]="Hurl your spear at an enemy with godlike strength knocking them back <<1>>.\n\nThis ability cannot be blocked.",
[237865]="Command the powers of Oblivion to send a Daedric familiar to fight. After a delay, the familiar attacks and deals <<1>> over <<2>> to up to 3 nearby enemies.",
[237876]="Curse an enemy with a destructive rune, dealing <<1>> to the target after <<2>>.\n\nThis ability cannot be dodged.",
[237883]="Charge with your divine lance to impale an enemy to deal <<1>>.",
[237887]="Send your spear into the heavens to bring down a shower of divine wrath, dealing <<1>> to up to 3 enemies in the area.",
[237890]="Summon the warmth of the sun to surround you and the 2 closest group members, granting a damage shield that absorbs up to <<1>> damage for <<2>>.",
[237915]="Call on Azura to send a blessing to heal a friendly ally for <<1>> Health and yourself for <<2>> Health.",
[237929]="Conjure globes of Daedric energy for protection, granting a damage shield for you that absorbs <<1>> damage for <<2>>.",
[237930]="Protect yourself with the power of Oblivion, creating a suit of Daedric mail that grants <<1>> for <<2>>, reducing your damage taken by <<3>>.",
[237933]="Summon the remnants of a storm atronach at the target location, dealing <<1>> to up to 3 enemies, stunning them for <<2>>, and then dealing <<3>> over <<4>>.",
[237942]="Call down a fragment of the sun, dealing <<1>> to up to 3 enemies in the area and stunning them for <<2>>.",
[237948]="Call down lightning to strike an enemy, dealing <<1>>.\n\nIf the enemy was below |cffffff20|r% Health, an explosion deals an additional <<2>> to them and up to 2 nearby enemies.",
[237949]="Blast an enemy with a charge of radiant heat, dealing <<1>> over <<2>>.",
[237953]="Conjure a ball of solar energy to heave at an enemy, dealing <<1>> to them.",
[237954]="Manifest yourself as pure lightning, zapping up to 3 nearby enemies with electricity dealing <<1>>.\n\nYou also gain <<2>> for <<3>>, increasing your Physical Resistance and Spell Resistance by <<4>>.",
[237957]="Summon an expanding beam of pure sunlight to doom an enemy for <<1>>, dealing <<2>> immediately and <<3>> after the duration ends.\n\nThe final hit of damage cannot be dodged.",
[237959]="Create a nexus of storm energy at the target location, dealing <<1>> to up to 3 enemies in the area.",
[237964]="Envelop an enemy in a lightless sphere, stunning them for <<1>>.\n\nThis ability cannot be blocked.",
[237971]="Invoke Meridia's name to heal yourself for <<1>> Health.\n\nWhile slotted you gain Minor Berserk, increasing your damage done by <<2>>.",
[237974]="Burn an enemy with a ray of holy fire, dealing <<1>> over <<2>>. Deals up to <<3>>% more damage to enemies below <<4>>% Health.",
[237981]="Transform yourself into pure energy and flash forward, stunning up to 3 enemies near your final location for <<1>>. \n\nThis effect cannot be blocked.",
[237994]="Channel the grace of the gods, healing you or 3 nearby allies for <<1>> Health every <<2>> for <<3>>.\n\nWhile channeling this ability you gain immunity to all disabling effects.",
[237998]="Charge your fists with the power of the storm and deal <<1>> to your enemy.\n\nThis ability does not drain all available Ultimate.",
[238000]="Command a cliff racer to dive bomb an enemy, dealing <<1>>. \n\nThis ability cannot be blocked.",
[238001]="Heal yourself or an ally for <<1>> Health.",
[238002]="Beacon your inner light, healing yourself or an ally for <<1>> Health.",
[238004]="Stir a group of shalk that attack after <<1>>, dealing <<2>> to up to 3 enemies in front of you.",
[238016]="Unleash a swarm of fetcherflies to relentlessly attack an enemy, dealing <<1>> over <<2>>.",
[238018]="Focus your spiritual devotion, healing you or up to 3 nearby allies for <<1>> Health.",
[238019]="Champion the cause of divine glory to apply <<1>>, <<2>>, and <<3>> to nearby group members for <<4>>, increasing Health, Magicka, and Stamina Recovery by <<5>>.",
[238020]="Call a betty netch to your side, which grants you Minor Berserk, increasing your damage done by <<1>> for <<2>>, and removing a negative effect from yourself.",
[238026]="Exalt in the sacred light of the Aedra, cleansing up to <<1>> negative effects from yourself.",
[238027]="Invoke the spirit of agility to gain Major Expedition for <<1>>,  increasing your Movement Speed by <<2>>.",
[238041]="Create a rune of celestial protection and gain <<1>> for <<2>>, increasing your Physical Resistance and Spell Resistance by <<3>>.",
[238043]="Rouse a grizzly to maul an enemy for <<1>>. Deals <<2>>% more damage to enemies below <<3>>% Health.",
[238054]="Seed a large area of mushrooms in front of you, healing up to 3 of you and your allies for <<1>> Health.",
[238055]="Summon a field of flowers which blooms after <<1>>, healing up to 3 of you and your allies in the area for <<2>> Health.",
[238065]="Grow vines to embrace you or an ally and heal them for <<1>> Health over <<2>>.",
[238067]="Embrace the lotus blessing, granting you Major Mending, Prophecy, and Savagery for <<1>>, increasing your healing done by <<2>> and Spell and Weapon Critical rating by <<3>>.",
[238071]="Launch a vine to swing yourself to an ally, healing them for <<1>> Health.",
[238074]="Swell a healing forest at the target location, healing up to 3 of you and your allies for <<1>> Health over <<2>>.",
[238076]="Wrap a thick cloak of ice around yourself and up to 2 grouped allies. The ice grants Major Resolve, increasing your Physical and Spell Resistance by <<1>> for <<2>>.",
[238078]="Dredge up a resentful soul from beneath you to sacrifice as fuel for your attacks, granting you <<1>> for <<2>>, increasing your damage done by <<3>>.\n\nCreates a corpse where the sacrifice was made.",
[238079]="Conjure icy shards around you to skewer up to 3 enemies in the area, dealing <<1>> and immobilizing them for <<2>>.",
[238081]="Lob an explosive skull at an enemy, dealing <<1>>.",
[238088]="Envelop yourself in winter winds, instantly healing for <<1>> Health.",
[238089]="Spin a shield of ice around you, absorbing up to <<1>> damage from projectiles for <<2>>.",
[238091]="Summon an ancient portal, that after <<1>> teleports an enemy in the area to you and immobilizes them for <<2>>.",
[238095]="Desecrate the ground at the target location, dealing <<1>> to up to 3 enemies inside and applying <<2>> for <<3>>, increasing their damage taken by <<4>>.",
[238098]="Twist a violent storm around you, stunning up to 6 nearby enemies for <<1>> and reducing their Movement Speed by <<2>> for <<3>> after the stun ends. \n\nYou gain Major Protection for <<4>>, reducing your damage taken by <<5>>.",
[238102]="Unearth a skeletal mage from the dirt at your enemy's location, causing them to cast one final spell after <<1>> before returning to their slumber and leaving a corpse behind. The spell deals <<2>> over <<3>> to the targeted enemy.",
[238126]="Violently drain the last spark of life from a corpse, dealing <<1>>  to up to 3 enemies around the corpse after <<2>>. Deals up to <<3>>% more damage to enemies under <<4>>% Health.",
[238129]="Unleash a frostbitten Flesh Colossus to pulverize up to 3 enemies in the area. The Colossus smashes the ground three times over <<1>>, dealing <<2>> with each smash.",
[238137]="Slice into your enemy's life force, dealing <<1>> and healing for <<2>> Health.",
[238139]="Wrap yourself in hardened bone, granting you Major Resolve, increasing your Physical Resistance and Spell Resistance by <<1>> for <<2>>.\n\nCreates a corpse when the effect ends if you are in combat, up to once every <<3>>.",
[238141]="Sap the lingering life from up to 3 fresh corpses, granting you <<1>> Ultimate and healing <<2>> Health per corpse consumed. You also gain <<3>> for <<4>>, reducing your damage taken by <<5>>. \n\nThis ability can be activated once every <<6>>.",
[238160]="Healing your missing health is prevented for <<1>> or until sufficient healing is received to penetrate and remove <<2>>.\n\n<<2>> is immune to skills that remove negative effects.",
[238169]="Craft an Apocryphal rune before launching it at a foe, dealing <<1>> and generating Crux.",
[238174]="Harness pure knowledge into a beam of energy that scars the world in front of you. Channel the beam for up to <<1>>, dealing <<2>> every <<3>> to up to 3 enemies.\n\nCasting Fatecarver consumes all Crux and increases damage done by <<4>> per Crux spent.",
[238178]="Summon an effigy of bone at your feet after <<1>>. Once completed, the totem fears up to 3 nearby enemies, causing them to cower in place for <<2>> and become afflicted with <<3>> for <<4>>, reducing their damage done by <<5>>.",
[238182]="Summon three patches of skeletal claws from the ground in front of you to grab up to 3 enemies, immobilizing them for <<1>> and applying <<2>> for <<3>>, reducing their damage done by <<4>>.",
[238186]="Summon three patches of skeletal claws from the ground in front of you. Enemies in the first area are snared by <<1>> for <<2>>, immobilized in the second area for <<3>>, and stunned in the final area for <<4>>.\n\nEach patch applies Minor Maim to enemies hit for <<5>>, reducing their damage done by <<6>>.",
[238189]="Infuse your arm with abyssal magic to form tentacles that lash out at your foes, dealing <<1>> to up to 3 enemies and immobilize them for <<2>>.",
[238191]="Etch a series of runes onto your weapon that pulse with power, generating a Crux if you have none while granting you Minor Force for <<1>>, increasing your Critical Damage done by <<2>>%.\n\nWhile slotted on either ability bar, gain Major Prophecy and Savagery, increasing your Spell and Weapon Critical rating by <<3>>.",
[238225]="Summon a flawed rune under an enemy that etches them and up to 2 foes nearby with scrawled glyphs, dealing <<1>> over <<2>>.",
[238228]="Tear open the fabric of the Aurbis to summon a scion of Hermaeus Mora to attack your target. This being casts forth a beam that rends asunder reality after <<1>>, dealing <<2>> to the enemy over <<3>>.",
[238232]="Be as the landslide. Let nothing stop you.\n\nImproves your Landslide passive to increase the potency of your damage done, healing done, and damage shield strength by <<1>> per stack.",
[238236]="Become a horrific Bone Goliath, increasing your Max Health by <<1>> for <<2>> and immediately restoring <<1>> Health.",
[238238]="Craft a defensive Apocryphal rune that deals <<1>>, applies <<2>> for <<3>>, reducing their damage done by <<4>>, and generates Crux.",
[238249]="Like the rune knights of old, summon a shield that absorbs <<1>> damage for <<2>>.\n\nConsume Crux to heal yourself for <<3>> Health, scaling off your Max Health, per Crux spent.",
[238251]="Sacrifice your own power to repair damaged flesh, healing you or an ally in front of you for <<1>> Health but applying Minor Defile to yourself for <<2>>, reducing your healing received and damage shield strength by <<3>>.",
[238254]="Sacrifice your own power to repair damaged flesh, healing you or an ally in front of you for <<1>> Health but applying Minor Defile to yourself for <<2>>, reducing your healing received and damage shield strength by <<3>>.",
[238255]="Embrace the power of death, removing up to <<1>> negative effects from yourself.\n\nWhile slotted on either bar you gain <<2>> Health, Magicka, and Stamina Recovery.",
[238256]="Forge defiant runic armor around you, granting Major Resolve for <<1>>, increasing your Armor by <<2>> and apply Minor Breach to up to 3 nearby enemies for <<3>>, reducing their Armor by <<4>>.",
[238258]="Release residual fragments of fallen souls at the target location, healing you or up to 3 allies in the area for <<1>> Health.",
[238262]="Cast forth a complex rune granting you and up to 2 group members Minor Resolve for <<1>>, increasing your Armor by <<2>>.\n\nYou gain Minor Protection for <<3>>, reducing your damage taken by <<4>>.",
[238265]="Conjure a ghostly spirit to do your bidding and heal you or an ally for <<1>> Health over <<2>>.",
[238266]="Conjure a ghostly spirit to do your bidding and heal you or an ally for <<1>> over <<2>>.",
[238267]="Etch an incomprehensible rune on your enemy's mind, paralyzing them in fear after a <<1>> delay, stunning them for <<2>>. This terror applies <<3>> for <<4>>, increasing their damage taken by <<5>>.\n\nThis ability cannot be dodged.",
[238274]="Gather the true strength of Apocrypha around you, forming protective tentacles and a damage shield that absorbs |cffffff60%|r of all damage for <<1>>, up to a max of <<2>> damage.\n\nWhen the shield collapses you lash out, dealing <<3>> to up to 3 enemies within 5 meters.",
[238277]="Siphon the last remnants of life from a corpse, healing for <<1>> Health to yourself or up to 3 allies around the corpse after <<2>>. Heals up to <<3>>% more Health to targets under <<4>>% Health.",
[238316]="Bring your allies back from the brink of death, resurrecting up to |cffffff3|r allies at the target location.",
[238429]="Craft a precise Apocryphal rune, then propel it at yourself or an ally in front of you. The rune heals for <<1>> Health and generates Crux.",
[238447]="Craft a series of precise Apocryphal runes, then propel them at yourself or an ally in front of you. The runes heal for <<1>> Health three times and generate Crux.\n\nEach active Crux reduces the cost of this ability by <<2>>.",
[238482]="Channel the abyssal sea to coalesce a beam of restorative energy. The beam heals you or up to 3 allies in its path for <<1>> Health over <<2>>.\n\nConsume Crux to also restore |cffffff672|r Magicka and Stamina per Crux spent to your allies over <<2>>.",
[238536]="Carve the runes of the Blind Man to call forth spinning mystical discs. Discs surround you or up to 2 allies in front of you, granting a shield that absorbs <<1>> damage for <<2>>.\n\nDiscs prefer your reticle target, or low-Health targets without shields.",
[238539]="Draw forth your tome and invoke the vigoratum of Hermaeus Mora to conjure a vortex of eldritch power. You or up to 3 nearby allies gain <<1>>, <<2>>, <<3>>, and <<4>> for <<5>>, increasing your damage done by <<6>> and your Health, Magicka, and Stamina Recovery by <<7>>.",
[238545]="Breach the world walls to create a portal at a target location, teleporting yourself to it immediately and generating Crux.",
[238549]="Call forth an Apocryphal glyphic for <<1>>, which heals you or up to 3 allies around it for <<2>> Health every <<3>> and grants <<4>> while in the area, increasing Critical Damage by <<5>>%.",
[238815]="When you have at least twenty Battlemaster's Tokens: Use to consume those twenty Tokens and create a Runebound Tome: Drakes and Daemons Duel Face Art.",
[238824]="When you have at least twenty Battlemaster's Tokens: Use to consume those twenty Tokens and create a Runebound Tome: Drakes and Daemons Duel Body Art.",
[238880]="Weapon and Spell Damage increased by <<1>>.",
[238881]="Magicka and Stamina Recovery is increased by <<1>>.",
[238882]="Maximum Health increased by <<1>> and reduces your damage taken by <<2>>.",
[239018]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[239033]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[239034]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[239117]="While in combat, roll dodging creates a random effect. This effect can occur once every |cffffff3|r seconds. Effects:\n\n-<<1>> that deals <<2>> to enemies in 3 meters after <<3>>.\n-Deal <<4>> to enemies facing you after <<5>>.\n-Deal <<6>> to the nearest enemy.\n-Gain <<7>> for <<8>>.\n-Restore <<9>> Stamina.\n-Reduce the cost of your next non-Ultimate ability by <<10>>.\n-Gain |cffffff7|r Ultimate.",
[239248]="Activate to teleport to Shadow Image",
[239259]="Weapon and Spell Damage increased by <<1>>",
[239260]="Magicka and Stamina Recovery is increased by <<1>>",
[239261]="Maximum Health increased by <<1>> and reduces your damage taken by <<2>>",
[239466]="Restore <<1>> Health, <<2>> Magicka, and <<3>> Stamina immediately.\n\nThis potion always seems to refill itself…",
[239576]="Activate to teleport to Shadow Image",
[239634]="Activate to teleport to Shadow Image",
[239639]="Healing your missing health is prevented for <<1>> or until sufficient healing is received to penetrate and remove <<2>>.\n\n<<2>> is immune to skills that remove negative effects.",
[239734]="Gain |cffffff1|r Magicka Recovery for every |cffffff100|r Max Magicka you have. \n\nCurrent Increase: \n<<1>> Magicka Recovery",
[239925]="While you have a food buff active, your Block Mitigation is increased by <<1>>% and block cost is reduced by <<2>>.",
[240148]="Imbue yourself with the magical runes of Ulfsild for <<1>>. These runes trigger when you cast an ability with a cost, causing a burst of magic around you.",
[240149]="Imbue yourself with the magical runes of Ulfsild for <<1>>. These runes trigger when you cast an ability with a cost, causing a burst of magic around you.",
[240150]="Imbue yourself with the magical runes of Ulfsild for <<1>>. These runes trigger when you cast an ability with a cost, causing a burst of magic around you.",
[240156]="Adds <<1>> Critical Chance while you have 50% or more Stamina. Reduce the cost of your Core Combat abilities by <<2>> while you have less than 50% of your Stamina.",
[240222]="Create Trebuchet",
[240223]="Create Trebuchet",
[240224]="Create Trebuchet",
[240225]="Create Trebuchet",
[240238]="Create a Forward Camp that allows 20 respawns.",
[240249]="Create Trebuchet",
[240250]="Create Ballista",
[240251]="Create Ram",
[240252]="Create a Forward Camp that allows 20 respawns.",
[240268]="Let your voice echo across the peaks.\n\nActivating rank 2 of <<1>> now also grants <<2>> Health, Magicka, and Stamina Recovery for every Ultimate spent for <<3>> after a delay of <<4>>.",
[240275]="Create Trebuchet",
[240276]="Create Trebuchet",
[240277]="Create Trebuchet",
[240278]="Create Mobile Graveyard that allows 20 respawns.",
[240281]="Increase your direct damage done to monsters by <<1>>.",
[240365]="Violently drain the last spark of life from a corpse, dealing <<1>> over <<2>> to all enemies around the corpse and between you and the corpse.  \n\nIf the siphon lasts its full duration it causes the corpse to explode, dealing an additional <<3>> to all enemies around the corpse.  This ability scales off your highest offensive stats.\n\nWhile slotted, your damage done is increased by <<4>>.",
[240453]="Slam an enemy with an upward swing, dealing <<1>>.",
[240459]="Launch across the earth and smash an enemy, dealing <<1>>. \n\nThis attack is always a Critical Strike.",
[240470]="While in combat and on your Primary Weapon gain <<1>>, increasing you damage done by <<2>> and increasing your damage taken by <<3>>.\n\nWhile in combat and on your Secondary Weapon gain <<4>>, reducing your damage taken by <<5>> and reducing your damage done by <<6>>.",
[240480]="Focus your strength into a mighty swing, dealing <<1>> to up to 3 enemies in front of you.\n\nYou also gain a damage shield that absorbs <<2>> damage for <<3>>.",
[240482]="Spin around and strike an enemy down, dealing <<1>>. Deals up to <<2>>% more damage to enemies with less than <<3>>% Health.",
[240483]="Focus your strength and resolve to gain <<1>>, increasing your Critical Damage by <<2>>%, as well as gaining <<3>>, increasing your Stamina Recovery by <<4>> for <<5>>.",
[240494]="Strike at an enemy with a vicious blow, dealing <<1>> to them and up to 2 nearby enemies.\n\nThis attack cannot be mitigated and grants you <<2>> Physical and Spell Resistance for <<3>>.",
[240535]="When you have all three collectible fragments for the Mote of Furious Flame: Use to perform the ritual.",
[240547]="Thrust your weapon with disciplined precision at an enemy, dealing <<1>>.\n\nAlso inflicts <<2>> on the enemy, reducing their Physical and Spell Resistance by <<3>> for <<4>>.",
[240558]="Surprise an enemy with a deep lunge, dealing <<1>> and afflicting them  with <<2>>, reducing their damage done by <<3>> for <<4>>.",
[240560]="Bolster your defenses, gaining a damage shield that absorbs up to <<1>> damage for <<2>>.  This portion of the ability scales off your Max Health.",
[240561]="Bolster your defenses, gaining a damage shield that absorbs up to <<1>> for <<2>>.  \n\nYou reflect the next projectile cast at you back to the enemy.",
[240564]="Rush an enemy and ram them, stunning them for <<1>>.",
[240569]="Strike an enemy full-force with your shield, dealing <<1>>. \n\nThis ability's damage is considered Bash damage and interrupts the enemy if they are casting.",
[240572]="Reinforce your shield, allowing you to automatically block all attacks at no cost for <<1>>.",
[240585]="Flood an enemy with steel, battering them with four consecutive attacks that each deal <<1>>.",
[240590]="Slice an enemy with both weapons to cause deep lacerations, dealing <<1>> and causing them to bleed for an additional <<2>> over <<3>>.",
[240594]="Launch yourself into a lethal spin, dealing <<1>> to up to 3 nearby enemies.\nDeals up to <<2>>% more damage to enemies below <<3>>% Health.",
[240662]="While in combat, activating a synergy increases your Weapon and Spell Damage by <<1>> for <<2>>, stacking up to |cffffff5|r times.",
[240795]="Fast Travel to any previously disovered wayshrine.",
[240796]="Fast Travel to any previously disovered wayshrine.",
[240800]="Fast Travel to any previously disovered wayshrine.",
[240801]="Fast Travel to any previously disovered wayshrine.",
[240832]="Increases your damage done with non-Ultimate Heavy Attacks and decreases your damage done with Light Attacks by <<1>> each.\n\nDealing damage with a Light Attack restores <<2>> Magicka or Stamina, depending on your equipped weapon type. This resource restore is treated as a Heavy Attack resource restore for bonuses and penalties. Your Heavy Attacks no longer restore resources.",
[240960]="On dealing area direct damage, place a Sword above an enemy, up to once every <<1>>. You cannot place a Sword on an enemy who already has one from you. After <<2>>, the Sword falls, dealing <<3>>. This damage scales off the higher of your Weapon or Spell Damage. \n\nApplying a Sword increases your damage done by <<4>> for <<2>>, stacking up to |cffffff6|r times.",
[241125]="You gain a <<1>>% Experience Point bonus from all sources, and reduced cost of Wayshrine usage by |cffffff100|r%, for <<2>>. The timer pauses when you are offline, and resumes when you return.",
[241186]="While in combat, overhealing done is converted into stored energy on you for <<1>>. After overhealing <<2>> Health, your energy maxes out, granting you the <<3>> synergy. When you activate this synergy, restore <<4>> Stamina and Magicka to yourself and group members within 28 meters of you.",
[241188]="Envelop yourself in a protective cloak of razors to gain Major Evasion, Minor Savagery, and Minor Prophecy for <<1>>, reducing damage taken from area attacks by <<2>> and increasing your Weapon and Spell Critical by <<3>>.",
[241232]="You and group members within 28 meters of you restore <<1>> Stamina and Magicka.",
[241234]="Fire a secret dagger from your sleeve at an enemy, dealing <<1>>.\n\nIf the enemy hit is casting an ability they are interrupted, set Off Balance, and stunned for <<2>>.",
[241236]="Slash up to 3 enemies in front of you, causing them to bleed for <<1>> over <<2>>. You heal <<3>> Health every time damage is dealt.",
[241255]="Plant a masterfully aimed arrow in an enemy's vital spot, dealing <<1>>.",
[241258]="Launch a multitude of arrows into the sky to rain down, dealing <<1>> to up to 3 enemies in the target area after a |cffffff2|r second delay.",
[241261]="Blast an enemy with an explosive arrow, dealing <<1>>, knocking them back <<2>>.",
[241274]="Fire a burst of arrows in one shot, dealing <<1>> to up to 3 enemies in front of you.",
[241275]="Shoot an arrow coated in Baandari poison at an enemy, dealing <<1>> and an additional <<2>> over <<3>>.",
[241278]="Unleash a barrage of arrows at an enemy, dealing <<1>> over <<2>>. \n\nYou can move at full speed and are immune to all disabling effects while channeling this attack.",
[241291]="Focus on one of the elemental energies with your staff and blast an enemy for <<1>>, <<2>>, or <<3>>.",
[241302]="Slam your staff down to create an elemental field in front of you, dealing <<1>> to up to 3 enemies in front of you over <<2>>.\n\nWall of Fire deals more damage.\n\nWall of Frost snares enemies.\n\nWall of Storms sets enemies Off Balance.",
[241314]="Slam your staff down to create a flaming field in front of you, dealing <<1>> to up to 3 enemies in front of you over <<2>>.",
[241318]="Slam your staff down to create an icy field in front of you, dealing <<1>> to up to 3 enemies in front of you over <<2>>, and reducing their Movement Speed by <<3>> for <<4>>.",
[241322]="Slam your staff down to create a storm field in front of you, dealing <<1>> to up to 3 enemies in front of you over <<2>> and setting them Off Balance for <<3>>.",
[241429]="Devastate an enemy with an enhanced charge from your staff, dealing <<1>> and an additional <<2>> Magic Damage over <<3>>. \n\nFlame Touch converts the initial hit into damage over time.\n\nFrost Touch converts some of the damage over time into initial damage.\n\nShock Touch deals damage more rapidly.",
[241431]="Devastate an enemy with an enhanced charge from your staff, dealing <<1>> over <<2>>.",
[241433]="Devastate an enemy with an enhanced charge from your staff, dealing <<1>> and an additional <<2>> over <<3>>.",
[241435]="Devastate an enemy with an enhanced charge from your staff, dealing <<1>> and an additional <<2>> over <<3>>.",
[241447]="Send the elements to sap an enemy's defenses and afflict them with <<1>> for <<2>>, reducing their Physical and Spell Resistance by <<3>>.",
[241454]="Release a surge of elemental energy, dealing <<1>> to up to 3 nearby enemies.\n\nFire Impulse converts some of the initial hit into damage over time.\n\nFrost Impulse costs more but provides Minor Protection.\n\nShock Impulse deals less damage but has a chance to deal increased damage.",
[241455]="Release a surge of flame, dealing <<1>> and an additional <<2>> over <<3>> to up to 3 nearby enemies.",
[241458]="Release a surge of frost, dealing <<1>> to up to 3 nearby enemies and applying Minor Protection to you for <<2>>, reducing your damage taken by <<3>>.",
[241460]="Release a surge of storm energy, dealing <<1>> Shock Damage to up to 3 nearby enemies.\n\nEach enemy hit has a <<2>> chance to instead take <<3>>.",
[241485]="Create a cataclysmic storm at the target location that builds for |cffffff2|r seconds then lays waste to up to 3 enemies in the area, dealing <<1>>.",
[241487]="Create a cataclysmic storm at the target location that builds for |cffffff2|r seconds then lays waste to up to 3 enemies in the area, dealing <<1>>.",
[241489]="Create a cataclysmic storm at the target location that builds after |cffffff2|r seconds then lays waste to up to 3 enemies in the area, dealing <<1>>.",
[241491]="Create a cataclysmic storm at the target location that builds after |cffffff2|r seconds then lays waste to up to 3 enemies in the area, dealing <<1>>.",
[241509]="While bracing you create a distortion barrier around yourself after <<1>>. After the delay, every <<1>> you gain <<2>> Armor and enemies within the distortion barrier have their Armor reduced by <<3>> for <<4>>. These effects stack up to |cffffff3|r times.",
[241517]="Summon restoring spirits with your staff at the target location, healing up to 3 of you and your allies for <<1>> Health over <<2>>.",
[241521]="Share your staff's life-giving energy, healing you or a nearby ally for <<1>> Health over <<2>>.",
[241527]="Slam your staff down to activate its blessings, healing up to 3 of you and your allies in front of you for <<1>> Health.",
[241535]="Call on your staff's strength to protect you or an ally with a damage shield that absorbs <<1>> damage for <<2>>.\n\nThe shield's strength is increased by up to <<3>>%, depending on the severity of the target's wounds.",
[241536]="Focus your staff's power to apply <<1>> and <<2>> to an enemy for <<3>>, healing you and your allies for <<4>> Health and restoring <<5>> Magicka every <<6>> when damaging them.",
[241586]="Release the rejuvenating energies of your staff to swirl around you, healing up to 3 of you and your allies for <<1>> Health.",
[241714]="· Deals <<1>>",
[241812]="When you enter combat, <<1>> of the damage you take is transferred to your Companion instead. Reduce the damage your Companion takes by <<2>>. When your Companion dies in combat, they will automatically revive themselves after <<3>>.",
[242028]="Gain <<1:>>, reducing your damage taken by <<2>>.",
...
[242521]="Increases experience gain for currently active skills and their skill lines by |cffffff3|r% per stage.",
[242596]="Fire Bolt Ammo",
[242709]="While in combat and on your Primary Weapon gain <<1>>, <<2>>, and <<3>>.\n\nWhile in combat and on your Secondary Weapon gain <<4>>, <<5>>, and <<6>>.",
[242722]="Your essence has been drained, reducing your Max Health.",
[242930]="· Deals <<1>> to all enemies in front of you",
[242938]="· Deals <<1>> to all enemies in front of you",
[242982]="Disorients the target for 8 seconds.",
[243059]="Fire Bolt Ammo",
[243119]="Violently drain the last spark of life from a corpse, dealing <<1>> over <<2>> to all enemies around the corpse and between you and the corpse.  \n\nIf the siphon lasts its full duration it causes the corpse to explode, dealing an additional <<3>> to all enemies around the corpse.  This ability scales off your highest offensive stats.\n\nWhile slotted, your damage done is increased by <<4>>.",
[243278]="· Nearby enemies are knocked back <<1>> and snared <<2>> for <<3>>",
[243280]="· Nearby enemies are knocked back <<1>>cm and snared <<2>> for <<3>>",
[243305]="When you deal damage, you summon a Verminous Fabricant that charges forward, dealing <<1>> to all enemies in its path, and knocking up to 6 into the air, stunning them for <<2>>. This effect can occur once every <<3>> and scales off the higher of your Weapon or Spell Damage.",
[243686]="Tether yourself to an ally, manifesting a life link between you and them.",
[244067]="Your essence has been drained, reducing your Max Health.",
[244144]="Increases Magicka Regeneration by 30%.",
[244160]="Immunity to enemy control abilities.",
[244496]="Let loose a battle cry, instilling you with resolve and healing for <<1>> Health over <<2>>.",
[244498]="Mobilize your forces, granting <<1>> to up to 3 of you and your group, increasing your Movement Speed by <<2>> for <<3>>.",
[244514]="Hurl a ball of caltrops that scatter over the target area, dealing <<1>> to up to 3 enemies inside, and reducing their Movement Speed by <<2>> for <<3>>.",
[244519]="Immunity to enemy control abilities.",
[244541]="Curse an enemy with a magical bomb that explodes after <<1>>, dealing <<2>>. You cannot recast this ability on a target you have affected.\n\nThis damage is increased by <<3>> for each additional <<4>> you have active, and cannot be dodged.",
[244644]="Sound a war horn to rally your forces, increasing you and up to 5 of your group members' Health, Magicka, and Stamina Recovery by <<1>> for <<2>>.",
[244688]="Create a protective sphere after a 1 second delay that reduces damage taken from siege weapons by <<1>>% to up to 3 of you and nearby allies for <<2>>.",
[244715]="Cleanse yourself and up to 2 group members, removing up to <<1>> negative effects immediately.\n\nCan only be cast when you have a negative effect active on yourself.",
[244725]="Invoke defensive tactics to protect yourself and up to 2 nearby group members with wards that each absorb up to <<1>> damage for <<2>>.",
[245049]="Launch a blinding flare, revealing stealthed and invisible enemies in the target area. Exposed enemies take <<1>> and cannot return to stealth or invisibility for <<2>>.",
[245055]="Create a lifebond between you and a group member for <<1>>. While bonded, your ally reduces their damage taken by <<2>> and increase your damage taken by <<3>>.\n\nThe bond will break if you move more than |cffffff17|r meters away from your target.",
[245238]="Fast Travel to any previously disovered wayshrine.",
[245239]="Fast Travel to any previously disovered wayshrine.",
[245302]="Increase Max Magicka by <<1>> for <<2>>.",
[245482]="While under the effect of the Grasping Void, Health Regeneration is reduced to 0.",
[245538]="<<1>> brands the earth underneath them with a rune of protection for <<2>>. Standing within the rune reduces the damage they and their allies take by <<3>>. \n\nIf the attacker is an Undead, Daedra, or Werewolf the rune reduces damage taken by an additional <<4>>.",
[245610]="Increase your damage done against enemies by <<1>> for each Damage Shield or healing over time effect on them.",
[245843]="· Charge to target and attack, dealing <<1>>\n· Stun target for <<2>>",
[245919]="Healing your missing health is prevented for <<1>> or until sufficient healing is received to penetrate and remove <<2>>.\n\n<<2>> is immune to skills that remove negative effects.",
[246025]="Wrap yourself in hardened bone, granting you Major Resolve, increasing your Physical Resistance and Spell Resistance by <<1>> for <<2>>.\n\nYou also count as a corpse, up to once every <<3>>.",
[246029]="Unearth a skeletal mage from the dirt at your enemy's location, causing them to cast one final spell after <<1>> before returning to their slumber and marking the enemy as a corpse. The spell deals <<2>> over <<3>> to the targeted enemy.\n\nOnly you can use the mark on a target for corpse consumption.",
[246057]="Dredge up a resentful soul from beneath you to sacrifice as fuel for your attacks, granting you <<1>> for <<2>>, increasing your damage done by <<3>>.\n\nYou also count as a corpse.",
[246070]="Fire a Dawnguard Vampire Hunter's crossbow bolt to strike an enemy, dealing <<1>>.",
[246071]="Brand the earth at your location with a rune of protection, granting up to 3 of you and your allies <<1>>, reducing their damage taken by <<2>> for <<3>>.",
[246091]="Invoke your expertise in anatomy and enemy behavior to increase your stealth detection by <<1>> for <<2>>.",
[246253]="Hurl a ball of caltrops that scatter over the target area, dealing <<1>> to enemies inside, and reducing their Movement Speed by <<2>> for <<3>>.",
[246275]="Set a sharpened blade trap under your target that deals <<1>> over <<2>>, and immobilizes them for <<3>>.\n\nThe trap cannot be blocked.",
[246303]="Arm yourself with Meridia's sacred sword and dispense her retribution, dealing <<1>> to up to 3 enemies in front of you and an additional <<2>> over <<3>>.",
[246400]="Mobilize your forces, granting <<1>> and <<2>> to you and your group, increasing your Movement Speed by <<3>> and Mounted Speed by <<3>>.\n\nAlso grants immunity to snares and immobilizations.\n\nThe effect ends if you cast any spell on an enemy or ally.",
[246479]="Bind an enemy with chaotic magic, dealing <<1>> over <<2>>.",
[246482]="Inscribe a rune of cosmic fire on the earth, which takes <<1>> to arm, and blasts up to 3 enemies in the target area for <<2>>.",
[246485]="Barter with Oblivion to trade vitality for power, sacrificing your Health in exchange for <<1>> Magicka.\n\nThe exchange reduces your healing done and damage shield strength by <<2>> for <<3>>.",
[246489]="Summon a mote of magelight, dealing <<1>> to up to 3 stealthed and invisible enemies around you. Exposed enemies cannot return to stealth or invisibility for <<2>>.",
[246494]="Call a comet down from the constellations to blast an enemy, dealing <<1>> to up to 3 enemies in the area, knocking them down, and stunning them for <<2>>.",
[246616]="Slam your staff down to activate its blessings, healing up to 3 of you and your allies in front of you for <<1>> Health.",
...
[247093]="Stir a group of shalk that attack after <<1>>, dealing <<2>> to up to 3 enemies in front of you.",
[247103]="Call forth Daedric shards from the earth to immobilize up to 3 enemies in front of you for <<1>>.",
...
[247317]="Violently drain the last spark of life from a corpse, dealing <<1>> over <<2>> to all enemies around the corpse and between you and the corpse.  \n\nIf the siphon lasts its full duration it causes the corpse to explode, dealing an additional <<3>> to all enemies around the corpse.  This ability scales off your highest offensive stats.\n\nWhile slotted, your damage done is increased by <<4>>.",
[247540]="While under the effect of the Grasping Void, Health Regeneration is reduced to 0.",
[247561]="Convert a portion of your Magicka into a protective ward, gaining a damage shield that absorbs <<1>> damage for <<2>>. Damage shield strength capped at |cffffff60|r% of your Max Health.",
[247567]="Immunity to enemy control abilities.",
[247587]="Shroud yourself in mist to gain <<1>>, reducing damage taken from area attacks by <<2>> for <<3>>.",
[247596]="Intensify your physical presence to gain <<1>>, increasing your Physical and Spell Resistance by <<2>> for <<3>>.\n\nAlso grants you immunity to knockback and disabling effects for <<4>>, but reduces your Movement Speed by <<5>> for the duration.",
[247607]="Fire Bolt Ammo",
[247614]="When you have all three collectible fragments for the Mote of Furious Flame: Use to perform the ritual.",
[247620]="Fast Travel to any previously disovered wayshrine.",
[247621]="Fast Travel to any previously disovered wayshrine.",
[247979]="Take <<1>>, with healing reduced by <<2>> for <<3>>.",
[248096]="You are a Werewolf Behemoth:\n· Maximum Health increased.\n· Weapon and Spell damage increased.\n· Weapon and Spell critical decreased.\n· Physical and Spell Resist increased.\n· Health Recovery increased.",
[248106]="You've transformed into a beast!\n\n· Maximum Health increased.\n· Weapon and Spell damage increased.\n· Weapon and Spell critical decreased.\n· Physical and Spell Resist increased.\n· Health Recovery increased.",
[248112]="Immunity to enemy control abilities.",
[248127]="Immunity to enemy control abilities.",
[248174]="Increase your damage done with Flame, Frost, and Shock Damage by <<1>>.\nIncrease your damage done with Burning, Chilled, and Concussion by an additional <<2>>.",
[248350]="Dealing direct damage with a non-Heavy Attack grants you a stack of <<1>> for <<2>>, up to 4 stacks max. You can gain a stack every <<3>>.\n\nDealing damage with a fully-charged Heavy Attack consumes the stacks, applies Sundered, and deals <<4>> per stack consumed.",
[248384]="Dealing damage to an Immobilized enemy applies <<1>> to them for <<2>>, increasing their damage taken by <<3>>. This effect can occur once every <<4>>.",
[248416]="Stomp the ground, dealing <<1>> to enemies within <<2>> and knocking them back.\n\nGenerates <<3>> Ultimate.\n\nThis ability has a cooldown of <<4>>.",
[248474]="Call upon the ancestor's blessing, healing yourself immediately for <<1>> Health and an additional <<2>> Health every <<3>> over <<4>>.",
[248510]="Light attack that deals <<1>>.",
[248514]="Light attack that deals <<1>>.",
[248516]="Hold to charge up a heavy attack, dealing up to <<1>> with each swipe.",
[248523]="Hone your ancient Argonian greatsword mastery and cleave your weapon, sending out multiple tremors that travel <<1>> dealing <<2>> to enemies.\n\nGenerates <<3>> Ultimate.\n\nThis ability has a cooldown of <<4>>.",
[248551]="Spew ancient ritual fire at all enemies within a cone of <<1>>, dealing <<2>> every <<3>> over <<4>>.",
[248566]="Gain <<1>> out of combat Health Recovery.",
[248569]="Gain <<1>> Health Recovery and lose <<2>> Magicka and Stamina Recovery.",
[248605]="Increases your stealth detection by <<1>>.",
[248606]="You gain a <<1>> Experience bonus from all sources.",
[248607]="You gain a <<1>> experience bonus to Alliance Rank and Alliance War skill lines from all sources.",
[248611]="You take <<1>> reduced damage from siege weapons.",
[248612]="You repair <<1>> more damage with repair kits.",
[248613]="You can see the outlines of enemies while manning all siege weapons but rams.",
[248614]="Gain <<1>> Health, <<2>> Magicka, and <<3>> Stamina due to your eternal nature.\nEach time you die, you become temporarily fragile and lose <<4>> Armor. Your return to life increases the bonus to Health, Magicka, and Stamina by 100%, up to 10 times.",
[248623]="While in combat, performing a Roll Dodge creates a |cffffff6|r meter pool of blood. After a <<1:>> delay, enemies in the pool take <<2>> Magic Damage. Gain a Damage Shield for <<3>> based on total damage done by the pool to enemies, up to |cffffff15000|r damage. This effect can occur once every <<4>> and the amount of damage done scales off your Max Health and cannot critically hit.",
[248625]="Lash out with a whip made of vines at all enemies within a cone of <<1>>, dealing <<2>>.\n\nIf you strike an enemy that is immobilized or stunned, you set them Off Balance.",
[248627]="Increases Health, Magicka, and Stamina Recovery by <<1>> for <<2>> after you capture a Lumber Mill, Farm, Mine, or Keep.",
[248630]="Gain |cffffff1|r second of immunity to crowd control effects after casting an Ultimate for each |cffffff20|r Ultimate spent.",
[248633]="Increases the range of long-range abilities by <<1>> while near a keep or outpost.\n\nAny ability with a range greater than |cffffff28|r meters is affected.\n\nReduce your damage done and healing done by <<2>>.",
[248636]="Reduces falling damage by <<1>>.",
...
[248648]="Increases your healing done with area of effect heals by <<1>>, and decrease your damage done by <<2>>.",
[248650]="Increases your healing done with single target heals by <<1>>, and decrease your damage done by <<2>>.",
[248652]="Increases your healing done with healing over time effects by <<1>>, and decrease your damage done by <<2>>.",
[248655]="Increases your healing done with direct heals by <<1>>, and decrease your damage done by <<1>>.",
[248663]="Your alliance battle training grants you insight into standard troop tactics. Reduce damage taken from non-players by <<1>>.",
[248666]="Reduce your damage taken by area of effect attacks by <<1>> and your healing done by <<1>>.",
[248671]="Reduce your damage taken by single target attacks by <<1>> and your healing done by <<1>>.",
[248674]="Reduce your damage taken by damage over time attacks by <<1>> and your healing done by <<2>>.",
[248676]="Reduce your damage taken by direct attacks by <<1>> and your healing done by <<1>>.",
[248678]="Call forth entangling vines from the ground, dealing <<1>> to enemies within <<2>> and immobilizing them for <<3>>. \n\nTargets that are immobilized take additional <<4>> every <<5>> over <<3>>.",
[248679]="Immobilizes nearby enemies for <<1>> and deals <<2>>. An  ally can activate the <<3>> Synergy, damaging enemies held within the talons.",
[248684]="Call forth entangling vines from the ground, dealing <<1>> to enemies within <<2>> and immobilizing them for <<3>>.",
...
[248700]="Decreases the time it takes to resurrect an ally by <<1>>.",
[248703]="Increase your damage shield effectiveness by <<1>>.\n\nIncrease your damage to enemies with a damage shield by <<2>>.",
[248705]="Harness pure knowledge into a beam of energy that scars the world in front of you. Channel the beam for up to <<1>>, dealing <<2>> Magic Damage every <<3>> to up to 6 enemies.\n\nThis ability is considered direct damage.",
[248708]="Reduce the cost of your damage shield abilities by <<1>>.",
[248710]="Gain |cffffff45|r Health Recovery for every 10 Ultimate you have.",
[248719]="Gain |cffffff10|r Magicka Recovery for every 10 Ultimate you have.",
[248720]="Gain |cffffff10|r Stamina Recovery for every 10 Ultimate you have.",
[248721]="Maneuvering quickly in and out of combat in Cyrodiil's killing fields recharges you. While Sprinting, you gain <<1>> Health and Magicka Recovery.",
[248742]="Reduce the time it takes to harvest by <<1>>, and reduce the time it takes for a fish to bite by <<2>>.",
[248744]="Increases the Movement Speed bonus of Sprint by <<1>> and the cost of Sprint by <<2>>.",
[248753]="While in combat, casting a Soul Magic ability consumes a Soul Gem and gives you a <<1>> for <<2>>. This effect can occur once every <<3>>. Dealing Light or Heavy Attack damage fires the <<1>> at your target, dealing |cffffff17.1|r% of your target's Max Health as Magic Damage, up to <<4>> Magic Damage.",
[248769]="Increases your Spell Resistance by <<1>>.\n\nDecreases your Physical Resistance by <<1>>.",
[248779]="Increases your Physical Resistance by <<1>>.\n\nDecreases your Spell Resistance by <<1>>.",
[248782]="When you taunt an enemy, apply <<1>> to them, increasing their damage taken by <<2>> for <<3>>. This effect can occur once every <<4>>.",
[248783]="Overheat with ancient magic, covering <<1>> around yourself, dealing <<2>> every <<3>> over <<4>>. You also gain Major Protection, reducing damage taken by <<5>> for <<6>>.\n\nEnemies stricken will have their Movement Speed reduced by <<7>>.\n\nActivating the ultimate again releases beams of ancient argonian magic, dealing <<8>> every <<9>> over <<10>>.",
[248792]="Reduces the Movement Speed penalty of Sneak by <<1>> and the cost of Sneak by <<2>>.",
[248793]="Thanks to your alliance drill sergeants, you learned how to fall early in your training. Reduces the cost of Roll Dodge by <<1>>.",
[248794]="Reduce the cost of Break Free by <<1>>.",
[248796]="Reduce the cost of Bash by <<1>>.",
[248797]="Reduces the cost of Sprint by <<1>> and the Movement Speed bonus of Sprint by <<2>>.",
[248798]="Reduce the cost of Sneak by <<1>>.",
[248799]="You stand as firm against a combatant's attacks as a Dwarven construct. Reduces the cost of Block by <<1>>.",
[248801]="Increase the amount of damage you block by <<1>>.",
[248803]="Increase damage done with Bash by <<1>>.",
...
[248817]="Increases your damage done with Magical attacks by <<1>>.\n\nReduces your Max Health by <<2>>.",
[248820]="Increases your damage done with Martial attacks by <<1>>.\n\nReduces your Max Health by <<2>>.",
[248823]="Increases your Magicka Recovery by <<1>>.\n\nReduces your Stamina Recovery by <<2>>.",
[248826]="Increases your Stamina Recovery by <<1>>.\n\nReduces your Magicka Recovery by <<2>>.",
[248828]="Increases your Max Magicka by <<1>>.\n\nReduce your Max Stamina by <<2>>.",
[248830]="Increases your Max Stamina by <<1>>.\n\nReduces your Max Magicka by <<2>>.",
[248833]="Increases your Max Health by <<1>>.",
[248837]="Increases your Armor by <<1>>.",
[248838]="Increases your Offensive Penetration by <<1>>.\n\nReduces your Armor by <<2>>.",
[248840]="Increases your healing done by <<1>>.\n\nReduces your damage done by <<2>>.",
[248842]="Increases your Health Recovery by <<1>>.",
[248848]="Increases your Critical Damage and Critical Healing by <<1>>.\n\nReduces your Critical Chance by <<2>>.",
[248855]="Increases your Critical Chance by <<1>>.\n\nReduces your Critical Damage and Critical Healing by <<2>>.",
[248858]="Increase your Health, Magicka, and Stamina Recovery by <<1>>.",
[248859]="Increases your Critical Resistance by <<1>>.\n\nReduces your Critical Chance by <<2>>.",
[248867]="Due to steady potion use, your constitution allows you to imbibe alchemical concoctions safely at a greater frequency. Reduces your potion cooldown by <<1>>.",
[248868]="Reduces Stamina cost of abilities by <<1>>.\n\nIncreases Magicka cost of abilities by <<2>>.",
[248870]="Reduces Magicka cost of abilities by <<1>>.\n\nIncreases Stamina cost of abilities by <<2>>.",
[248872]="The ease with which you perform your most challenging combat maneuver would make Pelinal smile. Reduces the cost of your Ultimate abilities by <<1>>.",
[248874]="Activate to teleport to Shadow Image",
[248932]="Increase your damage done with Heavy Attacks by <<1>>.\n\nReduce your damage done with Light Attacks by <<2>>.",
[248936]="Automatically block all attacks at no cost for <<1>> when you begin a Heavy Attack. This effect can occur once every <<2>>.",
[248939]="You mastered martial and magickal shortcuts, which increases your damage done and healing done by <<1>>. The concentration required to use these shortcuts increases your ability costs by <<2>>.",
...
[248986]="Increases your Critical Chance with Class abilities by <<1>>.\n\nReduces your Critical Chance with non-Class abilities by <<2>>.",
[248996]="Increases your healing done by <<1>>.\n\nReduces your healing taken by <<2>>.",
[248998]="Reduces all costs by <<1>>.",
...
[249028]="When you use an Ultimate ability while in combat, you and the closest |cffffff3|r group members within |cffffff28|r meters of you gain <<1>> Health Recovery, Magicka Recovery, and Stamina Recovery that lasts for <<2>> for each |cffffff20|r Ultimate spent.",
[249049]="Reduce the cost of your Restoration Staff abilities by <<1>>.\n\nIncrease the cost of your other weapon abilities by <<2>>.",
[249052]="Reduces the cost of your Class abilities by <<1>>.\n\nIncreases the cost of your non-Class abilities by <<2>>.",
...
[249153]="While in combat, completing a fully-charged Heavy Attack grants you either <<1>>, <<2>>, or <<3>> for <<4>>, increasing your Critical Damage done by <<5>>%, your damage done by <<6>>, or your Weapon and Spell Damage by <<7>>.\n\nThis effect can occur once every <<8>>.",
...
[249240]="Increases your damage done by <<1>>.\n\nReduces your Critical Damage by <<2>>.",
[249242]="Immunity to enemy control abilities.",
[249247]="Alliance battlefields are no place for the timid! Your daring increases your Max Health by <<1>> and Armor by <<2>>. Reduces your Block Mitigation by <<3>>.",
[249254]="Reduce the duration of Breakable Crowd Control, Immobilizes, and Snares on you by <<1>>.\n\nReduce the duration of your Breakable Crowd Control, Immobilizes, and Snares by <<2>>.",
[249256]="When you gain Crowd Control Immunity, you are as hard to entrap as a Dagi avoiding the Hungry Cat's claws. You become immune to snares and immobilizations that can be cleansed for <<1>>. This can occur once every <<2>>.",
[249272]="While out of combat, you gain <<1>> Health Recovery, and <<2>> Magicka and Stamina Recovery.",
[249386]="You deal and take <<1>> more damage with your Primary Weapon.\n\nYou deal and take <<2>> less damage with your Secondary Weapon.",
[249390]="When you die, after a <<1>> delay, an alchemical reaction deals <<2>> to up to 3 enemies within 8 meters of your corpse.",
[249770]="Violently drain the last spark of life from a corpse, dealing <<1>> over <<2>> to all enemies around the corpse and between you and the corpse.  \n\nIf the siphon lasts its full duration it causes the corpse to explode, dealing an additional <<3>> to all enemies around the corpse.  This ability scales off your highest offensive stats.\n\nWhile slotted, your damage done is increased by <<4>>.",
[249878]="· Charge to target and attack, dealing <<1>>\n· Stun target for <<2>>",
[250208]="Instant cast. Summon an immobile Gloom Wraith for 60 seconds.  Decreases Max Magicka by 15%. Costs 20 Magicka. Cooldown 5 seconds. \n—Uses Arcane Bolt, a light damage spell on any enemies within 15m.",
[250209]="Instant cast. Summon an immobile Gloom Wraith for 60 seconds.  Decreases Max Magicka by 15%. Costs 20 Magicka. Cooldown 5 seconds. \n—Uses Arcane Bolt, a light damage spell on any enemies within 15m.",
[250210]="Instant cast. Summon an immobile Gloom Wraith for 60 seconds.  Decreases Max Magicka by 15%. Costs 20 Magicka. Cooldown 5 seconds. \n—Uses Arcane Bolt, a light damage spell on any enemies within 15m.",
[250211]="Instant cast. Summon an immobile Gloom Wraith for 60 seconds.  Decreases Max Magicka by 15%. Costs 20 Magicka. Cooldown 5 seconds. \n—Uses Arcane Bolt, a light damage spell on any enemies within 15m.",
[251067]="Reduces the cost of your weapon abilities by <<1>>.\n\nIncreases the cost of your non-weapon abilities by <<2>>.",
[251077]="Increases your Health, Magicka, and Stamina Recovery by <<1>> while near a keep.",
[251097]="Increase the duration of your Assault and Support abilities by <<1>>.",
[251263]="Immunity to enemy control abilities.",
[251738]="Magicka and Stamina Recovery increased by <<1>>%.",
[251771]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[251785]="Call the weapon of the Dark Brotherhood to your hand and deliver a killing blow to an unsuspecting target. Experience from this target is reduced by 75%.\n\nThis ability does not work on players or difficult targets.",
[252037]="Fast Travel to any previously disovered wayshrine.",
[252038]="Fast Travel to any previously disovered wayshrine.",
[252041]="Dealing damage with a Bash or fully-charged Heavy Attack places the <<1>> on your target for <<2>>. While active, you gain <<3>>, increasing damage done by <<4>>, and deal <<5>> more damage to the target and <<6>> less damage to all other enemies. If the enemy dies while marked, you gain <<7>> Stamina or Magicka, based off your highest maximum resource. This effect can trigger up to every <<8>>.",
[252071]="Increase your swim speed by <<1>>.",
[252073]="Increases the duration of your Ayleid Health Bonus by <<1>>.",
[252087]="Reduce your Mounted Sprint cost by <<1>> while out of combat.",
[252124]="When you have all three collectible fragments for the Mote of Furious Flame: Use to perform the ritual.",
[252129]="When you have all three collectible fragments for the Mote of Furious Flame: Use to perform the ritual.",
[252139]="When an enemy you have recently damaged dies, after <<1>>, you and allies within <<2>> meters of the dead enemy receive <<3>> Health, Magicka, and Stamina Recovery for <<4>>. This effect can occur once every <<5>>.",
[252148]="Increase damage done to NPCs by <<1>>.",
[252173]="Increases your Movement Speed while Bracing by <<1>>.",
[252174]="Increases your Mounted Speed by <<1>>.",
[252228]="Stamina Recovery increased by <<1>>%.",
[252915]="30% Increase to Movement Speed",
[253049]="A red soul gem inflicts pain on your enemies.\n\nA fiery tether deals <<1>> every <<2>> to any enemy it intersects with as it stretches between you and the red soul gem.\n\nA red soul gem is created every <<3>> and they last <<4>>.\n\nAgonizing Tether only takes effect within the bounds of the Night Market.",
[253050]="Violently drain the last spark of life from a corpse, dealing <<1>> over <<2>> to all enemies around the corpse and between you and the corpse. \n\nIf the siphon lasts its full duration it causes the corpse to explode, dealing an additional <<3>> to all enemies around the corpse.  This ability scales off your highest offensive stats.\n\nWhile slotted, your damage done is increased by <<4>>.",
[253051]="A child of Arac follows you into battle.\n\nThe spider trails behind you, losing health whenever you're in combat. When it dies, you can step on its corpse and blast your enemies with <<1>> within <<2>>. Honoring the little spider's sacrifice.\n\nIts corpse is nothing more than a poison mound that lasts for <<3>> dealing <<4>> every <<5>>.\n\nEffects are only active within the bounds of the Night Market.",
[253063]="Violently drain the last spark of life from a corpse, dealing <<1>> over <<2>> to all enemies around the corpse and between you and the corpse.  \n\nIf the siphon lasts its full duration it causes the corpse to explode, dealing an additional <<3>> to all enemies around the corpse.  This ability scales off your highest offensive stats.\n\nWhile slotted, your damage done is increased by <<4>>.",
[253069]="Increases your healing received by <<1>>.",
[253070]="Increases your healing received by <<1>>.",
[253156]="Summon three patches of skeletal claws from the ground in front of you to grab up to 3 enemies, immobilizing them for <<1>> and applying <<2>> for <<3>>, reducing their damage done by <<4>>.",
[253609]="The mote of magicka temporarily increases your movement speed.",
[253633]="Violently drain the last spark of life from a corpse, dealing <<1>> over <<2>> to all enemies around the corpse and between you and the corpse.  \n\nIf the siphon lasts its full duration it causes the corpse to explode, dealing an additional <<3>> to all enemies around the corpse.  This ability scales off your highest offensive stats.\n\nWhile slotted, your damage done is increased by <<4>>.",
[253683]="While under the effect of the Grasping Void, Health Regeneration is reduced to 0.",
...
[253898]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[254097]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[254247]="· Deals <<1>> to enemy\n· Snare target <<2>> for <<3>>",
[254279]="While toggled:\n· Defend <<1>>% damage\n· Immune to stun, stagger, knockback\n\nEffect ends when you cause damage.",
[254343]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[254540]="Instant cast. Summon an immobile Gloom Wraith for 60 seconds.  Decreases Max Magicka by 15%. Costs 20 Magicka. Cooldown 5 seconds. \n—Uses Arcane Bolt, a light damage spell on any enemies within 15m.",
...
[254656]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[254658]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[254978]="When you have at least fifty Arena Gladiator Proofs: Use to consume those fifty Proofs and create a Runebound Tome: Alliance Banner Emote.",
[255057]="With a sweep that Morihaus would praise, you deal <<1>> to an enemy and to up to 2 additional enemies in front of you. This damage is increased by up to <<2>>% to enemies below <<3>>% Health.",
[255068]="· <<1>> damage to enemy\n· |cdc2222Chill|r: Slow <<2>> per stack, lasts <<3>>",
[255164]="Your prowess on Cyrodiil's battlefields exhausts your enemy, applying <<1>> Heal Absorption for <<2>>. This also increases their Roll Dodge cost by <<3>> for <<4>>.",
[255184]="Brace yourself, gaining <<1>> for <<2>>, which increases your Physical and Spell Resistance by <<3>>. You also quickly mend minor wounds, healing for <<4>> Health.",
[255189]="The Alliance War rages on, and so must you. Rally your spirits, gaining Major Intellect and Major Endurance for <<1>>, increasing your Magicka and Stamina Recovery by <<2>>.",
[255238]="Increases damage done by 5%.",
[255326]="Call out your alliance's battle cry, marshaling your group to the attack. You and up to 2 nearby group members gain Minor Berserk and Minor Expedition for <<1>>, increasing damage done by <<2>> and Movement Speed by <<3>>.",
[255479]="Your next Heavy Attack within <<1>> launches unstable magick that detonates after <<2>>, dealing <<3>> to up to 3 enemies in the area.\n\nThe delay is reduced by up to |cffffff1.5|r seconds based on how long you charged the Heavy Attack, and the damage cannot be blocked or mitigated.",
[255650]="Rush an enemy like a battle-raging minotaur and throw them up to <<1>> over your shoulder.",
[255673]="Throw magical chains at your target and up to 2 other nearby enemies, immobilizing them for <<1>>. This also applies <<2>> for <<3>>, reducing their damage done by <<4>>.",
[255681]="Revel in the front line of battle! Increases your Physical and Spell Resistance by <<1>> for every nearby enemy, up to a max of <<2>>, for <<3>>.",
[255689]="Send out an aura of protection to up to 3 nearby allies for <<1>>, applying a damage shield that absorbs up to <<2>> damage from projectiles. Also grants you <<3>>, reducing your damage taken by <<4>>.",
[255789]="Build a fury worthy of Malacath's admiration over <<1>> before unleashing it, dealing <<2>> to up to 3 nearby enemies.\n\nThe damage scales off your total Armor.",
[255952]="Forcefully interfere with your target's train of thought, silencing and stunning them for <<1>>.\n\nThis ability cannot be dodged.",
[255991]="Call forth talons from the ground, dealing <<1>> to enemies near you, an additional <<2>> over <<3>>, and immobilizing them for <<4>>. \n\nAn ally near the talons can activate the <<5>> synergy, dealing <<6>> to all enemies held within them.",
[255992]="Call forth talons from the ground, dealing <<1>> to enemies near you and immobilizing them for <<2>>. \n\nEnemies hit are afflicted with Minor Maim, reducing their damage done by <<3>> for <<4>>. \n\nAn ally near the talons can activate the <<5>> synergy, dealing <<6>> to all enemies held within them.",
[255993]="Draw on your draconic blood to heal for <<1>>, increasing by up to |cffffff50%|r additional healing based on your missing Health.\n\nYou also gain Major Fortitude, increasing your Health Recovery by <<2>> for <<3>>.",
[255994]="Draw on your draconic blood to heal for <<1>>% of your missing Health and an additional <<2>> Health every <<3>> over <<4>>. The heal over time scales off of your Max Health.\n\nYou also gain Major Fortitude, Major Endurance, and Minor Vitality, increasing your Health Recovery and Stamina Recovery by <<5>> and healing received and damage shield strength by <<6>> for <<7>>.",
[255995]="Launch yourself at an enemy, dealing <<1>> to all enemies in the area, knocking them back, and stunning them for <<2>>.\n\nAfter leaping you gain a damage shield that absorbs <<3>> damage for <<4>>. This portion of the ability scales with your Max Health.",
[255996]="Launch yourself at an enemy, dealing <<1>> to all enemies in the area, knocking them back, and stunning them for <<2>>.",
[255997]="Channel draconic energy to suck in the air around you, dealing <<1>> to nearby enemies and healing you for <<2>>% of the damage caused.\n\nAny enemy hit that is casting is interrupted, set Off Balance, and stunned for <<3>>.\n\nAfter <<4>>, you exhale fire, dealing <<5>> to nearby enemies.",
[255998]="Channel draconic energy to suck in the air around you, dealing <<1>> to nearby enemies and healing you for <<2>>% of the damage caused.\n\nAfter <<3>>, you exhale fire, dealing <<4>> to nearby enemies and restoring <<5>>% of the ability's cost for each enemy hit as Magicka.",
[255999]="Flex your scales, reducing damage taken from projectiles by <<1>> for <<2>>. \n\nWhen you are hit with a projectile, you retaliate by launching a fiery orb at the attacker that deals <<3>>. This effect can occur once every half second.",
[256000]="Flex your scales, reducing damage taken from projectiles by <<1>>  for <<2>>.\n\nGain immunity to snares and immobilizations for <<3>>.",
[256001]="Release your inner Dragon to gain Major Resolve, increasing your Physical and Spell Resistance by <<1>> for <<2>>. \n\nYou release a spray of fiery spikes around you, causing enemies hit to take <<3>> over <<4>>.\n\nWhile active, the armor returns <<5>> to any enemy that uses a direct damage attack against you in melee range.\n\nThis ability scales off your Physical and Spell Resistance.",
[256002]="Release your inner Dragon to gain Major Resolve, increasing your Physical and Spell Resistance by <<1>> for <<2>>. \n\nYou gain a damage shield that absorbs up to <<3>> damage for <<4>>, scaling off your Max Health.  \n\nWhile active, the armor returns <<5>> to any enemy that uses a direct damage attack against you in melee range, scaling off your Physical and Spell Resistance.",
[256003]="Immobilizes nearby enemies for <<1>> and deals <<2>>, then deals <<3>> over time. An  ally can activate the <<4>> Synergy, damaging enemies held within the talons.",
[256008]="Immobilizes nearby enemies for <<1>> and deals <<2>>. Affected enemies' damage is reduced by <<3>>. An  ally can activate the <<4>> Synergy, damaging enemies held within the talons.",
[256014]="· Heal for <<1>>% of missing health\n· Increase health regeneration by <<2>> for <<3>>",
[256016]="· Heal for <<1>>% of missing health\n· Increase health regeneration by <<2>> for <<3>>",
[256017]="· Heal for <<1>>% of missing health\n· Increase health regeneration by <<2>> for <<3>>",
[256022]="Immunity to enemy control abilities.",
[256030]="Immunity to enemy control abilities.",
[256177]="Call upon your battlefield curative skills to heal yourself or an ally for <<1>> Health, increasing by up to <<2>>% on targets below <<3>>%.",
[256184]="Recover health when you damage your enemies!\n\nEach tick of your Damage over Time effects heal you for <<1>>.\n\nTransfusion only takes effect within the bounds of the Night Market.",
[256193]="Your Light Attacks are infused with magic, causing small ice storms to burst forth with every swing!\n\nEach storm swirls forward dealing <<1>> every <<2>> to nearby enemies.\n\nSwift Gale only takes effect within the bounds of the Night Market.",
[256202]="You have the gift of life!\n\nWhen you die, you instead become immune to damage and negative effects. After <<1>> you are brought back from the dead, healing for <<2>> and radiating out a wave of renewal energy dealing <<3>> and stunning enemies for <<4>>.\n\nThis can occur only once.\n\nRebirth only takes effect within the bounds of the Night Market.",
[256214]="Chant a short battle prayer to grant up to 3 nearby allies a shield that absorbs <<1>> damage for <<2>> and <<3>> cost reduction on their non-Ultimate abilities for <<4>>.",
[256216]="Flames roar all around you! \n\nYou radiate intense heat dealing <<1>> every <<2>> within a radius of <<3>>.\n\nFlame Aura only takes effect within the bounds of the Night Market.",
[256225]="The wounds you inflict do not close.\n\nYour Direct Damage abilities cause enemies to bleed for <<1>> every <<2>> for <<3>>.\n\nExsanguinate only takes effect within the bounds of the Night Market.",
[256229]="The dead lend you a helping hand.\n\nEvery <<1>> a skeletal hand will ensnare enemies within |cffffff20|r meters, immobilizing them for <<2>>. Each snared enemy restores <<3>> Magicka and <<4>> Stamina.",
[256236]="Your Area Effects create diverging energy.\n\nOnce every <<1>> a location based Area Effect placed by you may begin to diverge, pulsing |cffffff1|r path of energy every <<2>> for <<3>> dealing <<4>>.\n\nMagical Multitudes only takes effect within the bounds of the Night Market.",
[256273]="Strike quick and true.\n\nYour Light Attack damage is increased by <<1>>. In addition, every Light Attack adds a stack of Intensity.\n\nAt |cffffff10|r stacks of Intensity, you go into a Frenzy for <<2>> increasing the damage of your Light Attacks by another <<3>>.\n\nLight Attacks refresh Frenzy.\n\nFrenzied Zeal only takes effect within the bounds of the Night Market.",
[256281]="You are able to sense wealthy enemies!\n\nEvery <<1>> an enemy with bountiful wealth will become highlighted. Use the <<2>> synergy to charge the enemy dealing <<3>> and scattering their coins nearby.\n\nUp to 10 piles of gold will be available at the same time.\n\nGolden Sleight only takes effect within the bounds of the Night Market.",
[256282]="Rush an enemy and ram them, dealing <<1>> and stunning them for <<2>>.",
[256295]="Channel your arcane potential to deal <<1>> Magic Damage to your target and up to 2 nearby enemies.\n\nWhile casting, up to 3 nearby allies can use the <<2>> synergy and increase <<3>>'s damage by <<4>>.",
[256300]="Your Heavy Attacks restore more resources!\n\nWhenever you hit a target with a fully-charged Heavy Attack you restore <<1>> Magicka, <<2>> Stamina, <<3>> Health, and generate <<4>> Ultimate.\n\nThis can occur every <<5>>.\n\nBountiful Resources only takes effect within the bounds of the Night Market.",
[256304]="Slam your staff down to activate its blessings, healing you and your allies in front of you for <<1>> Health.\n\nAlso grants <<2>>, increasing you and your allies' Physical Resistance and Spell Resistance by <<3>> for <<4>>.",
[256318]="Abyssal tendrils join from the void!\n\nWhen an abyssal tendril spawns, three Pearls will appear. Each Pearl you collect shields you from 33% of incoming damage. The tendrils will attack any enemies near them and heal you when you stand near where they spawn.\n\nSand Swipe only takes effect within the bounds of the Night Market.",
[256351]="With honed battle instincts, you grant yourself or an ally an immediate magic barrier that absorbs <<1>> of incoming damage, up to <<2>> damage, for <<3>>.",
[256448]="Summon fragments of chaos to distract your foes. This magic takes effect after <<1>>, disorienting them and up to 2 nearby enemies for <<2>>.\n\nDirect damage breaks the disorient early.",
[256490]="Your medic training allows you to redirect residual battle energy into an ally, reducing all incoming damage to <<1>> for <<2>>.\n\nThis ability cannot be interrupted, and will break if you are further than 22 meters from the target.",
[256557]="Throw a razor sharp blade at an enemy, causing them to bleed for <<1>> over <<2>>. This bleed can stack up to 3 times.",
[256690]="Your agile battle-dance would make Rahjin grin with glee. Disorient up to 3 nearby enemies for <<1>> before deftly springing 15 meters away.\n\nDirect damage breaks the disorient early.",
[256694]="Concentrate your attacks on a distant enemy for <<1>>, granting your and up to 2 nearby allies an additional <<2>> range on your abilities with a range greater than 7 meters. You also gain <<3>> for <<4>>, increasing your Critical Damage by <<5>>%.",
[256713]="Cloak yourself in purifying shadow to become invisible for <<1>> and immediately cleanse yourself of <<2>> negative effect.",
[256716]="Surge across the battlefield like a senche, increasing your Movement Speed by <<1>> for <<2>>.\n\nThis bonus is reduced by <<3>> every <<4>>.",
[256736]="Call out to your allies to focus fire on a single target for <<1>>, reducing the target's armor by <<2>> for each nearby enemy, up to a max of <<3>>. Also applies <<4>>, increasing their Critical Damage taken by <<5>>%.",
[256798]="Slam your whip down with tremendous force at an enemy, dealing <<1>> to them and all nearby enemies.",
[256808]="Slam your staff down to create a flaming field in front of you, dealing <<1>> to up to 3 enemies in front of you over <<2>>.",
[256809]="Slam your staff down to create an icy field in front of you, dealing <<1>> to up to 3 enemies in front of you over <<2>>, and reducing their Movement Speed by <<3>> for <<4>>.",
[256810]="Slam your staff down to create a storm field in front of you, dealing <<1>> to up to 3 enemies in front of you over <<2>> and setting them Off Balance for <<3>>.",
[256825]="· Deals <<1>> to all enemies in front of you",
[256885]="· Deals <<1>> to all enemies in front of you",
[256902]="The mote of magicka has increased your attack speed and movement speed.",
[257093]="A dark force connects you with your opponent, draining its power and giving it to you.",
[257526]="The market sustains you.\n\nMagicka and Stamina recovery is increased by <<1>> while within the confines of the Night Market.\n\nValued Mark only takes effect within the bounds of the Night Market.",
[257647]="· Pull enemy towards you\n· Deals <<1>> flame damage",
[257779]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[257813]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[257837]="This blessing will keep some of the creatures in Greenheart from attacking.",
[257909]="A powerful Tempest Caller comes to your aid!\n\nSummon the aid of a Tempest Caller who generates an immense storm on your location dealing <<1>> to nearby enemies. In addition, a constant bombardment of lightning strikes target enemies within 25 meters.\n\nThis can be used every <<2>>.\n\nTempest only takes effect within the bounds of the Night Market.",
[258457]="The hunt for gold continues!\n\nYour speed increases by <<1>> and your coin purse grows <<2>> heavier when you find gold.\n\nGolden Spurs only takes effect within the bounds of the Night Market.",
[258459]="You feel more resilient.\n\nThe market rewards your successes by adding <<1>> to your maximum health.\n\nHealthy Bargain only takes effect within the bounds of the Night Market.",
[258460]="Dealing direct critical damage applies <<1>> to the enemy, dealing <<2>> and increasing their damage taken from you by <<3>> for <<4>>. This damage scales off the higher of your Weapon or Spell Damage. When the enemy dies, <<1>> is reapplied to the lowest health enemy within <<5>> meters of the corpse and increases the damage taken by <<3>>, up to <<6>>. You may only have 1 enemy with <<1>>.",
[258569]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[258578]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[258669]="Dealing damage with a Bash or Heavy Attack deals <<1>> over <<2>> to the enemy. This effect can occur once every <<3>>.\n\nIf the effect completes, the enemy applies <<4>> to up to 6 enemies within 12 meters of itself for <<5>>. \n\nIf the enemy dies, the enemy releases glittering energy, restoring <<6>> Magicka and Stamina to you and group members within 12 meters of the defeated enemy.",
[258713]="Taking or dealing direct damage grants you a stack of <<1>> for <<2>>. You can gain <<1>> every <<3>>, up to |cffffff10|r stacks. Lose |cffffff1|r stack every <<4>> when not taking or dealing damage. At max stacks, you no longer gain or lose stacks of <<1>> and you gain <<5>>, <<6>>, and <<7>> for <<8>>. When max <<1>> ends, your Stamina, Magicka, and Health Recovery are reduced by <<9>> for <<10>>.",
[258758]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[258771]="<<1>> boost to all experience points.",
[258929]="Fast Travel to any previously disovered wayshrine.",
[258930]="Fast Travel to any previously disovered wayshrine.",
[259040]="Fast Travel to any previously disovered wayshrine.",
[259041]="Fast Travel to any previously disovered wayshrine.",
[259082]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[259224]="Fire forged within can never be extinguished. Fan the flames.\n\nWhen your Dragonknight damage over time effects end, you apply <<1>> to the target, dealing <<2>> over <<3>>. This effect stacks up to <<4>> times and increases in damage by <<5>> per stack.",
[259373]="Up to 3 living humanoids within 1.5 meters are disoriented and cannot witness crimes for <<1>>. Interacting with a target - including pickpocketing - will end the effect.",
[259469]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[259634]="· Heal for <<1>>% of missing health\n· Increase health regeneration by <<2>> for <<3>>",
[259648]="Draw on your draconic blood to heal yourself for <<1>> and nearby allies for <<2>> Health, increasing by up to <<3>> additional healing based on missing Health. \n\nHealed targets gain <<4>> and <<5>>, increasing Health Recovery by <<6>> and Weapon and Spell Damage by <<7>> for <<8>>.",
[259668]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
...
[259912]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[260046]="Dealing direct damage generates a stack of <<1>> for <<2>>, up to <<3>> stacks. While you have Gorethief equipped, Roll Dodge consumes 1 stack and heals you for <<4>> Health, scaling off your Max Health.\n\nAt max stacks, while you have Gorethief equipped, bash an enemy to consume all stacks and deal <<5>>, scaling off the higher of your Weapon or Spell Damage, to enemies within <<6>> meters of you.",
[260072]="After reviving at an oasis in the Night Market, you are invulnerable for a short time to aid your return to battle.",
[260206]="Violently drain the last spark of life from a corpse, dealing <<1>> over <<2>> to all enemies around the corpse and between you and the corpse.  \n\nIf the siphon lasts its full duration it causes the corpse to explode, dealing an additional <<3>> to all enemies around the corpse.  This ability scales off your highest offensive stats.\n\nWhile slotted, your damage done is increased by <<4>>.",
[260221]="Bolster your defenses, gaining a damage shield that absorbs up to <<1>> damage for <<2>>.\n\nWhile the shield persists, you are healed for <<3>> Health the next time a harmful direct damage projectile hits you. This effect can occur once per cast.\n\nThis ability scales off your Max Health.",
[260246]="Focus your strength and resolve to gain <<1>> and Sorcery, increasing your Weapon and Spell Damage by <<2>>, as well as gaining <<3>>, increasing your Stamina Recovery by <<4>> for <<5>>.\n\nActivating this ability removes all snares and immobilizations from you and grants immunity to them for <<6>>.",
[260255]="Envelop yourself in a protective cloak of razors, gaining <<1>> for <<2>>, reducing damage from area attacks by <<3>>. \n\nEvery <<4>> the shrapnel will pulse, dealing <<5>> to all enemies within <<6>> meters.\n\nYou also gain <<7>> for <<8>>, increasing your Movement Speed by <<9>>.",
[260368]="· Deals <<1>> to all enemies in front of you",
[261185]="Violently drain the last spark of life from a corpse, dealing <<1>> over <<2>> to all enemies around the corpse and between you and the corpse.  \n\nIf the siphon lasts its full duration it causes the corpse to explode, dealing an additional <<3>> to all enemies around the corpse.  This ability scales off your highest offensive stats.\n\nWhile slotted, your damage done is increased by <<4>>.",
[261285]="Increase your damage done with status effects by <<1>> for every <<2>> Ultimate you have, up to <<3>>. This effect is divided by 1 plus 1 if the target is a player, plus 1 if Feral Guardian is active.\n\nWhile you have <<4>> or more Ultimate, your Light and Heavy Attacks apply a random status effect, up to once every <<5>>.\n\nApplies <<6>> to you, consuming <<7>> Ultimate every <<8>> in combat.",
[261388]="While under the effect of the Grasping Void, Health Regeneration is reduced to 0.",
[261419]="After reviving at an oasis in the Night Market, you are invulnerable for a short time to aid your return to battle.",
...
[261509]="You count as an extra person for capturing objectives.",
[261575]="You remain as focused on your goal as an ancient Dragon. Increase the duration of Crowd Control Immunity by <<1>>.",
[261619]="· <<1>> damage to enemy\n· |cdc2222Chill|r: Slow <<2>> per stack, lasts <<3>>",
[261640]="You and your mount move as one, mirroring the skills possessed by the Gallants of Hammerfell. Reduces your Mount Sprint cost by <<1>>.",
[261647]="Leave a trap that snares enemies within 8m by 80% for 2 seconds and pulses every 3 seconds. Deals 150 damage per pulse.  Lasts 12 seconds",
[261687]="You remember how to walk down shadowy paths.\n\nA void portal can be summoned every <<1>>. Using this portal transports you to a location away from your enemies allowing you to escape or adjust your positioning farther from your attackers.\n\nVoid Escape only takes effect within the bounds of the Night Market.",
[261761]="You remember how to walk down shadowy paths.\n\nA void portal can be summoned every <<1>>. Using this portal transports you to a location away from your enemies allowing you to escape or adjust your positioning farther from your attackers.\n\nVoid Escape only takes effect within the bounds of the Night Market.",
[261762]="You remember how to walk down shadowy paths.\n\nA void portal can be summoned every <<1>>. Using this portal transports you to a location away from your enemies allowing you to escape or adjust your positioning farther from your attackers.\n\nVoid Escape only takes effect within the bounds of the Night Market.",
[261763]="You remember how to walk down shadowy paths.\n\nA void portal can be summoned every <<1>>. Using this portal transports you to a location away from your enemies allowing you to escape or adjust your positioning farther from your attackers.\n\nVoid Escape only takes effect within the bounds of the Night Market.",
...
[262095]="Fast Travel to any previously disovered wayshrine.",
[262096]="Fast Travel to any previously disovered wayshrine.",
[262136]="You channel the heroic energies expended on the battlefield while reviving the fallen. When you resurrect an ally, both you and the ally gain <<1>> for <<2>>, gaining 3 Ultimate every |cffffff1.5|r seconds.",
[262139]="Scholarly research makes your use of soul gems more effective. When resurrecting an ally with a soul gem, increase the Health they revive with by <<1>>.",
[262201]="Fast Travel to any previously disovered wayshrine.",
[262202]="Fast Travel to any previously disovered wayshrine.",
[262221]="You gain a <<1>>% Faction favor bonus from all Night Market enemy and district event sources for <<2>>. The timer pauses when you are offline, and resumes when you return. This bonus is compatible with other foods or drinks.",
[262231]="When you have all three pieces of the recipe: Use to combine into the full Recipe for Tonic of Portent Favor.",
[262232]="While Battle Spirit is inactive, crouching turns you invisible for <<1>>. This can occur once every <<2>>.\n\nIncrease your chances of successfully Pickpocketing by <<3>>.",
[262286]="Charge your fists with the power of the storm, replacing your Light and Heavy Attacks with new, stronger abilities.\n\nLight Attacks become lightning bolts, dealing <<1>> to an enemy up to |cffffff28|r meters away.  \n\nHeavy Attacks blast enemies in a |cffffff4 x 6|r area for <<2>>.\n\nAttacks deplete Ultimate until you run out, or the ability is toggled off.",
[262294]="· Deals <<1>>",
[262315]="While Battle Spirit is inactive, bracing while crouching turns you invisible for <<1>>. This can occur once every <<2>>.\n\nIncrease your chances of successfully Pickpocketing by <<3>>.\n\nOn dealing Critical Damage, increase your Max Magicka and Max Stamina for <<4>>, up to <<5>> at <<6>> stacks.\n\nOn dealing non-Critical Damage, increase your Health, Magicka, and Stamina Recovery for <<7>>, up to <<8>> at <<6>> stacks.\n\nEither effect can occur up to once every <<9>>.\n\nTalisman upgrades: <<10>>",
[263220]="You are as unyielding as a mountain.\n\nEach second you remain Bracing, you increase the amount of damage you block by <<1>>, up to 5 times. \n\nBlocking damage has a <<2>> chance to restore <<3>> Stamina. This effect can occur once every block cost.",
[263247]="Let others be swept along in the wake of your flame.\n\nActivating rank 2 of <<1>> grants you and group members within <<2>> meters of you <<3>> and Protection for <<4>> second per <<5>> Ultimate spent, increasing damage done and reducing damage taken by <<6>>.",
[263316]="Dive deep into the abyss where power is yours to claim.\n\nActivating an Arcanist Ultimate immediately generates maximum Crux and grants you <<1>> Weapon and Spell Damage for <<2>>.",
[263398]="Be the hand that guides the weave of fate.\n\nUpgrades rank 2 of <<1>> to generate maximum Crux, up to once every <<2>>. After this effect triggers you gain <<3>> Weapon and Spell Damage for <<4>>.",
[263410]="Surpass your limits in the fieldwork of battle.\n\nUpgrades rank 2 of <<1>> to also increase your damage done by <<2>>, halving against players, for the duration.",
[263411]="Increases your Critical Damage and Critical Healing by <<1>> while you have one or more Crux.",
[263412]="Master the archaic and forge new runes of conflict.\n\nUpgrades <<1>> to inflict <<2>> on your attacker while granting <<3>> to you and your group for <<4>>. You gain <<5>> Ultimate for every Crux you have.\n\nThese effects can occur once every <<6>>.",
[263416]="Illuminate body and mind with glimmering ink.\n\nWhile in combat, when you heal or overheal a total of <<1>> Health, you generate a Crux and grant you and your group members <<2>> for <<3>>, increasing Critical Damage by <<4>>%.",
[263448]="As an abattoir of death, no remnants of life are wasted.\n\nUpgrades rank 2 of <<1>> to also grant a stack of <<2>> for <<3>>, which increases your Max Health by <<4>> and Weapon and Spell Damage by <<5>> per stack, up to <<6>> times. Stacks decay three at a time instead of all at once.",
[263465]="Death's knell is a familiar song. Share it with your enemies.\n\nUpgrades rank 2 of <<1>> to mark the closest non-player enemy to you with death's touch for <<2>>, allowing you to use a corpse consuming ability on them. Consuming or replacing this effect forcibly triggers rank 1 of <<1>>'s Ultimate generation and triggers rank 2 of <<3>>.\n\nThis effect can occur once every <<4>>.",
[263509]="The cycle of life and death continues: you will live, others will die.\n\nUpgrades rank 2 of <<1>> to grant <<2>> for <<3>>, increasing the potency of your damage done by <<4>> for every <<4>> Health you have more than your target. The damage bonus caps at <<5>>, or <<6>> against players.",
[263519]="Expose your enemies to unrelenting cold.\n\nApplying <<1>> to an enemy also applies <<2>> for <<3>>, increasing their Critical Damage taken by <<4>>%.",
[263520]="The battlefield is your grove. Tend to it.\n\nGain <<1>> Weapon and Spell Damage for each status effect on your target, up to a maximum of <<2>>.",
[263521]="Tap into the wellspring of permafrost's resolve.\n\nUpgrades <<1>> to also activate when casting Winter's Embrace abilities and to grant <<2>> Weapon and Spell Damage for <<3>> if you are at full Health after the heal.",
[263522]="The twisting of seasons has tempered your will.\n\nReduce your damage taken by <<1>> for every status effect active on your attacker, up to a maximum of <<2>>.",
[263523]="Share in the spoils of nature's abundance.\n\nUpgrades rank 2 of <<1>> to grant you and your group members <<2>> for <<3>> and an additional <<4>> Magicka and Stamina, up to once ever <<5>>.",
[263549]="Knock upon death's door and demand your due.\n\nWhen you take damage you have a <<1>> chance to heal <<2>> Health and restore <<3>> of your missing Stamina, up to once per second. This chance increases by <<4>> for every missing Health percent you have and the healing is based off your Max Health.",
[263554]="Call souls back from an early grave. Only you may grant them release.\n\nWhile you are in combat, directly healing a target below <<1>> Health relinquishes them from death's clutches and allows you to use a corpse consuming ability against them within <<2>>, up to once every second. \n\nExtends the duration of <<3>> you apply by <<4>>.",
[263585]="Light consecrates the ground on which you tread.\n\nSacred Ground is now applied while you are in your own Nova and Spear Shards, and while Radial Sweep and Solar Barrage are active. While Sacred Ground is active, you heal for <<1>> Health every <<2>>. If you are at full Health after being healed from this effect while in combat, you also gain <<3>> Ultimate.",
[263586]="Radiant is the shield that pushes back the dark.\n\nWhile Sacred Ground is active, you gain a damage shield for <<1>>, up to once every <<2>>. The shield absorbs up to <<3>> damage and provides <<4>> Health, Magicka, and Stamina Recovery while active. If the shield breaks, you gain <<5>> Ultimate.",
[263587]="Light's banner instills hope. You are its bearer.\n\nUpgrades rank 2 of <<1>> to also grant <<2>> for the duration, which grants <<3>> Weapon and Spell Damage to allies and doubles for you.",
[263588]="Judgement follows in the wake of your radiance.\n\nWhen rank 2 of <<1>> deals damage, your Templar abilities gain <<2>> damage done for <<3>>. This bonus is halved against players.",
[263589]="Your conviction is unwavering. Light gives no quarter.\n\n<<1>> now activates and refreshes itself while Bracing. Increases the amount of damage you can block by <<2>> while stationary.",
[263591]="You and your allies standing in your Templar ground effect abilities gain <<1>> Weapon and Spell Damage.",
[263603]="The Night Mistress rewards those who strike without reservation.\n\nUpgrades rank 2 of <<1>> to have a chance to generate <<2>> Ultimate. This effect can occur once every <<3>> and the chance is equal to your Weapon Critical chance.",
[263604]="Every strike, every stab, is a step towards execution.\n\nIncreases your Weapon and Spell Damage by up to <<1>>, based on your target's missing Health. \n\nReduces your damage taken by up to <<2>>, based on your attacker's missing Health. \n\nBoth effects are halved against targets with Battle Spirit.",
[263605]="An assassin is only as good as their reputation.\n\nIncreases your Critical Damage and Healing by <<1>>. This effect is reduced to <<2>> against targets with Battle Spirit.\n\nIncreases your maximum Critical Damage and Healing by <<3>>.",
[263606]="This duel will be their last. For you, it's just another dance.\n\nActivating a Nightblade ability while bracing causes you to dodge attacks for <<1>>.\n\nWhenever you dodge an attack, your attacker's psyche suffers, increasing their damage taken by <<2>> for <<3>>, increasing to <<4>> against monsters.",
[263607]="Secrets and coin are tools as sharp as the daggers you wield.\n\nUpgrades rank 2 of <<1>> to grant group members <<2>> Magicka and Stamina, <<3>> Ultimate, and doubles the Ultimate you gain when it activates.",
[263640]="You're always right where you're needed most - or you benefit the most.\n\nIncreases your Weapon and Spell Damage by up to <<1>>, based on your target's missing Health.\n\nReduces your damage taken by up to <<2>>, based on your attacker's missing Health.",
[263870]="Spellcasting is second nature to you. A skill honed by tireless study.\n\nUpgrades rank 2 of <<1>> to work with all abilities with a cost, excluding cost per tick abilities, and restores <<2>> Magicka and <<3>> Stamina when it activates. This effect scales off your Max Magicka and Stamina.",
[263871]="Within you is a wellspring of near unlimited power.\n\nUpgrades rank 2 of <<1>> to work with any Sorcerer ability and increases your Weapon and Spell Damage by <<2>> for <<3>>. The Weapon and Spell Damage increases by <<4>> for every <<5>> Max Magicka or Stamina you have, whichever is higher.",
[263872]="The battlefield crackles with untapped potential. Make use of it.\n\nWhen you deal damage, you have a <<1>> chance to deal <<2>>, up to once every <<3>>. \n\nThe chance increases by <<4>> for every <<4>> missing Health the target has. The chance is divided by 1 plus every permanent pet you have active.",
[263873]="Success is a certainty when nothing is left to chance.\n\nWhile beginning to use a Sorcerer ability or an ability with a cast time, you gain a damage shield for <<1>> that can absorb <<2>> damage. This effect is based off your Max Health. If the shield does not break, you and nearby group members gain <<3>> Weapon and Spell Damage for <<4>>.",
[263874]="Magicka extends your reach, a benefit to those who fight beside you.\n\nCasting a damage shield on yourself or an ally grants an additional shield that absorbs up to <<1>> damage for <<2>> and <<3>> Health, Magicka, and Stamina Recovery for <<4>>. The shield scales off the higher of your Max Health or Max Magicka, and is capped at <<5>> of the target's Max Health.",
[263915]="Applying a shield to yourself or an ally grants them an a damage shield for <<1>> that can absorb <<2>> damage. This shield scales off the higher of your Max Health or Max Magicka.",
[266108]="On dealing critical damage, increase your Max Magicka and Max Stamina by <<1>> for <<2>>, stacking up to 5 times.\n\nOn dealing non-critical damage, increase your Health, Magicka, and Stamina Recovery by <<3>> for <<4>>, stacking up to 5 times.\n\nEither effect can occur up to once every <<5>>.",
[266268]="Up to 6 living humanoids within 2.5 meters are disoriented and cannot witness crimes for <<1>>. Interacting with a target - including pickpocketing - will end the effect.",
[266377]="Consume your fury and unleash the beast, increasing your Movement Speed by <<1>>, damage done by <<2>>, and reducing the cost of your Werewolf Transformation and abilities by <<3>> for <<4>>.\n\nThis effect is lost if you leave Werewolf form.",
[266733]="When you have all three collectible fragments for the Mote of Furious Flame: Use to perform the ritual.",
...
[266856]="On dealing critical damage, increase your Max Magicka and Max Stamina by <<1>> for <<2>>, stacking up to 5 times.\n\nOn dealing non-critical damage, increase your Health, Magicka, and Stamina Recovery by <<3>> for <<4>>, stacking up to 5 times.\n\nEither effect can occur up to once every <<5>>.",
[266859]="On dealing critical damage, increase your Max Magicka and Max Stamina by <<1>> for <<2>>, stacking up to 5 times.\n\nOn dealing non-critical damage, increase your Health, Magicka, and Stamina Recovery by <<3>> for <<4>>, stacking up to 5 times.\n\nEither effect can occur up to once every <<5>>.",
[267248]="A job well done is the only job you'll do.\n\nIncreases your Critical Damage and Healing by <<1>>. This bonus bypasses the Critical cap and adds to it.",
[267414]="You can transform into a savage beast.\n\nYou take <<1>> more damage from Poison Attacks while in Werewolf form.",
[267416]="Consume your fury and unleash the beast, increasing your Movement Speed by <<1>>, damage done by <<2>>, and reducing the cost of your Werewolf Transformation and abilities by <<3>> for <<4>>.\n\nThis effect is lost if you leave Werewolf form.",
[267425]="Consume your fury and unleash the beast, increasing your Movement Speed by <<1>>, damage done by <<2>>, Health Recovery by <<3>>, and reducing the cost of your Werewolf Transformation and abilities by <<4>> for <<5>>.\n\nThis effect is lost if you leave Werewolf form.",
[267467]="Increase Max Health by <<1>>, Poison Resistance by <<2>>, and Healing Taken by <<3>>.\nWhile in Werewolf form, increase Block Mitigation by <<4>> for <<5>>.",
[267471]="Increases your Flame Resistance by <<1>>.",
...
[267811]="On dealing critical damage, increase your Max Magicka and Max Stamina by <<1>> for <<2>>, stacking up to 5 times.\n\nOn dealing non-critical damage, increase your Health, Magicka, and Stamina Recovery by <<3>> for <<4>>, stacking up to 5 times.\n\nEither effect can occur up to once every <<5>>.",
[267854]="Teleports you to your alliance's base in the Imperial City Sewers. Only works in the Imperial City or the Sewers. Effect broken by movement (if effect is broken, the stone is not consumed).",
[268123]="While in werewolf form, can devour humanoid corpses to regenerate ultimate.",
[268597]="When you have all three collectible fragments for the Mote of Furious Flame: Use to perform the ritual.",
}
