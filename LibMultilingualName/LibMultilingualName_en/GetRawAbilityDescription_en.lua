...
[261285]="Increase your damage done to monsters with status effects by <<1>> for every <<2>> Ultimate you have, up to <<3>>. The cap is halved if Feral Guardian is active.\n\nWhile you have <<4>> or more Ultimate, your Light and Heavy Attacks apply a random status effect, up to once every <<5>>.\n\nWhile equipped, applies <<6>> to you, consuming <<7>> Ultimate every <<8>> in combat.",
