...
{
	["en"]=true,["de"] = true,["fr"] = true,["jp"] = true, ["ru"] = false, ["zh"] = true, ["pl"] = false,["es"] = true
}
if true then
...
function WritCreater.Options() --Sentimental
	...
	local options =  {
		...
		{
			type = "checkbox",
			name = WritCreater.optionStrings["master"].."（不支持, 请使用 Writ Worthy）",--"Master Writs",
		...
		},
		{
			...
			warning = "此选项需要 LibCustomMenu 插件",
			setFunc = function(value) 
...
----- CRAFTING SUBMENU
	...
	local craftSubmenu = {{
		type = "checkbox",
		name = WritCreater.optionStrings["blackmithing"].."（支持）"   ,
	...
	{
		type = "checkbox",
		name = WritCreater.optionStrings["clothing"].."（支持）"  ,
	...
	{
	  type = "checkbox",
	  name = WritCreater.optionStrings["woodworking"].."（支持）"    ,
	...
	{
	  type = "checkbox",
	  name = WritCreater.optionStrings["jewelry crafting"].."（支持）"    ,
	...
	{
		type = "checkbox",
		name = WritCreater.optionStrings["provisioning"].."（不支持）",
	...
	{
		type = "checkbox",
		name = WritCreater.optionStrings["enchanting"].."（支持）",
	...
	{
		type = "checkbox",
		name = WritCreater.optionStrings["alchemy"].."（不支持）",
