...
Harvest.MAX_NON_SURVEY_STACK = { -- doubled due to champion passive
	[Harvest.BLACKSMITH] = 3*2,
	[Harvest.JEWELRY] = 3*2,
	[Harvest.CLOTHING] = 3*2,
	[Harvest.WOODWORKING] = 3*2,
	[Harvest.ENCHANTING] = 1*2,
	[Harvest.MUSHROOM] = 1*2,
	[Harvest.FLOWER] = 1*2,
	[Harvest.WATERPLANT] = 1*2,
}
