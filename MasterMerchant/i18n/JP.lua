...
ZO_CreateStringId("MM_AGS_TRADER_VALUE_TYPE_NAME", "AGS Autofill Value Type")
ZO_CreateStringId("MM_AGS_TRADER_VALUE_TYPE_TIP", "Choose from the MM Average, TTC Average, TTC Suggested, and Bonanza Average prices for the configured AGS autofil value.")
