...
local strings = {
	...
	NOTYOU_RAIDSCORE_SOUND_TOOLTIP = "This turns off/on the Notification Sound (Applies to anything that uses NEW_NOTIFICATION sound)",
