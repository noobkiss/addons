...
L("NIGHT_MARKET_HIDE", "仅在 <<1>> 显示")
L("NIGHT_MARKET_ACTIVE", "活跃")
L("NIGHT_MARKET_INACTIVE", "不活跃")
L("NIGHT_MARKET_PORT", "传送至 <<1>>")
...
L("TIMER_FORMAT_TEXT_MINUTES_SECONDS", "<<1>>分 <<2>>秒")
L("TIMER_FORMAT_TEXT_WITH_SECONDS", "<<1>>天 <<2>>小时 <<3>>分 <<4>>秒")
L("TIMER_FORMAT_TEXT_WITH_SECONDS_NO_DAYS", "<<1>>小时 <<2>>分 <<3>>秒")
L("TOGGLE", "切换至 <<1>>")
L("TOMES_SEASONAL_PROGRESS", "Tamriel Tomes — 赛季进度")
L("TOMES_SEASONAL_PROGRESS_BEST", "Tamriel Tomes — 赛季最佳进度")
L("TOMES_SEASONAL_TIME_REMAINING", "Tamriel Tomes — 赛季剩余时间")
L("TOMES_WEEKLY_PROGRESS", "Tamriel Tomes — 每周进度")
L("TOMES_WEEKLY_PROGRESS_BEST", "Tamriel Tomes — 每周最佳进度")
L("TOMES_WEEKLY_TIME_REMAINING", "Tamriel Tomes — 每周剩余时间")
L("TOTAL_VALUE", "总价值： <<1>>")
