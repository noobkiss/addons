...
-- Third-party Compatibility
	...
	if EsoZH:IsAddonRunning("AwesomeGuildStore") then
		d("AwesomeGuildStore Running")
	...
	-- EasyTravel
	if EsoZH:IsAddonRunning("EasyTravel") then
		local ShowLocationsBackup
		
		if EasyTravel.PlayerList.Rebuild then
			ZO_PreHook(EasyTravel.PlayerList, "Rebuild", function()
				ShowLocationsBackup = EsoZH.Settings.LocationDoubleName
				EsoZH.Settings.LocationDoubleName = "zh"
			end)
			
			ZO_PostHook(EasyTravel.PlayerList, "Rebuild", function()
				EsoZH.Settings.LocationDoubleName = ShowLocationsBackup
			end)
		end
	end
-- Third-party Compatibility End
